...
macro(itk_module_config ns)
  ...
  endforeach()
  # Special case when ITK was built for Python wrapping
  # with static libraries
  if(NOT ITK_BUILD_SHARED AND ITK_WRAP_PYTHON)
    list(FIND _${ns}_USED_MODULES ITKCommon _have_common)
    if(NOT _have_common EQUAL -1)
      list(APPEND ${ns}_LIBRARIES ITKCommonGlobals)
    endif()
  endif()
