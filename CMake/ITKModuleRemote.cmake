...
function(itk_fetch_module _name _description)
  option(Module_ITK${_name} "${_description}" OFF)
  mark_as_advanced(Module_ITK${_name})

  # Fetch_$_remote_module} is deprecated. To maintain backward compatibility:
  if(Fetch_${_name})
    message(WARNING "Fetch_${_name} is deprecated, please use Module_ITK${_name} to download and enable the remote module.")
    set(Module_ITK${_name} ON CACHE FORCE "${_description}")
  endif()
