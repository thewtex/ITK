...
if(CPPCHECK_EXECUTABLE)
  ...
  if( "${_cppcheck_enable_style_result}" EQUAL 0 )
    message( "_cppcheck_enable_style_result EQUAL 0" )
  ...
  if("${_cppcheck_enable_unused_functions_results}" EQUAL 0)
    message( "_cppcheck_enable_unused_functions_results EQUAL 0" )
  ...
  if("${_cppcheck_enable_information_results}" EQUAL 0)
    ...
    message( "_cppcheck_enable_information_results EQUAL 0" )

  else()
    message( "_cppcheck_enable_information_results NOT EQUAL 0" )
  ...
  if("${_cppcheck_missingInclude_results}" EQUAL 0)
    ...
    message( "_cppcheck_missingInclude_results EQUAL 0" )

  else()
    message( "_cppcheck_missingInclude_results NOT EQUAL 0" )
