...
macro(itk_module _name)
  ...
  set(ITK_MODULE_${itk-module}_IMAGE_IO "")
  set(ITK_MODULE_${itk-module}_TRANSFORM_IO "")
  set(ITK_MODULE_${itk-module}_EXCLUDE_FROM_ALL 0)
  foreach(arg ${ARGN})
    if("${arg}" MATCHES "^(DEPENDS|TEST_DEPENDS|DESCRIPTION|DEFAULT|IMAGE_IO|TRANSFORM_IO)$")
      set(_doing "${arg}")
    ...
    elseif("${_doing}" MATCHES "^IMAGE_IO$")
      list(APPEND ITK_MODULE_${itk-module}_IMAGE_IO "${arg}")
    elseif("${_doing}" MATCHES "^TRANSFORM_IO$")
      list(APPEND ITK_MODULE_${itk-module}_TRANSFORM_IO "${arg}")
...
macro(itk_module_impl)
  ...
  set(itk-module-IMAGE_IO  "${ITK_MODULE_${itk-module}_IMAGE_IO}")
  set(itk-module-TRANSFORM_IO  "${ITK_MODULE_${itk-module}_TRANSFORM_IO}")
