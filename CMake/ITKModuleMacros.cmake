...
macro(itk_module _name)
  ...
  set(ITK_MODULE_${itk-module}_FACTORIES "" )
  foreach(arg ${ARGN})
    if("${arg}" MATCHES "^(FACTORIES|DEPENDS|TEST_DEPENDS|DESCRIPTION|DEFAULT)$")
      set(_doing "${arg}")
    ...
    elseif("${_doing}" MATCHES "^FACTORIES$")
      list(APPEND ITK_MODULE_${itk-module}_FACTORIES "${arg}")
      message("ADDING FACTORY \"${arg}\" in module \"${itk-module}\" \"${ITK_MODULE_${itk-module}_FACTORIES}\"")
