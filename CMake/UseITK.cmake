...
if(NOT ITK_NO_IO_FACTORY_REGISTER_MANAGER)
  ...
  foreach (TransformFormat  Matlab Txt HDF5)
   foreach(Type Float Double)
     set (LIST_OF_FACTORIES_REGISTRATION "${LIST_OF_FACTORIES_REGISTRATION}void ${TransformFormat}TransformIOFactoryTemplate${Type}Register__Private(void);")
     set (LIST_OF_FACTORY_NAMES "${LIST_OF_FACTORY_NAMES}${TransformFormat}TransformIOFactoryTemplate${Type}Register__Private,")
   endforeach()
  endforeach()

  get_filename_component(_selfdir "${CMAKE_CURRENT_LIST_FILE}" PATH)
  configure_file(${_selfdir}/itkTransformIOFactoryTemplateRegisterManager.h.in
    "${CMAKE_CURRENT_BINARY_DIR}/ITKIOFactoryRegistration/itkTransformIOFactoryTemplateRegisterManager.h" @ONLY)
  unset(LIST_OF_FACTORIES_REGISTRATION)
  unset(LIST_OF_FACTORY_NAMES)
