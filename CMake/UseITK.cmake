...
foreach (ImageFormat  JPEG GDCM BMP LSM PNG TIFF VTK Stimulate)
        if (Module_ITK-IO-${ImageFormat})
                list (APPEND LIST_OF_FACTORIES_REGISTRATION "void ${ImageFormat}ImageIOFactoryRegister(void)")
                list (APPEND LIST_OF_FACTORY_NAMES  "${ImageFormat}ImageIOFactoryRegister")
        endif()
endforeach()

foreach (ImageFormat  Meta Nrrd Gipl)
