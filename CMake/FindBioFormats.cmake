...
mark_as_advanced(BIOFORMATS_LIB)
find_library(BIOFORMATS_LIB bio-formats ${BIOFORMATS_LIB_SEARCHPATH})

if(BIOFORMATS_LIB)
  set(BIOFORMATS_FOUND 1)
  get_filename_component(BIOFORMATS_LIB_DIR ${BIOFORMATS_LIB} PATH)
endif(BIOFORMATS_LIB)
