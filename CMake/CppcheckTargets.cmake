...
function(add_cppcheck_sources _targetname)
  if(CPPCHECK_FOUND)
    ...
    message(STATUS "Adding target ${_name} ${_name}_cppcheck_test")
    get_target_property(mytargINCLUDES "${_name}" INCLUDE_DIRECTORIES)
    message(STATUS "include dirs list ${mytargINCLUDES}")
    ...
    message( STATUS "cppcheck include arg: ${_cppcheck_include}" )

    # --------------------------------------------------------------
    # let's take of compile definitions here
    message(STATUS "compile definitions ${mytargDEFINITIONS}")

    get_target_property(mytargDEFINITIONS "${_name}" DEFINITIONS)
    ...
    # --------------------------------------------------------------
    get_target_property(mytargTYPE "${_name}" TYPE)
    message(STATUS "compile definitions ${mytargTYPE}")
