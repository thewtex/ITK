...
if(ITK_USE_CXX_MODULES AND NOT CMAKE_CXX_STANDARD GREATER_EQUAL 20)
  message(FATAL_ERROR "ITK_USE_CXX_MODULES requires CMAKE_CXX_STANDARD greater or equal to 20")
endif()
if(CMAKE_CXX_STANDARD GREATER_EQUAL 20)
  option(ITK_USE_CXX_MODULES "Use C++ modules when building ITK" OFF)
  if (ITK_USE_CXX_MODULES)
    if(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
      set(ITK_REQUIRED_CXX_FLAGS "${ITK_REQUIRED_CXX_FLAGS} -fmodules-ts")
    elseif(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
      set(ITK_REQUIRED_CXX_FLAGS "${ITK_REQUIRED_CXX_FLAGS} -fmodules-ts")
    # elseif(CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
    #   set(ITK_REQUIRED_CXX_FLAGS "${ITK_REQUIRED_CXX_FLAGS} TODO")
    else()
      message(FATAL_ERROR "Compiler not supported by ITK for C++ modules")
    endif()
  endif()
endif()
