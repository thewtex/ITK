...
if(DEFINED ITK_BUILD_DEFAULT_MODULES)
  message(WARNING "ITK_BUILD_DEFAULT_MODULES is deprecated, please use ITK_BUILD_DEFAULT_MODULES.")
  set(ITK_BUILD_DEFAULT_MODULES ${ITK_BUILD_DEFAULT_MODULES} CACHE BOOL "Build the default ITK modules." FORCE)
endif()
...
foreach(itk-module ${ITK_MODULES_ALL})
  if(NOT ${itk-module}_IS_TEST)
    ...
    elseif(ITK_BUILD_DEFAULT_MODULES)
      set(ITK_MODULE_${itk-module}_IN_DEFAULT 1)
      set(Module_${itk-module}_DEFAULT ON)
    else()
      set(ITK_MODULE_${itk-module}_IN_DEFAULT 0)
      set(Module_${itk-module}_DEFAULT OFF)
    endif()
...
foreach(itk-module ${_enabled_modules})
  if(NOT ${itk-module}_IS_TEST)
    if(Module_${itk-module})
      # When modules options are forced to be ON by ITK_BUILD_DEFAULT_MODULES
      if(ITK_MODULE_${itk-module}_IN_DEFAULT)
        set(_reason ", requested by ITK_BUILD_DEFAULT_MODULES")
      else()
        set(_reason ", requested by Module options.")
      endif()
    # Warning to toggle modules back ON in the following three conflicts:
    elseif(ITK_MODULE_${itk-module}_IN_DEFAULT)
      set(_reason ", requested by ITK_BUILD_DEFAULT_MODULES")
      message(WARNING "Module_${itk-module} is turned on by ITK_BUILD_DEFAULT_MODULES.")
