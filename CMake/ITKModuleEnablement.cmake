...
foreach(itk-module ${ITK_MODULES_ALL})
  if(NOT ${itk-module}_IS_TEST)
    ...
    elseif(ITK_BUILD_ALL_MODULES)
      set(ITK_MODULE_${itk-module}_IN_ALL 1)
...
foreach(itk-module ${_enabled_modules})
  if(NOT ${itk-module}_IS_TEST)
    if(Module_${itk-module})
      # When modules options are forced to be ON by ITK_BUILD_ALL_MODULES
      if(ITK_MODULE_${itk-module}_IN_ALL)
        set(_reason ", requested by ITK_BUILD_ALL_MODULES")
      else()
        set(_reason ", requested by Module option request.")
      endif()
