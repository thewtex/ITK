...
set( MAXIMUM_NUMBER_OF_HEADERS 25 )
...
macro( itk_module_headertest _name )
  if( NOT ${_name}_THIRD_PARTY AND
    ...
    set( _test_num 1 )
    math( EXPR _available_headers "${_test_num} * ${MAXIMUM_NUMBER_OF_HEADERS}" )
    ...
    foreach( _header_test_src ${_outputs} )
      ...
      # This is required for the inline constructor in
      # MersenneTwisterRandomVariateGenerator in the ITKCommon case.
      if( ${_name} STREQUAL ITKCommon OR
          ${_name} STREQUAL ITKIOBase OR
          ${_name} STREQUAL ITKSpatialObjects )
        target_link_libraries( ${_test_name} ${_name} )
      endif()
    endforeach()
  endif()
endmacro()
