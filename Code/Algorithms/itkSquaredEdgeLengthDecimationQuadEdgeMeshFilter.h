...
class ITK_EXPORT SquaredEdgeLengthDecimationQuadEdgeMeshFilter:
  public MergeDecimationQuadEdgeMeshEdgeFilter< TInput, TOutput, TCriterion >
{
public:
  typedef SquaredEdgeLengthDecimationQuadEdgeMeshFilter Self;
  typedef SmartPointer< Self >                    Pointer;
  typedef SmartPointer< const Self >              ConstPointer;
  typedef MergeDecimationQuadEdgeMeshEdgeFilter<
    TInput, TOutput, TCriterion >                         Superclass;

  /** Run-time type information (and related methods).   */
  itkTypeMacro(SquaredEdgeLengthDecimationQuadEdgeMeshFilter, MergeDecimationQuadEdgeMeshEdgeFilter);
