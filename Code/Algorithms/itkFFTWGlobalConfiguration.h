...
//ITK_FFTW_WISDOM_STRATEGY   - Defines how agressive the generation of
//                             wisdom should be.
//ITK_FFTW_USE_WISDOM_CACHE  - Defines if a wisdom file cache should be used
...
public:
  ...
  /**
   * SetWisdomStrategy -- Set the behavior of wisdom plan creation
   *
   * If the environmental variable "ITK_FFTW_WISDOM_STRATEGY", is set,
   * then the environmental setting overides all internal applicaiton settings.
   * \param strategy - One of the FFTW planner flags FFTW_ESTIMATE, FFTW_MEASURE,
   * FFTW_PATIENT, FFTW_EXHAUSTIVE
   */
  int GetWisdomStrategy() const;
  void SetWisdomStrategy(const int strategy);

  /**
   * SetUseWisdomCache -- Set the behavior of wisdom file caching
   *
   * If the environmental variable "ITK_FFTW_USE_WISDOM_CACHE", is set,
   * then the environmental setting overides all internal applicaiton settings.
   * \param useCache - true will create a wisdom file in the location
   */
  bool GetUseWisdomCache() const;
  void SetUseWisdomCache(const bool useCache);
   ...
   * will override the setting of this function.
   */
  void SetWisdomCacheBase(const std::string CacheBaseDir);
  std::string GetWisdomCacheBase() const;
   ...
   * if UseWisdomCache is set to true.
  ...
  //std::string GetNameOfClass() { return "FFTWGlobalConfiguration"; } //Needed for itkWarningMacro
...
private:
  ...
  int                           m_WisdomStrategy;
  bool                          m_WisdomStrategyEnvSet;
  std::string                   m_WisdomCacheBase;
  bool                          m_WisdomCacheBaseEnvSet;
  //m_UseWisdomCache Controls the behavior of default
  //wisdom file creation policies.
  bool                          m_UseWisdomCache;
  bool                          m_UseWisdomCacheEnvSet;
