 ...
 *
 *=========================================================================*/
#ifndef __itkMergeDecimationQuadEdgeMeshEdgeFilter_h
#define __itkMergeDecimationQuadEdgeMeshEdgeFilter_h
...
{
/**
 * \class MergeDecimationQuadEdgeMeshEdgeFilter
 * \brief
 */
template< class TInput, class TOutput, class TCriterion >
class ITK_EXPORT MergeDecimationQuadEdgeMeshEdgeFilter:
  public DecimationQuadEdgeMeshFilter< TInput, TOutput, TCriterion >
{
public:
  typedef MergeDecimationQuadEdgeMeshEdgeFilter Self;
  ...
  itkTypeMacro(MergeDecimationQuadEdgeMeshEdgeFilter, DecimationQuadEdgeMeshFilter);
...
protected:
  ...
  virtual ~MergeDecimationQuadEdgeMeshEdgeFilter();
...
private:
  MergeDecimationQuadEdgeMeshEdgeFilter(const Self &);
  void operator=(const Self &);
};
}

#include "itkMergeDecimationQuadEdgeMeshEdgeFilter.txx"
#endif
