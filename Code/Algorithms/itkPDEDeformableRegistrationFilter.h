...
public:
  ...
  typedef itk::FixedArray< double, ImageDimension > StandardDeviationsType;
  ...
  itkGetConstMacro(StandardDeviations, StandardDeviationsType);
  ...
  itkGetConstMacro(UpdateFieldStandardDeviations, StandardDeviationsType);
