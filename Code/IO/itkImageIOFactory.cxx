...
#if defined(ITK_SUPPORTS_BIORAD_IMAGEIO)
#include "itkBioRadImageIOFactory.h"
#endif

#if defined(ITK_SUPPORTS_BMP_IMAGEIO)
#include "itkBMPImageIOFactory.h"
#endif

#if defined(ITK_SUPPORTS_GDCM_IMAGEIO)
#include "itkGDCMImageIOFactory.h"
#endif

#if !defined(ITK_USE_MODULAR_BUILD)
#  if defined(ITK_SUPPORTS_DICOM2_IMAGEIO)
#    include "itkDICOMImageIO2Factory.h"
#  endif
#endif

#if defined(ITK_SUPPORTS_ANALYZE_IMAGEIO)
#include "itkAnalyzeImageIOFactory.h"
#endif

#if defined(ITK_SUPPORTS_NIFTI_IMAGEIO)
#include "itkNiftiImageIOFactory.h"
#endif

#if defined(ITK_SUPPORTS_GIPL_IMAGEIO)
#include "itkGiplImageIOFactory.h"
#endif

#if defined(ITK_SUPPORTS_JPEG_IMAGEIO)
#include "itkJPEGImageIOFactory.h"
#endif

#if defined(ITK_SUPPORTS_LSM_IMAGEIO)
#include "itkLSMImageIOFactory.h"
#endif

#if defined(ITK_SUPPORTS_META_IMAGEIO)
#include "itkMetaImageIOFactory.h"
#endif

#if defined(ITK_SUPPORTS_PNG_IMAGEIO)
#include "itkPNGImageIOFactory.h"
#endif

#if defined(ITK_SUPPORTS_NRRD_IMAGEIO)
#include "itkNrrdImageIOFactory.h"
#endif

#if defined(ITK_SUPPORTS_TIFF_IMAGEIO)
#include "itkTIFFImageIOFactory.h"
#endif

#if defined(ITK_SUPPORTS_VTK_IMAGEIO)
#include "itkVTKImageIOFactory.h"
#endif

#if defined(ITK_SUPPORTS_STIMULATE_IMAGEIO)
