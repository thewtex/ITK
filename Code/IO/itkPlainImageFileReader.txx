 ...
 *
 *=========================================================================*/
#ifndef __itkPlainImageFileReader_txx
#define __itkPlainImageFileReader_txx
...
PlainImageFileReader< TOutputImage, ConvertPixelTraits >
...
template< class TOutputImage, class ConvertPixelTraits >
void PlainImageFileReader< TOutputImage, ConvertPixelTraits >
...
::GenerateOutputInformation(void)
{
  ...
  if ( m_UserSpecifiedImageIO == false ) //try creating via factory
    {
    // This method will throw an exception if no ImageIO can be created
...
::GenerateData()
{
  ...
  itkDebugMacro (<< "PlainImageFileReader::GenerateData() \n"
...
{
  itkExceptionMacro(
    "The PlainImageFileReader does not attempt to use the ImageIO Factory. \
     You should manually connect a known ImageIO to this class, or you should \
     use the ImageFileReader class if you want to use factories");
  return NULL;
}
