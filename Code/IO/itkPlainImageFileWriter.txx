 ...
 *
 *=========================================================================*/
#ifndef __itkPlainImageFileWriter_txx
#define __itkPlainImageFileWriter_txx
...
PlainImageFileWriter< TInputImage >
...
//---------------------------------------------------------
template< class TInputImage >
const typename PlainImageFileWriter< TInputImage >::InputImageType *
PlainImageFileWriter< TInputImage >
::GetInput(void)
{
...
::Write()
{
  ...
  // This method will throw an exception if no
  // ImageIO can be created for the current filename.
  // The logic for potentially pre-existing ImageIO
  // is managed inside this method.
  this->m_ImageIO = this->CreateImageIOThroughTheFactory();
...
{
  itkExceptionMacro(
    "The PlainImageFileWriter does not attempt to use the ImageIO Factory. \
     You should manually connect a known ImageIO to this class, or you should \
     use the ImageFileWriter class if you want to use factories");
  return NULL;
}
