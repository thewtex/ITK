 ...
 *
 *=========================================================================*/
#ifndef __itkRigid3DTransformBase_h
#define __itkRigid3DTransformBase_h
...
namespace itk
{
/** \class Rigid3DTransformBase
 * \brief Rigid3DTransformBase of a vector space (e.g. space coordinates)
 *
...
public:
  ...
  /**
   * Get rotation Matrix from an Rigid3DTransformBase
   *
...
protected:
  Rigid3DTransformBase(unsigned int spaceDim,
                   unsigned int paramDim);
  Rigid3DTransformBase(const MatrixType & matrix,
                   const OutputVectorType & offset);
  Rigid3DTransformBase();
  ~Rigid3DTransformBase();

  /**
   * Print contents of an Rigid3DTransformBase
   */
  void PrintSelf(std::ostream & os, Indent indent) const;

private:
  Rigid3DTransformBase(const Self &); //purposely not implemented
  void operator=(const Self &);   //purposely not implemented
};                                //class Rigid3DTransformBase
}  // namespace itk

// Define instantiation macro for this template.
#define ITK_TEMPLATE_Rigid3DTransformBase(_, EXPORT, TypeX, TypeY)                \
  namespace itk                                                               \
  {                                                                           \
  _( 1 ( class EXPORT Rigid3DTransformBase< ITK_TEMPLATE_1 TypeX > ) )            \
  namespace Templates                                                         \
  {                                                                           \
  typedef Rigid3DTransformBase< ITK_TEMPLATE_1 TypeX > Rigid3DTransformBase##TypeY; \
  }                                                                           \
  }

#if ITK_TEMPLATE_EXPLICIT
#include "Templates/itkRigid3DTransformBase+-.h"
#endif

#if ITK_TEMPLATE_TXX
#include "itkRigid3DTransformBase.txx"
#endif

#endif /* __itkRigid3DTransformBase_h */
