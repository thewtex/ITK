 ...
 *
 * Templated over same parameters as CompositeTransform
 *
 * TODO:
 *
 * Paths in component file names.
 * Currently the routine expects a full path and filename when directly passing a
 * list of component filenames. Then in the written master file, only the
 * filename of the component paths are written out, assuming the user will want
 * to keep these as relative paths, and will keep them together with the
 * master file.
 ...
 * These are currently not allowed here as components of the composite transform.
