...
ImageIORegion VTKImageIO2::GenerateStreamableReadRegionFromRequestedRegion(
  const ImageIORegion & requestedRegion) const
{
  if( this->GetPixelType() == ImageIOBase::SYMMETRICSECONDRANKTENSOR )
    {
    // Use the ImageIOBase implementation that sets the streamable region to the
    // largest possible region.
    return Superclass::Superclass::GenerateStreamableReadRegionFromRequestedRegion( requestedRegion );
    }

  return Superclass::GenerateStreamableReadRegionFromRequestedRegion( requestedRegion );
}

unsigned int
VTKImageIO2::GetActualNumberOfSplitsForWriting(unsigned int numberOfRequestedSplits,
                                                        ...
                                                        const ImageIORegion & largestPossibleRegion)
{
  if ( this->CanStreamWrite() &&
    ...
    {
    return Superclass::GetActualNumberOfSplitsForWritingCanStreamWrite( numberOfRequestedSplits, pasteRegion );
    }
