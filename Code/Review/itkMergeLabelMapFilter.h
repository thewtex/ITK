 ...
 *
 * This filter takes one or more input Label Map and merge them.
 *
 ...
 *             processing. No conflict can occure.
 *   STRICT (3): MergeLabelMapFilter keeps the labels unchanged and raise an
