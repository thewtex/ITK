 ...
 *
 *=========================================================================*/
#ifndef __itkResampleImageFilterTransduceFunction_h
#define __itkResampleImageFilterTransduceFunction_h
...
namespace itk
{
/** \class ResampleImageFilterTransduceFunction
 * \brief Resample an image via a coordinate transform
 *
 * ResampleImageFilterTransduceFunction resamples an existing image through
 * some coordinate transform, interpolating via some image function, with
 * optional modification via a transduce function.
 ...
 *
 * A transduce function derived from
 * PixelValueSpatialTransformationTransduceFunctionBase is applied to each
 * resampled image value. The default is an identity transducer via
 * PixelValueSpatialTransformationTransduceFunctionBase. The class will
 * automatically assign the transform to the transduce function and call its
 * Prepare method, during BeforeThreadedGenerateData.
 *
...
template< class TInputImage,
          ...
          class TPixelValueSpatialTransformationTransduceFunction =
            PixelValueSpatialTransformationTransduceFunctionBase<
             ITK_TYPENAME
              NumericTraits< typename TInputImage::PixelType >::RealType,
              typename TInputImage::PointType,
              TInputImage::ImageDimension,
              TOutputImage::ImageDimension > >
class ITK_EXPORT ResampleImageFilterTransduceFunction:
  public ImageToImageFilter< TInputImage, TOutputImage >
{
public:
  /** Standard class typedefs. */
  typedef ResampleImageFilterTransduceFunction                             Self;
  ...
  itkTypeMacro(ResampleImageFilterTransduceFunction, ImageToImageFilter);
  ...
  /** TransduceFunction typedef */
  typedef TPixelValueSpatialTransformationTransduceFunction
            PixelValueSpatialTransformationTransduceFunctionType;
  typedef typename TPixelValueSpatialTransformationTransduceFunction::Pointer
            PixelValueSpatialTransformationTransduceFunctionPointer;
  ...
  /** Get the PixelValueSpatialTransformationTransduceFunction.
   * This is const partly so user cannot set its transform. */
  itkGetConstObjectMacro(TransduceFunction,
    PixelValueSpatialTransformationTransduceFunctionType)
...
private:
  ResampleImageFilterTransduceFunction(const Self &); //purposely not implemented
  ...
  PixelValueSpatialTransformationTransduceFunctionPointer m_TransduceFunction;
  std::vector<PixelValueSpatialTransformationTransduceFunctionPointer>
    m_ThreaderTransduceFunction;
...
#include "itkResampleImageFilterTransduceFunction.txx"
#endif
