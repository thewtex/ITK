                       ...
                       int threadId)
{
  ...
  typename TInputImage::SizeValueType projectionSize = inputSize[m_ProjectionDimension];
...
template< class TInputImage, class TOutputImage, class TAccumulator >
TAccumulator
ProjectionImageFilter< TInputImage, TOutputImage, TAccumulator >::NewAccumulator(size_t size) const
{
