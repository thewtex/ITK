...
::CreateTriangles()
{
  ...
  while ( pointsIt != points->End() )
    ...
    PointIdentifier newId1 = FindCellId(n[0], pointsIt.Index(), n[1]);
    PointIdentifier newId2 = FindCellId(n[1], pointsIt.Index(), n[2]);
    PointIdentifier newId3 = FindCellId(n[2], pointsIt.Index(), n[0]);
...
template< typename TInputMesh, typename TOutputMesh >
typename SimplexMeshToTriangleMeshFilter< TInputMesh, TOutputMesh >::PointIdentifier
SimplexMeshToTriangleMeshFilter< TInputMesh, TOutputMesh >
