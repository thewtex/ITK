...
throw( InvalidRequestedRegionError )
{
  ...
  //GS: to acommodate vector pixel type
...
//                                           OutputImageType, RealOutputPixelType > SingleFilterType;
  ...
  //GS: for vector type image, the operator should still be a scalar:
  ...
  //GS: try accommodate for vector pixel type
