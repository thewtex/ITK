 ...
 *            Output direction is the sub-matrix it it is positive definite, else throw an exception.
 *
...
public:
  ...
  void DirectionCollapseGuess()
    {
    this->m_DirectionCollaspeStrategy=DIRECTIONCOLLASPEGUESS;
    }
  ...
  void DirectionCollapseToIdentity()
    {
    this->m_DirectionCollaspeStrategy=DIRECTIONCOLLASPETOIDENTITY;
    }
  ...
  void DirectionCollapseToSubmatrix()
    {
    this->m_DirectionCollaspeStrategy=DIRECTIONCOLLASPETOSUBMATRIX;
    }
