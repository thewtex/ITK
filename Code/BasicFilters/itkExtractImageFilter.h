...
public:
   ...
   *
   * itk::itkExtractImageFilter::DIRECTIONCOLLASPEGUESS
   ...
   */
  void SetDirectionCollapseStrategy(const DIRECTIONCOLLASPESTRATEGY choosenStrategy)
    {
    switch(choosenStrategy)
      {
    case DIRECTIONCOLLASPEGUESS:
    case DIRECTIONCOLLASPETOIDENTITY:
    case DIRECTIONCOLLASPETOSUBMATRIX:
      break;
    case DIRECTIONCOLLAPSEUNKOWNSTRATEGY:
    default:
   ...
   */
  DIRECTIONCOLLASPESTRATEGY GetDirectionCollapseStrategy() const
    {
    return this->m_DirectionCollaspeStrategy;
    }

  /** \sa SetDirectionCollapseStrategy */
  void SetDirectionCollapseGuess()
    {
    this->SetDirectionCollapseStrategy(DIRECTIONCOLLASPEGUESS);
    }

  /** \sa SetDirectionCollapseStrategy */
  void SetDirectionCollapseToIdentity()
    {
    this->SetDirectionCollapseStrategy(DIRECTIONCOLLASPETOIDENTITY);
    }

  /** \sa SetDirectionCollapseStrategy */
  void SetDirectionCollapseToSubmatrix()
    {
    this->SetDirectionCollapseStrategy(DIRECTIONCOLLASPETOSUBMATRIX);
    }
