...
HeadOfMonolithicITKTree=/media/work/src/ITK # This is the origin ITK dir
HeadOfModularITKTree=/media/work/src/modularITK  # This dir will be cleaned up every time running the script, so be carful not setting it to wrong dirs.
