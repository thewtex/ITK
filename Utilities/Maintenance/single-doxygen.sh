...
# * for a single file:
#
# $ ~/src/ITK/Utilities/Maintenance/single-doxygen.sh ~/src/ITK/Modules/Core/include/itkObject.h
#
# * for a module:
#
# $ ~/src/ITK/Utilities/Maintenance/single-doxygen.sh ~/src/ITK/Modules/Core/include/
