...
_remote_origin_url=$(git config remote.origin.url)
_protocol_position=$(expr index "$_remote_origin_url" ":")
if [ "${_remote_origin_url:$_protocol_position}" != "//itk.org/ITK.git" ]; then
