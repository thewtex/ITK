...
QuickView::Visualize(bool interact)
{
  ...
  typedef itk::ImageToVTKImageFilter<itk::Image<itk::RGBPixel<unsigned char>, 2> >
    RGBConnectorType;
  std::vector<ConnectorType::Pointer> connectors;       // Force the connectors
                                                        // to persist (not lose
                                                        // scope) after each
                                                        // iteration of the loop
  std::vector<RGBConnectorType::Pointer> RGBconnectors; // Force the connectors
                                                        // to persist after each
                                                        // iteration of the loop
