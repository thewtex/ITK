...
template<typename TFixedImage, typename TMovingImage, typename TTransform =
  GaussianSmoothingOnUpdateTimeVaryingVelocityFieldTransform<float, GetImageDimension<TFixedImage>::ImageDimension> >
...
public:
  ...
  itkSetMacro( NumberOfIntegrationSteps, SizeValueType );
  itkGetConstMacro( NumberOfIntegrationSteps, SizeValueType );
...
private:
  ...
  SizeValueType                                                   m_NumberOfIntegrationSteps;
