...
::PhysicsBasedNonRigidRegistrationMethod()
{
  ...
  this->m_FEMFilter->SetInput( this->m_BlockMatchingFilter->GetDisplacements() );
...
::GenerateData()
{
  ...
  // block matching
  this->m_BlockMatchingFilter->SetFixedImage( pipelineMonitorImageFilter->GetOutput() );
  ...
  femSolver->SetApproximationSteps( m_ApproximationSteps );
  femSolver->SetOutlierRejectionSteps( m_OutlierRejectionSteps );
