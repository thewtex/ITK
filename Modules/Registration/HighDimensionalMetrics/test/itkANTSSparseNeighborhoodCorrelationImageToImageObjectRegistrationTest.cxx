...
int itkANTSSparseNeighborhoodCorrelationImageToImageObjectRegistrationTest(int argc, char *argv[])
{
  ...
  // The metric
  typedef itk::ANTSSparseNeighborhoodCorrelationImageToImageObjectMetric
    < FixedImageType, MovingImageType > MetricType;
  MetricType::Pointer metric = MetricType::New();
  itk::Size<Dimension> radSize;
  radSize.Fill(2);
  metric->SetRadius(radSize);
  unsigned long numberOfSampling=(unsigned int)((float)fixedImage->GetRequestedRegion().GetNumberOfPixels()*0.05);
