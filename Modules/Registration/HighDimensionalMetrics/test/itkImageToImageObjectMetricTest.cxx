...
protected:
  ...
  ImageToImageObjectMetricTestMetric()
    ...
    this->m_DenseGetValueAndDerivativeThreader  = ImageToImageTestGetValueAndDerivativeThreader< ThreadedImageRegionPartitioner< VirtualImageDimension > >::New();
    this->m_SparseGetValueAndDerivativeThreader = ImageToImageTestGetValueAndDerivativeThreader< ThreadedIndexedContainerPartitioner >::New();
    }
