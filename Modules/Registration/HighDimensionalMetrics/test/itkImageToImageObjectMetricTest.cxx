...
protected:
  friend class ImageToImageTestGetValueAndDerivativeThreader<
    itk::ThreadedImageRegionPartitioner< VirtualImageDimension >, Superclass >;
  friend class ImageToImageTestGetValueAndDerivativeThreader<
    itk::ThreadedIndexedContainerPartitioner, Superclass >;

  typedef ImageToImageTestGetValueAndDerivativeThreader<
    itk::ThreadedImageRegionPartitioner< VirtualImageDimension >, Superclass >
                                                            DenseThreaderType;
  typedef ImageToImageTestGetValueAndDerivativeThreader<
    itk::ThreadedIndexedContainerPartitioner, Superclass >  SparseThreaderType;
