 ...
 *
 *  \c ProcessPoint must be overridden by derived
...
protected:
  ...
  /** \class GetValueAndDerivativeThreader
   * \brief Base class that defines a \c BeforeThreadedExecution and
   * \c AfterThreadedExecution.
   *
   *  The DenseGetValueAndDerivativeThreader and
   *  SparseGetValueAndDerivativeThreader derive from this class to get common
   *  threading setup and post processing code.
   *  */
  template< class TDomainPartitioner >
  class GetValueAndDerivativeThreader
    : public DomainThreader< TDomainPartitioner, ImageToImageObjectMetric >
  {
  public:
    /** Standard class typedefs. */
    typedef GetValueAndDerivativeThreader                                  Self;
    typedef DomainThreader< TDomainPartitioner, ImageToImageObjectMetric > Superclass;
    typedef SmartPointer< Self >                                           Pointer;
    typedef SmartPointer< const Self >                                     ConstPointer;

    itkTypeMacro( ImageToImageObjectMetric::GetValueAndDerivativeThreader, DomainThreader );
  ...
  protected:
    ...
    /** When collecting the results, average the returned value and derivative
     * by the number of valid points used in the calculation. */
    bool m_AverageValueAndDerivativeByNumberOfValuePoints;

  private:
    GetValueAndDerivativeThreader( const Self & ); // purposely not implemented
    void operator=( const Self & ); // purposely not implemented
  };

  /** \class DenseGetValueAndDerivativeThreader
   * \brief Run GetValueAndDerivateProcessPoint on the points defined by an
   * ImageRegion.
   * */
  class DenseGetValueAndDerivativeThreader
    : public GetValueAndDerivativeThreader< ThreadedImageRegionPartitioner< VirtualImageDimension > >
  {
  public:
    /** Standard class typedef. */
    typedef DenseGetValueAndDerivativeThreader                              Self;
    typedef GetValueAndDerivativeThreader< ThreadedImageRegionPartitioner< VirtualImageDimension > >
                                                                            Superclass;
    typedef SmartPointer< Self >                                            Pointer;
    typedef SmartPointer< const Self >                                      ConstPointer;

    itkTypeMacro( ImageToImageObjectMetric::DenseGetValueAndDerivativeThreader, ImageToImageObjectMetric::GetValueAndDerivativeThreader );
  ...
  protected:
    DenseGetValueAndDerivativeThreader() {}
  ...
  private:
    DenseGetValueAndDerivativeThreader( const Self & ); // purposely not implemented
    void operator=( const Self & ); // purposely not implemented
  };
  typename DenseGetValueAndDerivativeThreader::Pointer m_DenseGetValueAndDerivativeThreader;

  /** \class SparseGetValueAndDerivativeThreader
   * \brief Run GetValueAndDerivateProcessPoint on the points defined by a
   * PointSet.
   * */
  class SparseGetValueAndDerivativeThreader
    : public GetValueAndDerivativeThreader< ThreadedIndexedContainerPartitioner >
  {
  public:
    /** Standard class typedef. */
    typedef SparseGetValueAndDerivativeThreader                                  Self;
    typedef GetValueAndDerivativeThreader< ThreadedIndexedContainerPartitioner > Superclass;
    typedef SmartPointer< Self >                                                 Pointer;
    typedef SmartPointer< const Self >                                           ConstPointer;

    itkTypeMacro( ImageToImageObjectMetric::SparseGetValueAndDerivativeThreader, ImageToImageObjectMetric::GetValueAndDerivativeThreader );
  ...
  protected:
    SparseGetValueAndDerivativeThreader() {}
  ...
  private:
    SparseGetValueAndDerivativeThreader( const Self & ); // purposely not implemented
    void operator=( const Self & ); // purposely not implemented
  };
  typename SparseGetValueAndDerivativeThreader::Pointer m_SparseGetValueAndDerivativeThreader;
  ...
  virtual bool TransformAndEvaluateFixedPoint(
  ...
  virtual bool TransformAndEvaluateMovingPoint(
                           const VirtualIndexType & index,
                           const VirtualPointType & point,
                           const bool computeImageGradient,
