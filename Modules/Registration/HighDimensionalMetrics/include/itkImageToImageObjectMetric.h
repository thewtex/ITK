...
protected:
  ...
  /** Sampled point sets */
  FixedSampledPointSetPointer                 m_FixedSampledPointSet;
  ...
  /** Helper class for sampling. Handles either dense of sparse sampling
   * transparently. */
  class SamplingIteratorHelper
  {
  public:
    ...
    bool GetNext( Self * self, VirtualIndexType & virtualIndex, VirtualPointType & virtualPoint )
    {
      if( m_UseSampledPointSet )
        ...
        self->m_VirtualDomainImage->TransformPhysicalPointToIndex(
    ...
    /** Constructors. Use these to initialize for the desired type of sampling */
    ...
    SamplingIteratorHelper( const VirtualSampledPointSetPointer & pointSet,
