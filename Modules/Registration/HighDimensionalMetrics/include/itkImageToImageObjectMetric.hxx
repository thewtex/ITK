                         ...
                         DerivativeType & derivative )
{
  ...
  if( this->m_UseFixedSampledPointSet ) // sparse sampling
    ...
    typename SparseGetValueAndDerivativeThreader::DomainType range;
    range[0] = 0;
    range[1] = this->m_FixedSampledPointSet->GetNumberOfPoints() - 1;
    this->m_SparseGetValueAndDerivativeThreader->Execute( this, range );
    }
  else // dense sampling
    {
    this->m_DenseGetValueAndDerivativeThreader->Execute( this, this->GetVirtualDomainRegion() );
    }
