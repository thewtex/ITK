...
::InitializeForIteration()
{
  ...
  if( this->m_UseFixedSampledPointSet )
    ...
    this->m_JointHistogramMutualInformationSparseComputeJointPDFThreader->Execute( this, sampledRange );
    }
  else
    {
    this->m_JointHistogramMutualInformationDenseComputeJointPDFThreader->Execute( this, this->GetVirtualDomainRegion() );
    }
