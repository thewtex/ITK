...
int itkKappaStatisticImageToImageMetricTest(int, char* [] )
{
  ...
  fixedImage->AllocateWithDefaultPixelInitializer(); // initialize
                                                     // buffer to zero
  fixedImage->Update();
  ...
  movingImage->AllocateWithDefaultPixelInitializer(); // initialize
                                                      // buffer to zero
  movingImage->Update();
  ...
  xGradImage->AllocateWithDefaultPixelInitializer(); // initialize
                                                     // buffer to zero
  xGradImage->Update();

  DoubleImage2DType::Pointer yGradImage = DoubleImage2DType::New();
  yGradImage->SetRegions(imageSize);
  yGradImage->AllocateWithDefaultPixelInitializer(); // initialize
                                                     // buffer to zero
  yGradImage->Update();
