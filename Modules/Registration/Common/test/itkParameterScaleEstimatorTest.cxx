                                           ...
                                           bool subtractMean )
{
  ...
  scaleEstimator->SetLNorm(2); //by default, use Euclidean distance
  scaleEstimator->SetGlobalScalingFactor(3);
  scaleEstimator->SetTransformForward(true);
  scaleEstimator->ComputeParameterScales(transform, scales);
  // Testing done
