...
/** Number of bins to used in the histogram.
  * According to Mattes et al the optimum value is 50.
  ...
  typedef double PDFValueType; //NOTE:  floating point precision is not as
                               // stable.  Double precision proves faster and
...
private:
  ...
  //NOTE:  The signature in base class requires that movingImageValue is of type
  // double
