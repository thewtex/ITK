...
public:
  ...
  typedef Image< TFixedImagePixel, VImageDimension >             FixedImageType;
  typedef typename FixedImageType::ConstPointer                  FixedImageConstPointer;
  typedef typename FixedImageType::PixelType                     FixedImagePixelType;

  /** Moving image typedefs. */
  typedef Image< TMovingImagePixel, VImageDimension >            MovingImageType;
  ...
  typedef typename std::vector< SmartPointer< DataObject > >  ObjectContainerType;
  typedef typename ObjectContainerType::size_type             ObjectContainerSizeType;
  ObjectContainerSizeType GetNumberOfValidRequiredInputs() const;
