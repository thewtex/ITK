...
::PrintSelf(std::ostream & os, Indent indent) const
{
  ...
  if( !this->m_PerThread.empty()  && this->m_PerThread[0].JointPDF.IsNotNull() )
    {
    os << indent << "JointPDF: ";
    os << this->m_PerThread[0].JointPDF << std::endl;
    }
  if( !this->m_PerThread.empty() && this->m_PerThread[0].JointPDFDerivatives.IsNotNull() )
    {
...
throw ( ExceptionObject )
{
  ...
  this->m_PerThread.resize( this->m_NumberOfThreads );
