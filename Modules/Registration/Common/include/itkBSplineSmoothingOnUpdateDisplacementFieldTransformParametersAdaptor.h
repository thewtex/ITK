...
private:
  BSplineSmoothingOnUpdateDisplacementFieldTransformParametersAdaptor( const Self & ); //purposely
                                                                                       //
                                                                                       // not
                                                                                       //
                                                                                       // implemented
...
#endif /*
         __itkBSplineSmoothingOnUpdateDisplacementFieldTransformParametersAdaptor_h
         */
