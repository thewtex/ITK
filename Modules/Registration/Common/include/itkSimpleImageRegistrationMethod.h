...
public:
  ...
  typedef RegistrationParameterScalesEstimator<MetricType>            ScalesEstimatorType;
  ...
  typedef Array<RealType>                                             LearningRatesArrayType;
  ...
  /** Set/Get the scales estimator. */
  itkSetObjectMacro( ScalesEstimator, ScalesEstimatorType );
  itkGetObjectMacro( ScalesEstimator, ScalesEstimatorType );
  ...
  /** Set/Get the number of iterations for each level. */
  ...
  /** Set/Get the learning rates for each level. */
  itkSetMacro( LearningRatesPerLevel, LearningRatesArrayType );
  itkGetConstMacro( LearningRatesPerLevel, LearningRatesArrayType );
...
protected:
  ...
  void InitializeRegistrationAtEachLevel( const SizeValueType );
...
private:
  ...
  ScalesEstimatorPointer                                          m_ScalesEstimator;
  ...
  LearningRatesArrayType                                          m_LearningRatesPerLevel;
