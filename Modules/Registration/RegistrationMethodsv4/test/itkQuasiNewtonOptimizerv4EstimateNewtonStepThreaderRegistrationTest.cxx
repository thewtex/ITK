 ...
 * QuasiNewtonOptimizerv4EstimateNewtonStepThreader classes.
 *
...
int itkQuasiNewtonOptimizerv4EstimateNewtonStepThreaderRegistrationTestMain(int argc, char *argv[])
{
...
int itkQuasiNewtonOptimizerv4EstimateNewtonStepThreaderRegistrationTest(int argc, char *argv[])
{
  if( argc < 5 )
    {
  ...
  if (Dimension==2)
    ...
    return itkQuasiNewtonOptimizerv4EstimateNewtonStepThreaderRegistrationTestMain
