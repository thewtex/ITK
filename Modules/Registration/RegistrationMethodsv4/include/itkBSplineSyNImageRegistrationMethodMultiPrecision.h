 ...
 *
 *=========================================================================*/
#ifndef __itkBSplineSyNImageRegistrationMethodMultiPrecision_h
#define __itkBSplineSyNImageRegistrationMethodMultiPrecision_h
...
/** \class BSplineSyNImageRegistrationMethodMultiPrecision
...
class ITK_EXPORT BSplineSyNImageRegistrationMethodMultiPrecision
: public SyNImageRegistrationMethodMultiPrecision<TFixedImage, TMovingImage, TOutputTransform>
{
public:
  /** Standard class typedefs. */
  typedef BSplineSyNImageRegistrationMethodMultiPrecision                             Self;
  typedef SyNImageRegistrationMethodMultiPrecision
  ...
  itkTypeMacro( BSplineSyNImageRegistrationMethodMultiPrecision, SyNImageRegistrationMethodMultiPrecision );
...
protected:
  BSplineSyNImageRegistrationMethodMultiPrecision();
  virtual ~BSplineSyNImageRegistrationMethodMultiPrecision();
...
private:
  BSplineSyNImageRegistrationMethodMultiPrecision( const Self & );   //purposely not implemented
  void operator=( const Self & );               //purposely not implemented
};
} // end namespace itk

#ifndef ITK_MANUAL_INSTANTIATION
#include "itkBSplineSyNImageRegistrationMethodMultiPrecision.hxx"
#endif
