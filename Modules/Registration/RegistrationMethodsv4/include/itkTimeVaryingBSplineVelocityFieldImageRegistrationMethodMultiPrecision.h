 ...
 *
 *=========================================================================*/
#ifndef __itkTimeVaryingBSplineVelocityFieldImageRegistrationMethodMultiPrecision_h
#define __itkTimeVaryingBSplineVelocityFieldImageRegistrationMethodMultiPrecision_h
...
/** \class TimeVaryingBSplineVelocityFieldImageRegistrationMethodMultiPrecision
...
class ITK_EXPORT TimeVaryingBSplineVelocityFieldImageRegistrationMethodMultiPrecision
: public ImageRegistrationMethodMultiPrecisionv4<TFixedImage, TMovingImage, TOutputTransform>
{
public:
  /** Standard class typedefs. */
  typedef TimeVaryingBSplineVelocityFieldImageRegistrationMethodMultiPrecision                      Self;
  typedef ImageRegistrationMethodMultiPrecisionv4<TFixedImage, TMovingImage, TOutputTransform>      Superclass;
  ...
  itkTypeMacro( TimeVaryingBSplineVelocityFieldImageRegistrationMethodMultiPrecision, SimpleImageRegistrationMethod );
...
protected:
  TimeVaryingBSplineVelocityFieldImageRegistrationMethodMultiPrecision();
  virtual ~TimeVaryingBSplineVelocityFieldImageRegistrationMethodMultiPrecision();
...
private:
  TimeVaryingBSplineVelocityFieldImageRegistrationMethodMultiPrecision( const Self & );   //purposely not
                                                             // implemented
...
#include "itkTimeVaryingBSplineVelocityFieldImageRegistrationMethodMultiPrecision.hxx"
#endif
