...
::ComputeUpdateField( const FixedImageType * fixedImage, const TransformBaseType * fixedTransform, const MovingImageType * movingImage, const TransformBaseType * movingTransform, MeasureType & value )
{
  ...
  this->m_Metrics[0]->SetFixedImage( fixedImage );
  this->m_Metrics[0]->SetFixedTransform( const_cast<TransformBaseType *>( fixedTransform ) );
  this->m_Metrics[0]->SetMovingImage( movingImage );
  this->m_Metrics[0]->SetMovingTransform( const_cast<TransformBaseType *>( movingTransform ) );
