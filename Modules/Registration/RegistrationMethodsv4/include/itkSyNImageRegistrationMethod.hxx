...
::StartOptimization()
{
  ...
  while( iteration++ < this->m_NumberOfIterationsPerLevel[this->m_CurrentLevel] && !isConverged )
    ...
    DisplacementFieldPointer fixedToMiddleSmoothTotalField = this->GaussianSmoothDisplacementField( fixedComposer->GetOutput(), this->m_GaussianSmoothingVarianceForTheTotalField );
    ...
    DisplacementFieldPointer movingToMiddleSmoothTotalField = this->GaussianSmoothDisplacementField( movingComposer->GetOutput(), this->m_GaussianSmoothingVarianceForTheTotalField );

    // Iteratively estimate the inverse fields.

    DisplacementFieldPointer fixedToMiddleSmoothTotalFieldInverse = this->InvertDisplacementField( fixedToMiddleSmoothTotalField );
    fixedToMiddleSmoothTotalField = this->InvertDisplacementField( fixedToMiddleSmoothTotalFieldInverse );

    DisplacementFieldPointer movingToMiddleSmoothTotalFieldInverse = this->InvertDisplacementField( movingToMiddleSmoothTotalField );
    movingToMiddleSmoothTotalField = this->InvertDisplacementField( movingToMiddleSmoothTotalFieldInverse );
...
typename SyNImageRegistrationMethod<TFixedImage, TMovingImage, TOutputTransform>::DisplacementFieldPointer
SyNImageRegistrationMethod<TFixedImage, TMovingImage, TOutputTransform>
::InvertDisplacementField( const DisplacementFieldType * field )
{
...
::GenerateData()
{
  ...
  composer->SetDisplacementField( this->m_FixedToMiddleTransform->GetDisplacementField() );
  composer->SetWarpingField( this->m_MovingToMiddleTransform->GetInverseDisplacementField() );
  composer->Update();

  typename ComposerType::Pointer inverseComposer = ComposerType::New();
  inverseComposer->SetDisplacementField( this->m_MovingToMiddleTransform->GetDisplacementField() );
  inverseComposer->SetWarpingField( this->m_FixedToMiddleTransform->GetInverseDisplacementField() );
