...
//   movingWriter->SetFileName( "/Users/ntustison/Desktop/movingImage.nii.gz" );
//   movingWriter->SetInput( this->m_Metric->GetFixedImage() );
//   movingWriter->Update();
//
//   typedef ImageFileWriter<FixedImageType> FixedWriterType;
//   typename FixedWriterType::Pointer fixedWriter = FixedWriterType::New();
//   fixedWriter->SetFileName( "/Users/ntustison/Desktop/fixedImage.nii.gz" );
//   fixedWriter->SetInput( this->m_Metric->GetFixedImage() );
//   fixedWriter->Update();
//
//   int q;
//   std::cin >> q;
...
::SetMetricSamplePoints()
{
  ...
  if( numberOfLocalMetrics == 1 )
    ...
    {
    virtualImage = dynamic_cast<MetricType *>( multiMetric->GetMetricQueue()[0].GetPointer() )->GetVirtualImage();
    }
