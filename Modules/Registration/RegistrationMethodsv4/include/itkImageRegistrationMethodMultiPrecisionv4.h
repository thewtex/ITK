 ...
 *
 *=========================================================================*/
#ifndef __itkImageRegistrationMethodMultiPrecisionv4_h
#define __itkImageRegistrationMethodMultiPrecisionv4_h
...
/** \class ImageRegistrationMethodMultiPrecisionv4
...
class ITK_EXPORT ImageRegistrationMethodMultiPrecisionv4
:public ProcessObject
{
public:
  /** Standard class typedefs. */
  typedef ImageRegistrationMethodMultiPrecisionv4   Self;
  ...
  itkTypeMacro( ImageRegistrationMethodMultiPrecisionv4, ProcessObject );
  ...
  typedef ObjectToObjectMultiMetricTemplatev4<RealType, ImageDimension, ImageDimension> MultiMetricType;
  typedef ImageToImageMetricComputationTypeTemplatev4
                    <RealType, FixedImageType, MovingImageType>                         ImageMetricType;
...
protected:
  ...
  virtual ~ImageRegistrationMethodMultiPrecisionv4();
...
private:
  ImageRegistrationMethodMultiPrecisionv4( const Self & );   //purposely not implemented
  void operator=( const Self & );                  //purposely not implemented
};
} // end namespace itk

#ifndef ITK_MANUAL_INSTANTIATION
#include "itkImageRegistrationMethodMultiPrecisionv4.hxx"
#endif
