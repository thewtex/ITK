 ...
 *
 *=========================================================================*/
#ifndef __itkSyNImageRegistrationMethodMultiPrecision_h
#define __itkSyNImageRegistrationMethodMultiPrecision_h
...
/** \class SyNImageRegistrationMethodMultiPrecision
...
class ITK_EXPORT SyNImageRegistrationMethodMultiPrecision
: public ImageRegistrationMethodMultiPrecisionv4<TFixedImage, TMovingImage, TOutputTransform>
{
public:
  /** Standard class typedefs. */
  typedef SyNImageRegistrationMethodMultiPrecision                                    Self;
  ...
  itkTypeMacro( SyNImageRegistrationMethodMultiPrecision, SimpleImageRegistrationMethod );
...
protected:
  SyNImageRegistrationMethodMultiPrecision();
  virtual ~SyNImageRegistrationMethodMultiPrecision();
...
private:
  SyNImageRegistrationMethodMultiPrecision( const Self & );   //purposely not implemented
...
#include "itkSyNImageRegistrationMethodMultiPrecision.hxx"
#endif
