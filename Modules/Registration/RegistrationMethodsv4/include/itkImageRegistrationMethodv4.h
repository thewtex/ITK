...
public:
  ...
  /**
   * Set/Get the initial fixed parameters of the output optimizable transform.
   */
  void SetInitialTransformFixedParameters( const ParametersType & fixedParam )
    {
    this->m_InitialTransformFixedParameters = fixedParam;
    this->Modified();
    }

  itkGetConstReferenceMacro(InitialTransformFixedParameters, ParametersType);
...
protected:
  ...
  ParametersType                                                  m_InitialTransformFixedParameters;
