...
public:
   ...
   *
   * This transform is composed with the MovingInitialTrasnsform to
   * specify the initial transformation to from the moving image to
  ...
  virtual OutputTransformType * GetTransform();
