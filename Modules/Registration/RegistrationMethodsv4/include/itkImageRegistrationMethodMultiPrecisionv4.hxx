 ...
 *
 *=========================================================================*/
#ifndef __itkImageRegistrationMethodMultiPrecisionv4_hxx
#define __itkImageRegistrationMethodMultiPrecisionv4_hxx

#include "itkImageRegistrationMethodMultiPrecisionv4.h"

#include "itkDiscreteGaussianImageFilter.h"
#include "itkGradientDescentOptimizerTemplatev4.h"
#include "itkGradientDescentOptimizerv4.h" //for compatiblity of test files.
...
ImageRegistrationMethodMultiPrecisionv4<TFixedImage, TMovingImage, TTransform>
::ImageRegistrationMethodMultiPrecisionv4()
{
  ...
  typedef MattesMutualInformationImageToImageMetricComputationTypeTemplatev4
                                        <RealType, FixedImageType, MovingImageType> DefaultMetricType;
  ...
  typedef RegistrationParameterScalesFromPhysicalShiftTemplate<DefaultMetricType> DefaultScalesEstimatorType;
...
template<typename TFixedImage, typename TMovingImage, typename TTransform>
const typename ImageRegistrationMethodMultiPrecisionv4<TFixedImage, TMovingImage, TTransform>::FixedImageType *
ImageRegistrationMethodMultiPrecisionv4<TFixedImage, TMovingImage, TTransform>
...
template<typename TFixedImage, typename TMovingImage, typename TTransform>
const typename ImageRegistrationMethodMultiPrecisionv4<TFixedImage, TMovingImage, TTransform>::MovingImageType *
ImageRegistrationMethodMultiPrecisionv4<TFixedImage, TMovingImage, TTransform>
 ...
 */
template<typename TFixedImage, typename TMovingImage, typename TTransform>
const typename  ImageRegistrationMethodMultiPrecisionv4<TFixedImage, TMovingImage, TTransform>::TransformParametersAdaptorsContainerType &
ImageRegistrationMethodMultiPrecisionv4<TFixedImage, TMovingImage, TTransform>
 ...
 */
template<typename TFixedImage, typename TMovingImage, typename TTransform>
const typename ImageRegistrationMethodMultiPrecisionv4<TFixedImage, TMovingImage, TTransform>::DecoratedOutputTransformType *
ImageRegistrationMethodMultiPrecisionv4<TFixedImage, TMovingImage, TTransform>
::GetOutput() const
{
