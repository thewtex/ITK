 ...
 *
 *=========================================================================*/
#ifndef __itkTimeVaryingVelocityFieldImageRegistrationMethodMultiPrecisionv4_h
#define __itkTimeVaryingVelocityFieldImageRegistrationMethodMultiPrecisionv4_h
...
/** \class TimeVaryingVelocityFieldImageRegistrationMethodMultiPrecisionv4
 ...
 * composite transform.
 *
 * This derived class from the ImageRegistrationMethodMultiPrecisionv4 class
...
class ITK_EXPORT TimeVaryingVelocityFieldImageRegistrationMethodMultiPrecisionv4
: public ImageRegistrationMethodMultiPrecisionv4<TFixedImage, TMovingImage, TOutputTransform>
{
public:
  /** Standard class typedefs. */
  typedef TimeVaryingVelocityFieldImageRegistrationMethodMultiPrecisionv4         Self;
  typedef ImageRegistrationMethodMultiPrecisionv4
                             <TFixedImage, TMovingImage, TOutputTransform>        Superclass;
  ...
  itkTypeMacro( TimeVaryingVelocityFieldImageRegistrationMethodMultiPrecisionv4, ImageRegistrationMethodMultiPrecisionv4 );
...
protected:
  TimeVaryingVelocityFieldImageRegistrationMethodMultiPrecisionv4();
  virtual ~TimeVaryingVelocityFieldImageRegistrationMethodMultiPrecisionv4();
...
private:
  TimeVaryingVelocityFieldImageRegistrationMethodMultiPrecisionv4( const Self & );   //purposely not
                                                             // implemented
...
#include "itkTimeVaryingVelocityFieldImageRegistrationMethodMultiPrecisionv4.hxx"
#endif
