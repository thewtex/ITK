...
public:
  ...
  /** set/get OpenCL workgroup size, should be multiple of warp size (32 for Kepler and earlier) */
  itkSetMacro(WorkGroupSize, size_t);
  itkGetConstReferenceMacro(WorkGroupSize, size_t);
