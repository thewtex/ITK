 ...
 *
 *  This templated function test the MattesMutualInformationImageToMetricv4
...
//------------------------------------------------------------
  ...
  std::cout << "useExplicitJointPDFDerivatives: " << useExplicitJointPDFDerivatives << std::endl;
  ...
  */
  ...
  failed = TestMattesMetricWithBSplineTransform<
    ImageType,BSplineInterpolatorType>( bSplineInterpolator, useSampling,
        useExplicitJointPDFDerivatives );
