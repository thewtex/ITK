...
int itkObjectToObjectMultiMetricv4TestRun ( ObjectToObjectMultiMetricv4TestMultiMetricType::Pointer & multiVariateMetric )
{
...
int itkObjectToObjectMultiMetricv4Test (int , char *[])
{
  ...
  if( itkObjectToObjectMultiMetricv4TestRun( multiVariateMetric ) != EXIT_SUCCESS )
    {
    return EXIT_FAILURE;
    }
  ...
  //
  // Test basic operation with a scales estimator
  //
