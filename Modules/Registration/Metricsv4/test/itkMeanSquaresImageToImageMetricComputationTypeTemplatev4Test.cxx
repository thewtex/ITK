...
int itkMeanSquaresImageToImageMetricComputationTypeTemplatev4Test(int, char ** const)
{
  ...
  /* The metric */
  typedef itk::MeanSquaresImageToImageMetricComputationTypeTemplatev4< double, ImageType, ImageType, ImageType > MetricType;
