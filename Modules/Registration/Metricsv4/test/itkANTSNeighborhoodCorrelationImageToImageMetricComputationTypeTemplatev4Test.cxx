...
/**
 * Test program for ANTSNeighborhoodCorrelationImageToImageMetricComputationTypeTemplatev4,
 * using a synthetic image and initial displacement.
 *
 */

template<class ImagePointerType, class DerivativeType>
void ANTSNeighborhoodCorrelationImageToImageMetricComputationTypeTemplatev4Test_PrintDerivativeAsVectorImage(
...
void ANTSNeighborhoodCorrelationImageToImageMetricComputationTypeTemplatev4Test_PrintImage(ImageType *imageP) {
...
void ANTSNeighborhoodCorrelationImageToImageMetricComputationTypeTemplatev4Test_PrintImage(const ImagePointerType &image) {
...
int itkANTSNeighborhoodCorrelationImageToImageMetricComputationTypeTemplatev4Test( int, char ** const )
{
  ...
  typedef itk::ANTSNeighborhoodCorrelationImageToImageMetricComputationTypeTemplatev4<double, ImageType, ImageType> MetricType;
  ...
  ANTSNeighborhoodCorrelationImageToImageMetricComputationTypeTemplatev4Test_PrintImage(fixedImage);

  std::cout << "movingImage:" << std::endl;
 ANTSNeighborhoodCorrelationImageToImageMetricComputationTypeTemplatev4Test_PrintImage(movingImage);
  ...
  ANTSNeighborhoodCorrelationImageToImageMetricComputationTypeTemplatev4Test_PrintImage(transformMdisplacement->GetDisplacementField());
  ...
  ANTSNeighborhoodCorrelationImageToImageMetricComputationTypeTemplatev4Test_PrintDerivativeAsVectorImage(fixedImage, derivativeReturn, ImageDimension);
  ...
  ANTSNeighborhoodCorrelationImageToImageMetricComputationTypeTemplatev4Test_PrintDerivativeAsVectorImage(fixedImage, derivativeReturnSparse, ImageDimension);
