...
int itkDemonsImageToImageMetricComputationTypeTemplatev4Test(int, char ** const)
{
  ...
  /* The metric */
  typedef itk::DemonsImageToImageMetricComputationTypeTemplatev4< double, ImageType, ImageType, ImageType > MetricType;
