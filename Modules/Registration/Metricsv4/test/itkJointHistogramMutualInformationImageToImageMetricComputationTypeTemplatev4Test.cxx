...
int itkJointHistogramMutualInformationImageToImageMetricComputationTypeTemplatev4Test( int , char * [] )
{
  ...
  /* The metric */
  typedef itk::JointHistogramMutualInformationImageToImageMetricComputationTypeTemplatev4< double,
                                                                                           ImageType,
                                                                                           ImageType,
                                                                                           ImageType >
                                                                                                          MetricType;
