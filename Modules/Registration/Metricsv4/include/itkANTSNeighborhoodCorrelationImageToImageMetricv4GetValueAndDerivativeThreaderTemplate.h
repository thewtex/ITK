 ...
 *
 *=========================================================================*/
#ifndef __itkANTSNeighborhoodCorrelationImageToImageMetricv4GetValueAndDerivativeThreaderTemplate_h
#define __itkANTSNeighborhoodCorrelationImageToImageMetricv4GetValueAndDerivativeThreaderTemplate_h
 ...
 */
template<class T>
struct IdentityHelperTemplate
{
  typedef T MyType;
};

/** \class ANTSNeighborhoodCorrelationImageToImageMetricv4GetValueAndDerivativeThreaderTemplate
...
class ANTSNeighborhoodCorrelationImageToImageMetricv4GetValueAndDerivativeThreaderTemplate
  : public ImageToImageMetricv4GetValueAndDerivativeThreaderTemplate< TDomainPartitioner, TImageToImageMetric >
{
public:
  /** Standard class typedefs. */
  typedef ANTSNeighborhoodCorrelationImageToImageMetricv4GetValueAndDerivativeThreaderTemplate Self;
  typedef ImageToImageMetricv4GetValueAndDerivativeThreaderTemplate< TDomainPartitioner, TImageToImageMetric >
                                                                                                Superclass;
  typedef SmartPointer< Self >                                                                  Pointer;
  typedef SmartPointer< const Self >                                                            ConstPointer;

  itkTypeMacro( ANTSNeighborhoodCorrelationImageToImageMetricv4GetValueAndDerivativeThreaderTemplate, ImageToImageMetricv4GetValueAndDerivativeThreaderTemplate );
...
protected:
  ANTSNeighborhoodCorrelationImageToImageMetricv4GetValueAndDerivativeThreaderTemplate() {}
   ...
   * dense and sparse cases differently. The helper class IdentityHelperTemplate allows for correct overloading
   ...
   *
   * Specifically, a helper class \c IdentityHelperTemplate is used as a function parameter, with the sole purpose
   * to differentiate different types of domain partitioners: \c ThreadedIndexedContainerPartitioner for sparse
   * or \c ThreadedImageRegionPartitioner for dense. \c IdentityHelperTemplate is simply a class template, ie. a struct
   ...
   * templates. The helper class \c IdentityHelperTemplate is used to overload w.r.t different partitioner types.
  ...
  virtual bool ProcessVirtualPoint( const VirtualIndexType & virtualIndex,
    ...
    return ProcessVirtualPoint_impl(IdentityHelperTemplate<TDomainPartitioner>(), virtualIndex, virtualPoint, threadId );
  }

  /* specific overloading for sparse CC metric */
  bool ProcessVirtualPoint_impl(
                             IdentityHelperTemplate<ThreadedIndexedContainerPartitioner> itkNotUsed(self),
  ...
  template<class T>
  bool ProcessVirtualPoint_impl(
                             IdentityHelperTemplate<T> itkNotUsed(self),
                             const VirtualIndexType & virtualIndex,
                             const VirtualPointType & virtualPoint,
                             const ThreadIdType threadId ) {
  ...
  virtual void ThreadedExecution( const DomainType& domain,
                                    const ThreadIdType threadId ){
    ThreadedExecution_impl(IdentityHelperTemplate<TDomainPartitioner>(), domain, threadId );
  }

  /* specific overloading for dense threader only based CC metric */
  void ThreadedExecution_impl(
                             IdentityHelperTemplate<ThreadedImageRegionPartitioner<TImageToImageMetric::VirtualImageDimension> > itkNotUsed(self),
...
private:
  ANTSNeighborhoodCorrelationImageToImageMetricv4GetValueAndDerivativeThreaderTemplate( const Self & ); // purposely not implemented
...
#include "itkANTSNeighborhoodCorrelationImageToImageMetricv4GetValueAndDerivativeThreaderTemplate.hxx"
#endif
