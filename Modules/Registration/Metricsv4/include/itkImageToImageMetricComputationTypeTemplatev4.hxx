 ...
 *
 *=========================================================================*/
#ifndef __itkImageToImageMetricComputationTypeTemplatev4_hxx
#define __itkImageToImageMetricComputationTypeTemplatev4_hxx
...
template<class InternalComputationValueType, class TFixedImage,class TMovingImage,class TVirtualImage, typename TMetricTraits>
ImageToImageMetricComputationTypeTemplatev4<InternalComputationValueType, TFixedImage, TMovingImage, TVirtualImage, TMetricTraits >
...
template<class InternalComputationValueType, class TFixedImage,class TMovingImage,class TVirtualImage, typename TMetricTraits>
typename ImageToImageMetricComputationTypeTemplatev4<InternalComputationValueType, TFixedImage, TMovingImage, TVirtualImage, TMetricTraits >::MeasureType
ImageToImageMetricComputationTypeTemplatev4<InternalComputationValueType, TFixedImage, TMovingImage, TVirtualImage, TMetricTraits >
::GetValue() const
{
...
::GetValueAndDerivativeExecute() const
{
  if( this->m_UseFixedSampledPointSet ) // sparse sampling
    ...
    typename ImageToImageMetricv4GetValueAndDerivativeThreaderTemplate< ThreadedIndexedContainerPartitioner, Self >::DomainType range;
    range[0] = 0;
