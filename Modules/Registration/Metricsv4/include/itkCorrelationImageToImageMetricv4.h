...
#include "itkCorrelationHelperImageToImageMetricv4GetValueAndDerivativeThreader.h"
 ...
 *  towards its minimal value, which is required by metricv4 framework. Note that
...
protected:
  ...
  /*
   * For the threader class to get access to the private/protected
   * member variables from base metric class
   */
//  DerivativeType *&  GetReferenceDerivativeResult(){return this->m_DerivativeResult;}
//  SizeValueType & GetReferenceNumberOfValidPoints(){return this->m_NumberOfValidPoints;}
//  MeasureType & GetReferenceValue(){return this->m_Value;}
  ...
  friend class CorrelationHelperImageToImageMetricv4GetValueAndDerivativeThreader< ThreadedImageRegionPartitioner< Superclass::VirtualImageDimension >, Superclass, Self >;
  friend class CorrelationHelperImageToImageMetricv4GetValueAndDerivativeThreader< ThreadedIndexedContainerPartitioner, Superclass, Self >;

  typedef CorrelationHelperImageToImageMetricv4GetValueAndDerivativeThreader< ThreadedImageRegionPartitioner< Superclass::VirtualImageDimension >, Superclass, Self >
    CorrelationHelperDenseThreaderType;
  typedef CorrelationHelperImageToImageMetricv4GetValueAndDerivativeThreader< ThreadedIndexedContainerPartitioner, Superclass, Self >
