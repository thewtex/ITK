 ...
 *
 *=========================================================================*/
#ifndef __itkImageToImageMetricv4GetValueAndDerivativeThreaderBaseTemplate_h
#define __itkImageToImageMetricv4GetValueAndDerivativeThreaderBaseTemplate_h
...
/** \class ImageToImageMetricv4GetValueAndDerivativeThreaderBaseTemplate
 ...
 *  \tparam TImageToImageMetricComputationTypeTemplatev4 type of the ImageToImageMetricComputationTypeTemplatev4
 *
...
class ImageToImageMetricv4GetValueAndDerivativeThreaderBaseTemplate
  : public DomainThreader< TDomainPartitioner, TImageToImageMetricComputationTypeTemplatev4 >
{
public:
  /** Standard class typedefs. */
  typedef ImageToImageMetricv4GetValueAndDerivativeThreaderBaseTemplate                               Self;
  typedef DomainThreader< TDomainPartitioner, TImageToImageMetricComputationTypeTemplatev4 >  Superclass;
  typedef SmartPointer< Self >                                                                Pointer;
  typedef SmartPointer< const Self >                                                          ConstPointer;

  itkTypeMacro( ImageToImageMetricv4GetValueAndDerivativeThreaderBaseTemplate, DomainThreader );
  ...
  typedef typename ImageToImageMetricv4Type::ParametersValueType          InternalComputationValueType;
...
protected:
  /** Constructor. */
  ImageToImageMetricv4GetValueAndDerivativeThreaderBaseTemplate();
...
private:
  ImageToImageMetricv4GetValueAndDerivativeThreaderBaseTemplate( const Self & ); // purposely not implemented
...
#include "itkImageToImageMetricv4GetValueAndDerivativeThreaderBaseTemplate.hxx"
#endif
