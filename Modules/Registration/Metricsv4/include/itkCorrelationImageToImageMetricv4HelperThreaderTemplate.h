 ...
 *
 *=========================================================================*/
#ifndef __itkCorrelationImageToImageMetricv4HelperThreaderTemplate_h
#define __itkCorrelationImageToImageMetricv4HelperThreaderTemplate_h
...
class CorrelationImageToImageMetricv4HelperThreaderTemplate
  : public ImageToImageMetricv4GetValueAndDerivativeThreaderTemplate< TDomainPartitioner, TImageToImageMetric >
{
public:
  /** Standard class typedefs. */
  typedef CorrelationImageToImageMetricv4HelperThreaderTemplate                                      Self;
  ...
  itkTypeMacro( CorrelationImageToImageMetricv4HelperThreaderTemplate, ImageToImageMetricv4GetValueAndDerivativeThreaderTemplate );
...
protected:
  CorrelationImageToImageMetricv4HelperThreaderTemplate() {}
...
private:
  CorrelationImageToImageMetricv4HelperThreaderTemplate( const Self & ); // purposely not implemented
...
#include "itkCorrelationImageToImageMetricv4HelperThreaderTemplate.hxx"
#endif
