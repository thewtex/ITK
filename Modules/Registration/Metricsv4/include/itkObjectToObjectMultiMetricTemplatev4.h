...
#ifndef __itkObjectToObjectMultiMetricTemplatev4_h
#define __itkObjectToObjectMultiMetricTemplatev4_h
...
namespace itk
{
/** \class ObjectToObjectMultiMetricTemplatev4
...
class ITK_EXPORT ObjectToObjectMultiMetricTemplatev4:
  public ObjectToObjectMetricComputationTypeTemplate<ParametersValueType, TFixedDimension, TMovingDimension, TVirtualImage>
{
public:
  /** Standard class typedefs */
  typedef ObjectToObjectMultiMetricTemplatev4                                                           Self;
  typedef ObjectToObjectMetricComputationTypeTemplate
                              <ParametersValueType, TFixedDimension, TMovingDimension, TVirtualImage>   Superclass;
  typedef SmartPointer<Self>                                                                            Pointer;
  typedef SmartPointer<const Self>                                                                      ConstPointer;

  /** Run-time type information (and related methods). */
  itkTypeMacro(ObjectToObjectMultiMetricTemplatev4, ObjectToObjectMetricComputationTypeTemplate);
...
protected:
  ...
  ObjectToObjectMultiMetricTemplatev4();
  virtual ~ObjectToObjectMultiMetricTemplatev4();
...
private:
  ...
  ObjectToObjectMultiMetricTemplatev4(const Self &);
...
#include "itkObjectToObjectMultiMetricTemplatev4.hxx"
#endif
