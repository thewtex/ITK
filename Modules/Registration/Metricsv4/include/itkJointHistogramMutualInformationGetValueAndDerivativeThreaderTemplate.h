 ...
 *
 *=========================================================================*/
#ifndef __itkJointHistogramMutualInformationGetValueAndDerivativeThreaderTemplate_h
#define __itkJointHistogramMutualInformationGetValueAndDerivativeThreaderTemplate_h
...
/** \class JointHistogramMutualInformationGetValueAndDerivativeThreaderTemplate
...
public:
  ...
  typedef JointHistogramMutualInformationGetValueAndDerivativeThreaderTemplate Self;
  typedef ImageToImageMetricv4GetValueAndDerivativeThreaderTemplate< TDomainPartitioner, TImageToImageMetric >
                                                                       Superclass;
  typedef SmartPointer< Self >                                         Pointer;
  typedef SmartPointer< const Self >                                   ConstPointer;

  itkTypeMacro( JointHistogramMutualInformationGetValueAndDerivativeThreaderTemplate, ImageToImageMetricv4GetValueAndDerivativeThreaderTemplate );
...
protected:
  JointHistogramMutualInformationGetValueAndDerivativeThreaderTemplate() {}
...
private:
  JointHistogramMutualInformationGetValueAndDerivativeThreaderTemplate( const Self & ); // purposely not implemented
...
#include "itkJointHistogramMutualInformationGetValueAndDerivativeThreaderTemplate.hxx"
#endif
