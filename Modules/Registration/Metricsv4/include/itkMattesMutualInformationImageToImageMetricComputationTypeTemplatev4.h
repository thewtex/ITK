 ...
 *
 *=========================================================================*/
#ifndef __itkMattesMutualInformationImageToImageMetricComputationTypeTemplatev4_h
#define __itkMattesMutualInformationImageToImageMetricComputationTypeTemplatev4_h

#include "itkImageToImageMetricComputationTypeTemplatev4.h"
#include "itkMattesMutualInformationImageToImageMetricv4GetValueAndDerivativeThreaderTemplate.h"
#include "itkPoint.h"
#include "itkIndex.h"
...
/** \class MattesMutualInformationImageToImageMetricComputationTypeTemplatev4
 *
 ...
 *
 * See
 *  MattesMutualInformationImageToImageMetricv4GetValueAndDerivativeThreaderTemplate::ProcessPoint
 *  for poritons of the algorithm implementation.
 *
 * See ImageToImageMetricComputationTypeTemplatev4 for details of common metric operation and options.
 *
 * References:
...
class ITK_EXPORT MattesMutualInformationImageToImageMetricComputationTypeTemplatev4 :
...
public:
  ...
  typedef MattesMutualInformationImageToImageMetricComputationTypeTemplatev4                    Self;
  ...
  itkTypeMacro(MattesMutualInformationImageToImageMetricComputationTypeTemplatev4, ImageToImageMetricComputationTypeTemplatev4);
...
protected:
  MattesMutualInformationImageToImageMetricComputationTypeTemplatev4();
  virtual ~MattesMutualInformationImageToImageMetricComputationTypeTemplatev4();

  friend class MattesMutualInformationImageToImageMetricv4GetValueAndDerivativeThreaderTemplate< ThreadedImageRegionPartitioner< Superclass::VirtualImageDimension >, Superclass, Self >;
  friend class MattesMutualInformationImageToImageMetricv4GetValueAndDerivativeThreaderTemplate< ThreadedIndexedContainerPartitioner, Superclass, Self >;
  typedef MattesMutualInformationImageToImageMetricv4GetValueAndDerivativeThreaderTemplate< ThreadedImageRegionPartitioner< Superclass::VirtualImageDimension >, Superclass, Self >
    MattesMutualInformationDenseGetValueAndDerivativeThreaderType;
  typedef MattesMutualInformationImageToImageMetricv4GetValueAndDerivativeThreaderTemplate< ThreadedIndexedContainerPartitioner, Superclass, Self >
...
private:
  MattesMutualInformationImageToImageMetricComputationTypeTemplatev4(const Self &); //purposely not implemented
...
#include "itkMattesMutualInformationImageToImageMetricComputationTypeTemplatev4.hxx"
#endif
