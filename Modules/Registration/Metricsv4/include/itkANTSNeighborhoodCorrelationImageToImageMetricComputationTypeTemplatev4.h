 ...
 *
 *=========================================================================*/
#ifndef __itkANTSNeighborhoodCorrelationImageToImageMetricComputationTypeTemplatev4_h
#define __itkANTSNeighborhoodCorrelationImageToImageMetricComputationTypeTemplatev4_h

#include "itkImageToImageMetricComputationTypeTemplatev4.h"
#include "itkANTSNeighborhoodCorrelationImageToImageMetricv4GetValueAndDerivativeThreaderTemplate.h"

namespace itk {

/** \class ANTSNeighborhoodCorrelationImageToImageMetricComputationTypeTemplatev4
 *
 ...
 *  Example of usage:
 *
 *  typedef itk::ANTSNeighborhoodCorrelationImageToImageMetricComputationTypeTemplatev4
...
class ITK_EXPORT ANTSNeighborhoodCorrelationImageToImageMetricComputationTypeTemplatev4 :
...
public:
  ...
  typedef ANTSNeighborhoodCorrelationImageToImageMetricComputationTypeTemplatev4                Self;
...
protected:
  ...
  virtual ~ANTSNeighborhoodCorrelationImageToImageMetricComputationTypeTemplatev4();

  friend class ANTSNeighborhoodCorrelationImageToImageMetricv4GetValueAndDerivativeThreaderTemplate< ThreadedImageRegionPartitioner< VirtualImageDimension >, Superclass, Self >;
  typedef ANTSNeighborhoodCorrelationImageToImageMetricv4GetValueAndDerivativeThreaderTemplate< ThreadedImageRegionPartitioner< VirtualImageDimension >, Superclass, Self >
    ANTSNeighborhoodCorrelationImageToImageMetricv4DenseGetValueAndDerivativeThreaderType;

  friend class ANTSNeighborhoodCorrelationImageToImageMetricv4GetValueAndDerivativeThreaderTemplate< ThreadedIndexedContainerPartitioner, Superclass, Self >;
  typedef ANTSNeighborhoodCorrelationImageToImageMetricv4GetValueAndDerivativeThreaderTemplate< ThreadedIndexedContainerPartitioner, Superclass, Self >
    ANTSNeighborhoodCorrelationImageToImageMetricv4SparseGetValueAndDerivativeThreaderType;

  virtual void PrintSelf(std::ostream & os, Indent indent) const;

private:
  ANTSNeighborhoodCorrelationImageToImageMetricComputationTypeTemplatev4( const Self & ); //purposely not implemented
...
#include "itkANTSNeighborhoodCorrelationImageToImageMetricComputationTypeTemplatev4.hxx"
#endif
