 ...
 *
 *=========================================================================*/
#ifndef __itkCorrelationImageToImageMetricv4GetValueAndDerivativeThreaderTemplate_h
#define __itkCorrelationImageToImageMetricv4GetValueAndDerivativeThreaderTemplate_h
...
/** \class CorrelationImageToImageMetricv4GetValueAndDerivativeThreaderTemplate
...
public:
  ...
  typedef CorrelationImageToImageMetricv4GetValueAndDerivativeThreaderTemplate                                      Self;
  ...
  itkTypeMacro( CorrelationImageToImageMetricv4GetValueAndDerivativeThreaderTemplate, ImageToImageMetricv4GetValueAndDerivativeThreaderTemplate );
...
protected:
  CorrelationImageToImageMetricv4GetValueAndDerivativeThreaderTemplate() {}
...
private:
  CorrelationImageToImageMetricv4GetValueAndDerivativeThreaderTemplate( const Self & ); // purposely not implemented
   ...
   * class CorrelationHelperImageToImageMetricv4GetValueAndDerivativeThreaderTemplate.
...
#include "itkCorrelationImageToImageMetricv4GetValueAndDerivativeThreaderTemplate.hxx"
#endif
