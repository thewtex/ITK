...
#ifndef __itkJointHistogramMutualInformationImageToImageMetricComputationTypeTemplatev4_h
#define __itkJointHistogramMutualInformationImageToImageMetricComputationTypeTemplatev4_h

#include "itkImageToImageMetricComputationTypeTemplatev4.h"
#include "itkImage.h"
#include "itkBSplineDerivativeKernelFunction.h"

#include "itkJointHistogramMutualInformationComputeJointPDFThreaderTemplate.h"
#include "itkJointHistogramMutualInformationGetValueAndDerivativeThreaderTemplate.h"

namespace itk
{
/** \class JointHistogramMutualInformationImageToImageMetricComputationTypeTemplatev4
...
class ITK_EXPORT JointHistogramMutualInformationImageToImageMetricComputationTypeTemplatev4 :
...
public:
  ...
  typedef JointHistogramMutualInformationImageToImageMetricComputationTypeTemplatev4            Self;
  ...
  itkTypeMacro(JointHistogramMutualInformationImageToImageMetricComputationTypeTemplatev4,
                ImageToImageMetricComputationTypeTemplatev4);
...
protected:
  JointHistogramMutualInformationImageToImageMetricComputationTypeTemplatev4();
  virtual ~JointHistogramMutualInformationImageToImageMetricComputationTypeTemplatev4();
  ...
  friend class JointHistogramMutualInformationComputeJointPDFThreaderBaseTemplate< ThreadedImageRegionPartitioner< Self::VirtualImageDimension >, Self >;
  friend class JointHistogramMutualInformationComputeJointPDFThreaderBaseTemplate< ThreadedIndexedContainerPartitioner, Self >;
  friend class JointHistogramMutualInformationComputeJointPDFThreaderTemplate< ThreadedImageRegionPartitioner< Self::VirtualImageDimension >, Self >;
  friend class JointHistogramMutualInformationComputeJointPDFThreaderTemplate< ThreadedIndexedContainerPartitioner, Self >;

  typedef JointHistogramMutualInformationComputeJointPDFThreaderTemplate< ThreadedImageRegionPartitioner< Self::VirtualImageDimension >, Self >
    JointHistogramMutualInformationDenseComputeJointPDFThreaderType;
  typedef JointHistogramMutualInformationComputeJointPDFThreaderTemplate< ThreadedIndexedContainerPartitioner, Self >
  ...
  friend class JointHistogramMutualInformationGetValueAndDerivativeThreaderTemplate< ThreadedImageRegionPartitioner< Superclass::VirtualImageDimension >, Superclass, Self >;
  friend class JointHistogramMutualInformationGetValueAndDerivativeThreaderTemplate< ThreadedIndexedContainerPartitioner, Superclass, Self >;

  typedef JointHistogramMutualInformationGetValueAndDerivativeThreaderTemplate< ThreadedImageRegionPartitioner< Superclass::VirtualImageDimension >, Superclass, Self >
    JointHistogramMutualInformationDenseGetValueAndDerivativeThreaderType;
  typedef JointHistogramMutualInformationGetValueAndDerivativeThreaderTemplate< ThreadedIndexedContainerPartitioner, Superclass, Self >
...
private:
  JointHistogramMutualInformationImageToImageMetricComputationTypeTemplatev4(const Self &); //purposely not implemented
...
#include "itkJointHistogramMutualInformationImageToImageMetricComputationTypeTemplatev4.hxx"
#endif
