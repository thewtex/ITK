 ...
 *
 *=========================================================================*/
#ifndef __itkImageToImageMetricComputationTypeTemplatev4_h
#define __itkImageToImageMetricComputationTypeTemplatev4_h

#include "itkCovariantVector.h"
#include "itkImageFunction.h"
#include "itkObjectToObjectMetricComputationTypeTemplate.h"
 ...
 * See ObjectToObjectMetricComputationTypeTemplate for more discussion on the virtual domain.
 *
...
template<class InternalComputationValueType, class TFixedImage,class TMovingImage,class TVirtualImage = TFixedImage,
         typename TMetricTraits = DefaultImageToImageMetricTraitsv4< TFixedImage, TMovingImage, TVirtualImage, InternalComputationValueType > >
class ITK_EXPORT ImageToImageMetricComputationTypeTemplatev4 :
      public ObjectToObjectMetricComputationTypeTemplate<InternalComputationValueType, TFixedImage::ImageDimension, TMovingImage::ImageDimension, TVirtualImage>
{
public:

  /** Standard class typedefs. */
  typedef ImageToImageMetricComputationTypeTemplatev4                                                                                     Self;
  typedef ObjectToObjectMetricComputationTypeTemplate<InternalComputationValueType, TFixedImage::ImageDimension, TMovingImage::ImageDimension, TVirtualImage>    Superclass;
  typedef SmartPointer<Self>                                                                                                              Pointer;
  typedef SmartPointer<const Self>                                                                                                        ConstPointer;

  /** Run-time type information (and related methods). */
  itkTypeMacro(ImageToImageMetricComputationTypeTemplatev4, ObjectToObjectMetricComputationTypeTemplate);
  ...
  typedef InternalComputationValueType              ParametersValueType;
...
protected:
  ...
  friend class ImageToImageMetricv4GetValueAndDerivativeThreaderBaseTemplate< ThreadedImageRegionPartitioner< VirtualImageDimension >, Self >;
  friend class ImageToImageMetricv4GetValueAndDerivativeThreaderBaseTemplate< ThreadedIndexedContainerPartitioner, Self >;
  friend class ImageToImageMetricv4GetValueAndDerivativeThreaderTemplate< ThreadedImageRegionPartitioner< VirtualImageDimension >, Self >;
  ...
  typename ImageToImageMetricv4GetValueAndDerivativeThreaderTemplate< ThreadedImageRegionPartitioner< VirtualImageDimension >, Self >::Pointer m_DenseGetValueAndDerivativeThreader;

  /* A SparseGetValueAndDerivativeThreader
   * Derived classes must define this class and assign it in their constructor
   * if threaded processing in GetValueAndDerivative is performed. */
  typename ImageToImageMetricv4GetValueAndDerivativeThreaderTemplate< ThreadedIndexedContainerPartitioner, Self >::Pointer m_SparseGetValueAndDerivativeThreader;
  ...
  virtual ~ImageToImageMetricComputationTypeTemplatev4();
...
private:
  ImageToImageMetricComputationTypeTemplatev4(const Self &); //purposely not implemented
  void operator=(const Self &); //purposely not implemented
};
}//namespace itk

#ifndef ITK_MANUAL_INSTANTIATION
#include "itkImageToImageMetricComputationTypeTemplatev4.hxx"
#endif
