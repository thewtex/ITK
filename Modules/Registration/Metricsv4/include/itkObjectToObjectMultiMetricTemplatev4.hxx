 ...
 *
 *=========================================================================*/
#ifndef __itkObjectToObjectMultiMetricTemplatev4_hxx
#define __itkObjectToObjectMultiMetricTemplatev4_hxx
...
ObjectToObjectMultiMetricTemplatev4<ParametersValueType, TFixedDimension, TMovingDimension, TVirtualImage>
...
template<class ParametersValueType, unsigned int TFixedDimension, unsigned int TMovingDimension, class TVirtualImage>
typename ObjectToObjectMultiMetricTemplatev4<ParametersValueType, TFixedDimension, TMovingDimension, TVirtualImage>::MeasureType
ObjectToObjectMultiMetricTemplatev4<ParametersValueType, TFixedDimension, TMovingDimension, TVirtualImage>
::GetValue() const
{
  for (SizeValueType j = 0; j < this->GetNumberOfMetrics(); j++)
...
template<class ParametersValueType, unsigned int TFixedDimension, unsigned int TMovingDimension, class TVirtualImage>
typename ObjectToObjectMultiMetricTemplatev4<ParametersValueType, TFixedDimension, TMovingDimension, TVirtualImage>::MetricValueArrayType
ObjectToObjectMultiMetricTemplatev4<ParametersValueType, TFixedDimension, TMovingDimension, TVirtualImage>
::GetValueArray() const
{
...
template<class ParametersValueType, unsigned int TFixedDimension, unsigned int TMovingDimension, class TVirtualImage>
const typename ObjectToObjectMultiMetricTemplatev4<ParametersValueType, TFixedDimension, TMovingDimension, TVirtualImage>::MetricQueueType &
ObjectToObjectMultiMetricTemplatev4<ParametersValueType, TFixedDimension, TMovingDimension, TVirtualImage>
...
#endif //__itkObjectToObjectMultiMetricTemplatev4_hxx
