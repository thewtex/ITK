 ...
 *
 *=========================================================================*/
#ifndef __itkPointSetToPointSetMetricComputationTypeTemplatev4_h
#define __itkPointSetToPointSetMetricComputationTypeTemplatev4_h
...
namespace itk
{
/** \class PointSetToPointSetMetricComputationTypeTemplatev4
 ...
 *
 * See ObjectToObjectMetricComputationTypeTemplate documentation for more discussion on the virutal domain.
 *
...
template<class InternalComputationValueType, class TFixedPointSet,  class TMovingPointSet>
class ITK_EXPORT PointSetToPointSetMetricComputationTypeTemplatev4
: public ObjectToObjectMetricComputationTypeTemplate<InternalComputationValueType, TFixedPointSet::PointDimension, TMovingPointSet::PointDimension>
{
public:

  /** Standard class typedefs. */
  typedef PointSetToPointSetMetricComputationTypeTemplatev4                                                                           Self;
  typedef ObjectToObjectMetricComputationTypeTemplate<InternalComputationValueType, TFixedPointSet::PointDimension, TMovingPointSet::PointDimension>         Superclass;
  typedef SmartPointer<Self>                                                                                                          Pointer;
  typedef SmartPointer<const Self>                                                                                                    ConstPointer;

  /** Run-time type information (and related methods). */
  itkTypeMacro( PointSetToPointSetMetricComputationTypeTemplatev4, ObjectToObjectMetricComputationTypeTemplate );
...
protected:
  PointSetToPointSetMetricComputationTypeTemplatev4();
  virtual ~PointSetToPointSetMetricComputationTypeTemplatev4();
...
private:
  PointSetToPointSetMetricComputationTypeTemplatev4( const Self & ); //purposely not implemented
...
#include "itkPointSetToPointSetMetricComputationTypeTemplatev4.hxx"
#endif
