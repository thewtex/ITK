 ...
 *
 *=========================================================================*/
#ifndef __itkJointHistogramMutualInformationComputeJointPDFThreaderBaseTemplate_h
#define __itkJointHistogramMutualInformationComputeJointPDFThreaderBaseTemplate_h
...
/** \class JointHistogramMutualInformationComputeJointPDFThreaderBaseTemplate
...
public:
  ...
  typedef JointHistogramMutualInformationComputeJointPDFThreaderBaseTemplate  Self;
  typedef DomainThreader< TDomainPartitioner, TJointHistogramMetric > Superclass;
  typedef SmartPointer< Self >                                        Pointer;
  typedef SmartPointer< const Self >                                  ConstPointer;

  itkTypeMacro( JointHistogramMutualInformationComputeJointPDFThreaderBaseTemplate, DomainThreader );
...
protected:
  JointHistogramMutualInformationComputeJointPDFThreaderBaseTemplate();
...
private:
  JointHistogramMutualInformationComputeJointPDFThreaderBaseTemplate( const Self & ); // purposely not implemented
...
#include "itkJointHistogramMutualInformationComputeJointPDFThreaderBaseTemplate.hxx"
#endif
