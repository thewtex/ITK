...
int GPUDemonsRegistrationFilterTestTemplate(int argc, char *argv[])
{
  ...
  typedef GPUDisplacementFieldType::Pointer              GPUDisplacementFieldPointer;
  typedef CPUDisplacementFieldType::Pointer              CPUDisplacementFieldPointer;
...
TDisplacementFieldPointer itkGPUDemons(int, char *argv[])
{
  ...
  // demons registration
  typedef TDisplacementFieldPointer::ObjectType     DisplacementFieldType;
