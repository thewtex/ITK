...
//
// This method return 0, if the two files are equal within the
// provided tolerances. It will return max int if either file is not
// found, And will return max int - 1 if the image sizes don't match.
