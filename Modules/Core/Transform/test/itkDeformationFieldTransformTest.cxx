...
int itkDeformationFieldTransformTest(int ,char *[] )
{
  ...
  DeformationTransformType::InputDiffusionTensorType testTensor;
  DeformationTransformType::OutputDiffusionTensorType deformTensor,
                                                      deformTensorTruth;
  testTensor[0] = 3;
  testTensor[1] = 0.01;
  testTensor[2] = 0.01;
  ...
  deformTensor = deformationTransform->TransformDiffusionTensor(
  ...
  try
    {
    deformTensor = deformationTransform->TransformDiffusionTensor( testTensor );
    }
  catch( itk::ExceptionObject & e )
    {
    std::cout << "Caught expected exception:" << std::endl << e << std::endl;
