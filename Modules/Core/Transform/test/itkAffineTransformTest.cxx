...
bool testValue( const double v1, const double v2, int maxUlps=1 )
{
  return itk::Math::FloatAlmostEqual( v1, v2, maxUlps );
}

template <typename TMatrix>
bool testMatrix( const TMatrix & m1, const TMatrix & m2, int maxUlps=1 )
{
  bool pass = true;
...
bool testVector( const TVector & v1, const TVector & v2, int maxUlps=1 )
{
  bool pass = true;
...
template <typename TVector>
bool testVariableVector( const TVector & v1, const TVector & v2, int maxUlps=1 )
{
  bool               pass = true;
...
int itkAffineTransformTest(int, char *[])
{
  ...
  if( !testVariableVector( m4, m4T, 4000000 ) )
    {
