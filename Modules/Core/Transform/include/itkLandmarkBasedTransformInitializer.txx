...
::InternalInitializeTransform(AffineTransformType *)
{
  ...
  // q
  // dim=4 * NumberOfLandMarks matrix
  ...
  vnl_matrix<double> inverseAffineRotation =
    vnl_matrix_inverse<double>(Affine.get_n_columns(0,ImageDimension));
  ...
  itk::Matrix<double,ImageDimension> mA =
    itk::Matrix<double,ImageDimension>(inverseAffineRotation);
