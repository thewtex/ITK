...
//  // Set the direction parameters
  ...
  this->m_CoefficientImages[0]->AllocateWithDefaultPixelInitializer(); // initializes buffer to zero
  ...
  for( unsigned int i = 1; i < SpaceDimension; i++ )
    ...
    this->m_CoefficientImages[i]->AllocateWithDefaultPixelInitializer(); // initialize buffer to zero
    }
}
