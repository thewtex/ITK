 ...
 *
 *=========================================================================*/
#ifndef __itkHD5TransformIO_h
#define __itkHD5TransformIO_h
 ...
 *  any sort of data.
 */
class HD5TransformIO:public TransformIOBase
{
public:
  typedef HD5TransformIO                Self;
  ...
  itkTypeMacro(HD5TransformIO, TransformIOBase);
  itkNewMacro(Self);
...
protected:
  HD5TransformIO();
  virtual ~HD5TransformIO();
private:
  /** Read a parameter array from the file location name */
  ParametersType ReadParameters(H5::H5File &f,const std::string &DataSetName);
