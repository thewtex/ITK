...
template<
  ...
  >
class ImageFunction:
    public FunctionBase< Point< typename TInputImage::SpacePrecisionType, TInputImage::ImageDimension >, TOutput >
{
public:
  ...
  typedef FunctionBase<
    Point< typename TInputImage::SpacePrecisionType,
  ...
  typedef ContinuousIndex< typename InputImageType::SpacePrecisionType,
