...
LabelImageGaussianInterpolateImageFunction<TInputImage, TCoordRep>
::LabelImageGaussianInterpolateImageFunction()
{
}

template<class TInputImage, class TCoordRep>
typename LabelImageGaussianInterpolateImageFunction<TInputImage, TCoordRep>
::OutputType
LabelImageGaussianInterpolateImageFunction<TInputImage, TCoordRep>
::EvaluateAtContinuousIndex( const ContinuousIndexType & cindex, OutputType * itkNotUsed( grad )  ) const
{
  ...
  typedef typename NumericTraits<PixelType>::RealType InputImageRealType;

  typedef std::map<OutputType, RealType, std::less<InputImageRealType> > WeightMapType;
  typedef typename WeightMapType::iterator WeightMapIteratorType;
