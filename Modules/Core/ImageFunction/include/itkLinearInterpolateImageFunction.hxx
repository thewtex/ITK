 ...
 */
// If variable length vector
template<typename TInputImage, typename RealTypeScalarRealType>
void
MakeZeroInitizer(const TInputImage * const inputImagePtr,
  typename itk::VariableLengthVector<RealTypeScalarRealType> & tempZeros)
{
...
template<typename TInputImage, typename RealTypeScalarRealType>
void
MakeZeroInitizer(const TInputImage * const itkNotUsed( inputImagePtr ),
  RealTypeScalarRealType & tempZeros)
{
...
::EvaluateUnoptimized(const ContinuousIndexType & index) const
{
  ...
  RealType value;
  MakeZeroInitizer<TInputImage>( inputImagePtr, value);
