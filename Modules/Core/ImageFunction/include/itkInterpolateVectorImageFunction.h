 ...
 *
 *=========================================================================*/
#ifndef __itkInterpolateVectorImageFunction_h
#define __itkInterpolateVectorImageFunction_h
 ...
 *
 * InterpolateVectorImageFunction is the base for all ImageFunctions that
 * interpolates image with vector pixel types. This function outputs
 * a return value of type VariableLengthVector<double,Dimension>.
 *
...
class ITK_EXPORT InterpolateVectorImageFunction:
...
public:
  ...
  typedef InterpolateVectorImageFunction Self;
  ...
  itkTypeMacro(InterpolateVectorImageFunction, ImageFunction);
...
private:
  InterpolateVectorImageFunction(const Self &); //purposely not implemented
