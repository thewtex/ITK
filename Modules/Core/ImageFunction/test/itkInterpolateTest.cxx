...
int itkInterpolateTest(int, char *[] )
{
  ...
  SpacePrecisionType darray1[3] = { 10, 20, 40};
  ...
  SpacePrecisionType darray2[3] = {0, 20, 40};
  ...
  SpacePrecisionType epsilon = 1.0e-10;
  SpacePrecisionType darray3[3] = {19 - epsilon, 20, 40};
  ...
  SpacePrecisionType darray4[3] = {20, 20, 40};
  ...
  SpacePrecisionType darray5[3] = {5.25, 12.4, 42.0};
  ...
  SpacePrecisionType darray6[3] = {5.25, 12.6, 42.0};
  ...
  SpacePrecisionType darray7[3] = {5.25, 12.5, 42.0};
  ...
  SpacePrecisionType darray8[3] = {5.25, 11.5, 42.0};
