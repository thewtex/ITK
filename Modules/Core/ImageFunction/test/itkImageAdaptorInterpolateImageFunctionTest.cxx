...
int itkImageAdaptorInterpolateImageFunctionTest(int, char* [] )
{
  ...
  {
  ImageAdaptorInterpolate::SpacePrecisionType darray[3] = {10, 20, 40};
  double temp = 70.0;
  ...
  {
  ImageAdaptorInterpolate::SpacePrecisionType darray[3] = {0, 20, 40};
  double temp = 60.0;
  output = OutputType( temp );
  cindex = ContinuousIndexType(darray);
  passed = ImageAdaptorInterpolate::TestContinuousIndex( interp, cindex, true, output );
  ...
  {
  ImageAdaptorInterpolate::SpacePrecisionType epsilon = 1.0e-10;
  ImageAdaptorInterpolate::SpacePrecisionType darray[3] = {19 - epsilon, 20, 40};
  double temp = 79.0;
  output = OutputType( temp );
  cindex = ContinuousIndexType(darray);
  passed = ImageAdaptorInterpolate::TestContinuousIndex( interp, cindex, true, output );
  ...
  {
  ImageAdaptorInterpolate::SpacePrecisionType darray[3] = {20, 20, 40};
  double temp = 1.0;
  output = OutputType( temp );
  cindex = ContinuousIndexType(darray);
  ...
  {
  ImageAdaptorInterpolate::SpacePrecisionType darray[3] = {5.25, 12.5, 42.0};
  double temp = 59.75;
  output = OutputType( temp );
  cindex = ContinuousIndexType(darray);
  passed = ImageAdaptorInterpolate::TestContinuousIndex( interp, cindex, true, output );
