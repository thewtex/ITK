...
itkLabelImageGaussianInterpolateImageFunctionTest( int , char*[] )
{
  ...
  typedef unsigned short int PixelType;                 //Label images should be
                                                        // integer value types
 ...
 At: [5, 4] computed value =  17 known_value = 17
    ...
    PixelType valarray[large_xSize][large_ySize] = {
            ...
            {255,255,171,  7,  7},
                      {  7,  7,  7,  7,  7},
                      {  7,  7,  7,  7,  7},
                 { default_background_value,default_background_value,default_background_value,default_background_value,
    ...
    for (itk::IndexValueType y = 0; y < large_ySize; y++)
      ...
      for (itk::IndexValueType x = 0; x < large_xSize; x++)
        ...
        std::cout << "At: " << index << " computed value =  " << large_image->GetPixel(index) << " known_value = " <<
