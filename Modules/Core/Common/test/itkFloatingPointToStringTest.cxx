...
{
  itk::FloatingPointToString<T> convert;
  std::cout << t << "(min): " << convert(itk::NumericTraits<T>::min()) << std::endl;
  std::cout << t << "(NonpositiveMin): " << convert(itk::NumericTraits<T>::NonpositiveMin()) << std::endl;
  std::cout << t << "(max): " << convert(itk::NumericTraits<T>::max()) << std::endl;
  std::cout << t << "(round_error): " << convert(itk::NumericTraits<T>::round_error()) << std::endl;
  std::cout << t << "(denorm_min): " << convert(itk::NumericTraits<T>::denorm_min()) << std::endl;
}
int itkFloatingPointToStringTest(int, char* [] )
{
