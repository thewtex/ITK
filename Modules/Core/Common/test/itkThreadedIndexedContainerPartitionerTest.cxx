...
public:
  ...
  private:
    ...
    virtual void ThreadedExecution( const DomainType& subdomain,
      ...
      if( threadId == 0 )
        {
        std::cout << "This is the : " << this->m_EnclosingClass->m_ClassDescriptor << std::endl;
        }
  ...
  const DomainThreaderEnclosingClass::TestDomainThreader::DomainType & fullRange )
{
  ...
  DomainThreaderEnclosingClass::TestDomainThreader::Pointer domainThreader = enclosingClass.GetDomainThreader();
