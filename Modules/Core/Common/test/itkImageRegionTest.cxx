...
int itkImageRegionTest(int, char* [] )
{
  ...
  if( shrinkRegion != padAndShrinkRegion )
    {
    passed = false;
    std::cerr << "Pad and shrink my an OffSetValueType radius failed." << std::endl;
    }
  ...
  if( shrinkRegion != padAndShrinkRegion )
    {
    passed = false;
    std::cerr << "Pad and shrink my an SizeType radius failed." << std::endl;
    }
  ...
  if( shrinkRegion != padAndShrinkRegion )
    {
    passed = false;
    std::cerr << "Pad and shrink my an IndexValueArrayType radius failed." << std::endl;
    }
