...
int main( int, char *[] )
{
  ...
  std::cout << "Distance: " << itk::Math::FloatDistance( floatRepresentationfx1.asFloat, floatRepresentationfx2.asFloat ) << std::endl;

  if( itk::Math::FloatDistance( floatRepresentationfx1.asFloat, floatRepresentationfx2.asFloat ) != -1 )
    {
    std::cerr << "Unexpected float distance." << std::endl;
    return EXIT_FAILURE;
    }
  ...
  if( itk::Math::FloatDistance( floatRepresentationfx1.asFloat, floatRepresentationfx2.asFloat ) != -1 )
    {
    std::cerr << " result is: " << itk::Math::FloatDistance( floatRepresentationfx1.asFloat, floatRepresentationfx2.asFloat ) << std::endl;
    std::cerr << "Unexpected float distance." << std::endl;
    return EXIT_FAILURE;
    }
  if( itk::Math::FloatAlmostEqual( floatRepresentationfx1.asFloat, floatRepresentationfx2.asFloat ) )
  ...
  if( itk::Math::FloatDistance( floatRepresentationfx1.asFloat, floatRepresentationfx2.asFloat ) != -6 )
    {
    std::cerr << "Unexpected float distance." << std::endl;
    return EXIT_FAILURE;
    }
  ...
  if( itk::Math::FloatDistance( floatRepresentationfx1.asFloat, floatRepresentationfx2.asFloat ) != 0 )
    {
    std::cerr << "Unexpected float distance." << std::endl;
    return EXIT_FAILURE;
    }
  ...
  if( ! itk::Math::FloatDistance( floatRepresentationfx1.asFloat, floatRepresentationfx2.asFloat ) > 0 )
    {
    std::cerr << "Did not get the expected FloatDistance sign." << std::endl;
    return EXIT_FAILURE;
    }
  else
    {
    std::cout << "Got the expected FloatDistance sign.\n" << std::endl;
    }
  ...
  if( itk::Math::FloatDistance( floatRepresentationdx1.asFloat, floatRepresentationdx2.asFloat ) != -1 )
    {
    std::cerr << "Unexpected float distance." << std::endl;
    return EXIT_FAILURE;
    }
  ...
  if( itk::Math::FloatDistance( floatRepresentationdx1.asFloat, floatRepresentationdx2.asFloat ) != -6 )
    {
    std::cerr << "Unexpected float distance." << std::endl;
    return EXIT_FAILURE;
    }
  ...
  if( itk::Math::FloatDistance( floatRepresentationdx1.asFloat, floatRepresentationdx2.asFloat ) != 0 )
    {
    std::cerr << "Unexpected float distance." << std::endl;
    return EXIT_FAILURE;
    }
  ...
  std::cout << "floatRepresentationdx2.asFloat: " << floatRepresentationdx2.asFloat << std::endl;
  std::cout << "floatRepresentationdx2.asInt:   " << floatRepresentationdx2.asInt << std::endl;
  std::cout << "Distance: " << itk::Math::FloatDistance( floatRepresentationdx1.asFloat, floatRepresentationdx2.asFloat ) << std::endl;
