...
void ImageRegionSplitterDirection::PrintSelf(std::ostream & os, Indent indent) const
{
...
unsigned int ImageRegionSplitterDirection::GetNumberOfSplits(unsigned int dim,
...
unsigned int ImageRegionSplitterDirection::GetSplit(unsigned int dim,
                                               unsigned int i,
