...
unsigned int MultiThreader:: m_GlobalMaximumNumberOfThreads = ITK_MAX_THREADS;

// Initialize static member that controls global default number of threads : 0
// => Not initialized.
unsigned int MultiThreader:: m_GlobalDefaultNumberOfThreads = 0;

void MultiThreader::SetGlobalMaximumNumberOfThreads(unsigned int val)
{
...
unsigned int MultiThreader::GetGlobalMaximumNumberOfThreads()
{
  return m_GlobalMaximumNumberOfThreads;
}

void MultiThreader::SetGlobalDefaultNumberOfThreads(unsigned int val)
{
...
void MultiThreader::SetNumberOfThreads(unsigned int numberOfThreads)
{
...
unsigned int MultiThreader::GetGlobalDefaultNumberOfThreads()
{
...
{
  for ( unsigned int i = 0; i < ITK_MAX_THREADS; i++ )
    {
...
void MultiThreader::SetMultipleMethod(unsigned int index, ThreadFunctionType f, void *data)
{
