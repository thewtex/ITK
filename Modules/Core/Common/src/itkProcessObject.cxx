...
{
  std::cout << "setting number of indexed outputs to " << num << " from " << this->GetNumberOfIndexedOutputs() << std::endl;
  if( this->GetNumberOfIndexedOutputs() != num )
    ...
    if ( num < this->GetNumberOfIndexedOutputs() )
      ...
      {
      std::cout << "adding..." << this->GetNumberOfIndexedOutputs() << " " << num << std::endl;
