...
::ThreadPool() :
  ...
  m_IdCounter(1)
{
#if !defined(ITK_HAS_TR1_UNORDERED_MAP) && !defined(ITK_USE_WIN32_THREADS)
  m_WorkerQueue.reserve(1000);
  m_ThreadProcessIdentifiersVector.reserve(1000);
#endif
#if !defined(ITK_HAS_TR1_UNORDERED_SET) && !defined(ITK_USE_WIN32_THREADS)
