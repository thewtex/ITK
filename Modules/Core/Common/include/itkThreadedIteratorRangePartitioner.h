...
struct ThreadedIteratorRangePartitionerDomain
{
 ...
 * the first iterator, \c m_Begin, defines the start of the domain, and the second iterator,
 * \c m_End, defines one element past the end of the domain.
 *
