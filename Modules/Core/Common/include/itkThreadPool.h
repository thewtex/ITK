...
private:
  ...
  // KW TODO -- replace with std::unordered_sets
  typedef std::unordered_map<ThreadJobIdType,ThreadJob> ThreadJobContainerType;
  typedef std::pair<ThreadJobIdType,ThreadJob>          ThreadJobContainerPairType;

  typedef std::unordered_set<ThreadJobIdType>      ThreadJobIdsContainerType;

  typedef std::unordered_set<ThreadProcessIdType>  ThreadProcessIdContainerType;
...
private:
  ...
  typedef std::unordered_map<ThreadProcessIdType,ThreadSemaphorePair *> ThreadSemHandlePairingQueueType;
  typedef std::pair<ThreadProcessIdType,ThreadSemaphorePair *>          ThreadSemHandlePairingQueuePairType;
