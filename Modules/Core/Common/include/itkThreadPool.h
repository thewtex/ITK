...
private:
  ...
  typedef ThreadPoolMapType<ThreadProcessIdType,ThreadProcessStatusPair> ThreadIdHandlePairingContainerType;
  typedef std::pair<ThreadProcessIdType,ThreadProcessStatusPair>         ThreadIdHandlePairingContainerPairType;

  ThreadIdHandlePairingContainerType m_ThreadIdHandlePairingQueue;

  //ThreadSemaphorePair *m_ThreadSemHandlePairingQueue;
  typedef ThreadPoolMapType<ThreadProcessIdType,ThreadSemaphorePair *> ThreadSemHandlePairingQueueType;
