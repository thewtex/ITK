...
public:
  ...
  /** Get a singleton */
  static ThreadPool * GetThreadPool(); //TODO: This should return a const pointer.  Only 1 thread pool can exist from the singleton.
  ...
  ThreadProcessIDType AssignWork(ThreadJob worker); //TODO:  Do you want to pass a copy of the job, or a reference to the job?
