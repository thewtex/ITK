...
protected:
   ...
   * correctly, that all required inputs are set and need parameters
   * are set. If not valid an exceptions will be thrown.
   *
   ...
   * not valid.
   *
   * This method is called imediately before
   * GenerateOutputInformation().
   *
   * The ProcessObject implementation does nothing.
   *
   */
