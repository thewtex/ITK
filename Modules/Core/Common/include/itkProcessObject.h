 ...
 * inputs named inputs are preferred. However, indexed inputs provide
 * constant time access to input and output DataObjects, and more
 * efficient. Neither type of input or output should be accessed in a
 * tight loop.
 *
...
protected:
   ...
   * added with AddRequiredInputName it should not be considered in
   * this count. In this class' VerifiyPrecoditions(), the is check that
   * GetNumberOfValidRequiredInputs() is at least this value.
   */
