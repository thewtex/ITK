...
public:
    explicit
    ReverseIterator(Iterator i) : m_Iterator(i) {
    }
...
public:
    explicit
    ConstReverseIterator(ConstIterator i) : m_Iterator(i) {
    }
...
public:
   ...
   * Visual C++. */
  reference
  operator[](short index)                {
    return m_InternalArray[index];
  }

  const_reference
  operator[](short index) const {
    return m_InternalArray[index];
  }
  ...
  const_reference
  operator[](unsigned short index) const {
    return m_InternalArray[index];
  }
  ...
  void
  SetElement(unsigned short index, const_reference value)
  {
    m_InternalArray[index] = value;
  }

  const_reference
  GetElement(unsigned short index) const {
    return m_InternalArray[index];
  }
