...
private:
  ...
  mutable DataObjectIdentifierType                  m_SourceOutputName;
   ...
   * object. */
  bool ConnectSource(ProcessObject *s, const DataObjectIdentifierType & name) const;
  ...
  bool DisconnectSource(ProcessObject *s, const DataObjectIdentifierType & name) const;
