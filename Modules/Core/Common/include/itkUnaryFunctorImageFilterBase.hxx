 ...
 *
 *=========================================================================*/
#ifndef __itkUnaryFunctorImageFilterBase_hxx
#define __itkUnaryFunctorImageFilterBase_hxx
...
UnaryFunctorImageFilterBase< TInputImage, TOutputImage, TFunction >
...
/**
 * UnaryFunctorImageFilterBase can produce an image which is a different resolution
 * than its input image.  As such, UnaryFunctorImageFilterBase needs to provide an
...
::GenerateOutputInformation()
{
  ...
  if ( phyData )
    ...
    itkExceptionMacro( << "itk::UnaryFunctorImageFilterBase::GenerateOutputInformation "
                       ...
                       ThreadIdType threadId)
{
  ...
  while ( !inputIt.IsAtEnd() )
    {
    outputIt.Set( this->InvokeFunctor( outputIt.GetIndex(), inputIt.Get() ) );
    ++inputIt;
    ++outputIt;
