...
::GetInput(void) const
{
  return static_cast< const TInputImage * >( this->GetMainInput() );
}
...
::GenerateInputRequestedRegion()
{
  ...
  typename Superclass::DataObjectPointerArray inputs = this->GetInputs();
  for ( typename Superclass::DataObjectPointerArray::iterator it = inputs.begin(); it != inputs.end(); it++ )
    {
