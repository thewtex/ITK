 ...
 *
 * Partitioning will occur within the highest-numbered, non-singleton-length
...
public:
  ...
  typedef typename DomainType::IndexType      DomainIndexType;
  typedef typename DomainType::SizeType       DomainSizeType;
  typedef typename DomainType::SizeValueType  DomainLengthType;
   ...
   * non-overlapping subregions, setting subregion \c i as \c subRegion and
   * returning the total number of subregions actually available.
   *
