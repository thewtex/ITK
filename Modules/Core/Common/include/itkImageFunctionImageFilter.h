 ...
 * \brief Implements pixel-wise generic operations on an image.
 *
...
public:
  ...
  typename FunctionType::Pointer       GetFunction() { return m_Function; }

  /** Set the functoin object. This replaces the current Function pointer
   * with a new Function pointer.*/
  void SetFunction(typename FunctionType::Pointer function)
  {
