...
/* Define macros to export and import template instantiations for each
   library in ITK.  */
#define _ITKCommon(c, x, n) \
 _TEMPLATE(ITKCommon_EXPORT, c, x, n)
...
// Force error if defined, it was meaningless
#define ITK_EXPORT ":error:  ITK_EXPORT should be removed for ITK_FUTURE_LEGACY_REMOVE"
...
// For backwards compatibility define ITK_EXPORT to nothing like before
