...
// Macro which correctly specifies the export/visibility of a
// declaration of an explicitly instantiated template.
//
// Example to be used in the header for a declaration:
//   extern template class ITKTEMPLATE_EXPORT(Common) MetaDataObject< bool >;
// While in source file for a definition:
//   template class MetaDataObject< bool >;
//
#if defined( _WIN32 ) || defined ( WIN32 )
#define ITKTEMPLATE_EXPORT(library)
#else
#define ITKTEMPLATE_EXPORT(library) ITK##library##_EXPORT
#endif
