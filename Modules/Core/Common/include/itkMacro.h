...
/** Set a decorated input. This defines the Set"name"() and a Set"name"Input()
  method */
...
/** Set a decorated input. This defines the Set"name"() and Set"name"Input()
  method */
...
//       the ivar.
//       It is permissable to use both itkGetObjectMacro and
...
// In the future, the itkGetObjectMacro will be deprecated with the
// ITK_LEGACY_REMOVE
...
// to ease the transition from the historical GetObjectMacro to the
