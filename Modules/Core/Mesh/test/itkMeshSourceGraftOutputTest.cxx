...
private:
  MeshSourceGraftOutputFilter(const MeshSourceGraftOutputFilter&); //purposely
                                                                   // not
                                                                   //
                                                                   // implemented
  void operator=(const MeshSourceGraftOutputFilter&);              //purposely
...
itkMeshSourceGraftOutputTest(int, char* [] )
{
  ...
  int n = 1;                                        // let's start with a few of
                                                    // them
