...
// ADD DistanceToCentroidMembershipFunction (with the added SetDistanceMetric()
// method
// ADD EuclideanDistanceMetri
// Create two classes with their respective DistanceToCentroidMembershipFunction
// and two separate centroids
...
itkSampleClassifierFilterTest1( int, char * [] )
{
  ...
  //should be thrown since there will be a mismatch between the number of
  // classes
