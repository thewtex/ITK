...
#ifndef __itkLevelSetContainerSource_h
#define __itkLevelSetContainerSource_h

#include "itkProcessObject.h"

namespace itk
{
/** \class LevelSetContainerSource
 */
template< class TLevelSetContainer >
class ITK_EXPORT LevelSetContainerSource : public ProcessObject
{
public:
  /** Standard class typedefs. */
  typedef LevelSetContainerSource    Self;
  ...
  itkTypeMacro(LevelSetContainerSource, ProcessObject);

  /** Some convenient typedefs. */
  typedef Superclass::DataObjectIdentifierType          DataObjectIdentifierType;
  typedef DataObject::Pointer                           DataObjectPointer;

  typedef TLevelSetContainer                            OutputLevelSetContainerType;
  typedef typename OutputLevelSetContainerType::Pointer OutputLevelSetContainerPointer;

  /** Get the mesh output of this process object.  */
  OutputLevelSetContainerType * GetOutput(void);

  OutputLevelSetContainerType * GetOutput(unsigned int idx);
  ...
  void SetOutput(OutputLevelSetContainerType *output);
   ...
   * SmartPointer to a DataObject. If a subclass of LevelSetContainerSource has
...
protected:
  ...
  virtual ~LevelSetContainerSource() {}
...
private:
  LevelSetContainerSource(const Self &);     //purposely not implemented
  void operator=(const Self &); //purposely not implemented
};
} // end namespace itk

#ifndef ITK_MANUAL_INSTANTIATION
#include "itkLevelSetContainerSource.hxx"
#endif
