...
::FindActiveLayer()
{
  ...
  LevelSetLayerType& layer0 = m_SparseLevelSet->GetLayer( LevelSetType::ZeroLayer() );
...
::FindPlusOneMinusOneLayer()
{
  ...
  const LevelSetLayerType layer0 = m_SparseLevelSet->GetLayer( LevelSetType::ZeroLayer() );
  LevelSetLayerType& layerMinus1 = m_SparseLevelSet->GetLayer( LevelSetType::MinusOneLayer() );
  LevelSetLayerType& layerPlus1 = m_SparseLevelSet->GetLayer( LevelSetType::PlusOneLayer() );
  ...
  while( nodeIt != nodeEnd )
    ...
    m_InternalImage->SetPixel( nodeIt->first, LevelSetType::MinusOneLayer() );
    ++nodeIt;
    }
  ...
  while( nodeIt != nodeEnd )
    ...
    m_InternalImage->SetPixel( nodeIt->first, LevelSetType::PlusOneLayer() );
    ++nodeIt;
    }
