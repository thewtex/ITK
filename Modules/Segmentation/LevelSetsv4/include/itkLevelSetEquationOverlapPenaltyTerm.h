...
public:
  ...
  itkTypeMacro( LevelSetEquationOverlapPenaltyTerm,
  ...
  virtual void ComputeSumTerm( const LevelSetInputIndexType& iP,
...
protected:
  ...
  /** Returns the term contribution for a given location iP */
