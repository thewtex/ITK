...
public:
  ...
  /** Initialize term parameters in the dense case by computing for each pixel
    location */
  ...
  virtual void
  ComputeProductTerm( const LevelSetInputIndexType& ,
...
private:
  LevelSetEquationChanAndVeseInternalTerm( const Self& ); // purposely not
                                                          // implemented
