...
class LevelSetSparseImageBase :
  public LevelSetImageBase< TOutput, VDimension >
  {
public:
  typedef LevelSetSparseImageBase                   Self;
  typedef SmartPointer< Self >                      Pointer;
  typedef SmartPointer< const Self >                ConstPointer;
  typedef LevelSetImageBase< TOutput, VDimension >  Superclass;

  /** Run-time type information */
  itkTypeMacro ( LevelSetSparseImageBase, LevelSetImageBase );
