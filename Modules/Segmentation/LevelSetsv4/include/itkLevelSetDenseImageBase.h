...
class LevelSetDenseImageBase :
  public LevelSetImageBase< typename TImage::PixelType, TImage::ImageDimension >
  {
public:
  ...
  typedef LevelSetImageBase< PixelType, ImageType::ImageDimension > Superclass;

  /** Method for creation through object factory */
  itkNewMacro ( Self );

  /** Run-time type information */
  itkTypeMacro ( LevelSetDenseImageBase, LevelSetImageBase );
