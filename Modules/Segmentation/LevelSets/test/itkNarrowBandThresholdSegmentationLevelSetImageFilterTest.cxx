  ...
  Execute(Object *caller, const EventObject &)
  {
    std::cout <<
      (dynamic_cast<NarrowBandLevelSetImageFilter< ::NBTS::SeedImageType,
                                                   ::NBTS::ImageType> *>(caller) )->GetSegmentationFunction()->
...
itkNarrowBandThresholdSegmentationLevelSetImageFilterTest(int, char * [] )
{
  ...
  filter->ReverseExpansionDirectionOn(); // Change the default behavior of the
                                         // speed
                                         // function so that negative values
                                         // result in
                                         // surface growth.
  ...
  try {
    ...
    //        itk::CastImageFilter<NBTS::SeedImageType,
    // NBTS::ImageType>::Pointer
    //         caster = itk::CastImageFilter<NBTS::SeedImageType,
    // NBTS::ImageType>::New();
