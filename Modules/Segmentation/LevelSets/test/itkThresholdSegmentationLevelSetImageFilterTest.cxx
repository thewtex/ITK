...
itkThresholdSegmentationLevelSetImageFilterTest(int, char * [] )
{
  ...
  filter->SetUseNegativeFeaturesOn(); // Change the default behavior of the
                                      // speed
                                      // function so that negative values result
                                      // in
                                      // surface growth.
  ...
  try {
    ...
    //        itk::CastImageFilter<TSIFTN::SeedImageType,
    // TSIFTN::ImageType>::Pointer
    //         caster = itk::CastImageFilter<TSIFTN::SeedImageType,
    // TSIFTN::ImageType>::New();
