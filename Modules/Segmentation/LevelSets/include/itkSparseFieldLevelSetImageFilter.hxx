...
::Initialize()
{
  typedef typename TInputImage::SpacePrecisionType SpacePrecisionType;
  unsigned int i;
...
::InitializeActiveLayerValues()
{
  ...
  if ( this->GetUseImageSpacing() )
    {
    typename InputImageType::SpacePrecisionType minSpacing = NumericTraits< typename InputImageType::SpacePrecisionType >::max();
