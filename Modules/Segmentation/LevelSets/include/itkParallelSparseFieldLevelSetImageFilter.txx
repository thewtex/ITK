...
void
ParallelSparseFieldLevelSetImageFilter< TInputImage, TOutputImage >
::ThreadedAllocateData(const unsigned int& ThreadId)
{
...
void
ParallelSparseFieldLevelSetImageFilter< TInputImage, TOutputImage >
::ThreadedInitializeData(const unsigned int& ThreadId, const ThreadRegionType & ThreadRegion)
{
...
void
ParallelSparseFieldLevelSetImageFilter< TInputImage, TOutputImage >
::ThreadedInitializeIteration( const unsigned int& itkNotUsed(ThreadId) )
{
...
::IterateThreaderCallback(void *arg)
{
  ...
  if ( !str->Filter->GetState() ) // if it is unitialized
    {
    if ( ThreadId == 0 )
      {
...
ParallelSparseFieldLevelSetImageFilter< TInputImage, TOutputImage >
::ThreadedCalculateChange(const unsigned int& ThreadId)
{
...
void
ParallelSparseFieldLevelSetImageFilter< TInputImage, TOutputImage >
::ThreadedApplyUpdate(const TimeStepType& dt, const unsigned int& ThreadId)
{
...
::ThreadedUpdateActiveLayerValues(const TimeStepType& dt, LayerType *UpList,
                                  LayerType *DownList, const unsigned int& ThreadId)
{
...
void
ParallelSparseFieldLevelSetImageFilter< TInputImage, TOutputImage >
::CopyInsertList(const unsigned int& ThreadId, LayerPointerType FromListPtr,
...
void
ParallelSparseFieldLevelSetImageFilter< TInputImage, TOutputImage >
::ClearList(const unsigned int& ThreadId, LayerPointerType ListPtr)
{
  LayerNodeType *nodePtr;
...
::CopyInsertInterNeighborNodeTransferBufferLayers(
  const unsigned int& ThreadId, LayerPointerType List,
  const unsigned int& InOrOut, const unsigned int& BufferLayerNumber)
{
  if ( ThreadId != 0 )
    {
...
::ThreadedProcessFirstLayerStatusLists(
  const unsigned int& InputLayerNumber, const unsigned int& OutputLayerNumber,
  const StatusType& SearchForStatus, const unsigned int& InOrOut,
  const unsigned int& BufferLayerNumber, const unsigned int& ThreadId)
{
  LayerNodeType *nodePtr;
...
::ThreadedProcessOutsideList(
  const unsigned int& InputLayerNumber, const StatusType& ChangeToStatus,
  const unsigned int& InOrOut, const unsigned int& BufferLayerNumber,
  const unsigned int& ThreadId)
{
...
void
ParallelSparseFieldLevelSetImageFilter< TInputImage, TOutputImage >
::ThreadedLoadBalance(const unsigned int& ThreadId)
{
...
void
ParallelSparseFieldLevelSetImageFilter< TInputImage, TOutputImage >
::GetThreadRegionSplitByBoundary(const unsigned int& ThreadId, ThreadRegionType & ThreadRegion)
{
...
unsigned int
ParallelSparseFieldLevelSetImageFilter< TInputImage, TOutputImage >
::GetThreadNumber(const unsigned int& splitAxisValue)
{
...
void
ParallelSparseFieldLevelSetImageFilter< TInputImage, TOutputImage >
::SignalNeighborsAndWait(const unsigned int& ThreadId)
{
...
ParallelSparseFieldLevelSetImageFilter< TInputImage, TOutputImage >
::SignalNeighbor(
  const unsigned int& SemaphoreArrayNumber,
  const unsigned int& ThreadId)
{
...
void
ParallelSparseFieldLevelSetImageFilter< TInputImage, TOutputImage >
::WaitForNeighbor(const unsigned int& SemaphoreArrayNumber, const unsigned int& ThreadId)
{
  ThreadData &td = m_Data[ThreadId];
  td.m_Lock[SemaphoreArrayNumber].Lock();
