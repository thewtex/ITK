...
visualizeLevelSet( TInputImage * inputImage, const int numberOfIterations, const char * )
{
  ...
  // set evolution.
  typedef itk::Image< LevelSetOutputRealType, InputImageType::ImageDimension > BinaryImageType;
  ...
  // Create level set
  typename LevelSetType::Pointer levelSet = LevelSetType::New();
  levelSet->SetImage( inputImage );

  // Create the level set container
  typedef typename itk::LevelSetContainerBase< itk::IdentifierType, LevelSetType > LevelSetContainerType;
  ...
  typedef vtkVisualize2DLevelSetImageBase< InputImageType, LevelSetImageType > VisualizationType;
