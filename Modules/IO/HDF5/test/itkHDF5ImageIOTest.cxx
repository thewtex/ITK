...
int RWTest(const char *fileName)
{
  ...
  // char metaDataString[] = "Test NonConst String";
  // itk::EncapsulateMetaData<char *>(metaDict,"TestNonConstString",metaDataString);

  // const char *metaDataConstString = "Test Const String";
  // itk::EncapsulateMetaData<const char *>(metaDict,"NonConstString",metaDataConstString);
