...
class ITK_EXPORT HDF5ImageIO:public ImageIOBase
{
public:
...
private:
  ...
  void WriteString(H5::H5File *h5file,
                   const std::string &path,
                   const std::string &value);
  void WriteString(H5::H5File *h5file,
                   const std::string &path,
                   const char *s);
  std::string ReadString(H5::H5File *h5file,
                         const std::string &path);
  template <typename TScalar>
  void WriteVector(H5::H5File *h5file,
                   const std::string &path,
                   const std::vector<TScalar> &vec);
  template <typename TScalar>
  std::vector<TScalar> ReadVector(H5::H5File *h5file,
                                  const std::string &DataSetName);
  void WriteDirections(H5::H5File *h5file,
                       const std::string &path,
                       const std::vector<std::vector<double> > &dir);
  std::vector<std::vector<double> > ReadDirections(H5::H5File *h5file,
                                                   const std::string &path);
