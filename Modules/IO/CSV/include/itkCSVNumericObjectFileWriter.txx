 ...
 *
 *=========================================================================*/
#ifndef __itkCSVNumericObjectFileWriter_txx
#define __itkCSVNumericObjectFileWriter_txx
...
::Write()
{
  ...
  if ( success )
    {
    std::cout << "The file " << this->m_FileName
              << " was written successfully!" << std::endl;
    }
