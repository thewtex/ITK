...
inline const std::string GetTypeNameAsString()
{
  itkGenericExceptionMacro(<< "Unknown ScalarType" << typeid(TType).name());
}
template <>
inline const std::string GetTypeNameAsString<double>()
{
  return std::string("double");
}

template <>
inline const std::string GetTypeNameAsString<float>()
{
