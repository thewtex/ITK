 ...
 *
 *=========================================================================*/
#ifndef __itkTransformIOBaseTemplate_h
#define __itkTransformIOBaseTemplate_h
...
namespace itk
{
   ...
   * This class also is used by the TransformFileReaderTemplate and TransformFileWriterTemplate
   * classes. End users don't directly manipulate classes derived from TransformIOBaseTemplate;
   * the TransformIOFactoryTemplate is used by the Reader/Writer to pick a concrete derived class to do
...
#include "itkTransformIOBaseTemplate.hxx"
#endif

#endif // __itkTransformIOBaseTemplate_h
