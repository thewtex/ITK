...
{
  typedef TransformBaseTemplate<TInputScalarType>     InputTransformType;
  typedef TransformBaseTemplate<TOutputScalarType>    OutputTransformType;
  ...
  OptimizerParameters< TOutputScalarType >
  ConvertParametersType(const OptimizerParameters< TInputScalarType >  &sourceParams)
  {
  ...
  void SetAllParameters(const InputTransformType *transform, OutputTransformPointer& convertedTransform)
  {
    // The precision type of the input transform parameters should be converted to the requested output precision
    convertedTransform->SetFixedParameters( TransformIOHelper<TOutputScalarType, TInputScalarType>
                                           ::ConvertParametersType( transform->GetFixedParameters() ) );
    convertedTransform->SetParameters( TransformIOHelper<TOutputScalarType, TInputScalarType>
                                      ::ConvertParametersType( transform->GetParameters() ) );
  }
};
...
struct SetInputTransformWithOutputPrecisionType
{
  ...
  if( transformName.find("CompositeTransform") == std::string::npos )
    {
    TransformIOHelper<TOutputScalarType, TInputScalarType> IOhelper;
    ...
    */
    itk::CompositeTransformIOHelperTemplate<TInputScalarType> inputHelper;
    ...
    */
    ...
    itk::CompositeTransformIOHelperTemplate<TOutputScalarType> outputHelper;
