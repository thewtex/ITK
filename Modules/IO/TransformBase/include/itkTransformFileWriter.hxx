...
struct TransformIOHelper
{
  ...
  static void SetAllParameters(const InputTransformType *transform, OutputTransformPointer& convertedTransform)
  {
    ...
    convertedTransform->SetFixedParameters( TransformIOHelper<TOutputScalar, TInputScalar>
                                           ::ConvertParametersType( transform->GetFixedParameters() ) );
    convertedTransform->SetParameters( TransformIOHelper<TOutputScalar, TInputScalar>
...
struct SetInputTransformWithOutputPrecisionType
{
  ...
  if( transformName.find("CompositeTransform") == std::string::npos )
    {
    TransformIOHelper<TOutputScalar, TInputScalar> IOhelper;
