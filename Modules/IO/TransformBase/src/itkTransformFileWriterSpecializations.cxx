...
namespace TransformFileWriterHelper
{
template<>
...
::PushBackTransformList(const Object *transObj)
{
  ...
  if( dblptr.IsNotNull() )
    {
    TransformFileWriterHelper::AddToTransformList<double, double>( dblptr, m_TransformList );
    }
  else
    {
    ...
    if( fltptr.IsNotNull() )
      {
      TransformFileWriterHelper::AddToTransformList<double, float>( fltptr, m_TransformList );
      }
    else
      {
...
::PushBackTransformList(const Object *transObj)
{
  ...
  if( dblptr.IsNotNull() )
    {
    TransformFileWriterHelper::AddToTransformList<float, double>( dblptr, m_TransformList );
    }
  else
    {
    TransformBaseTemplate<float>::ConstPointer fltptr = dynamic_cast<const TransformBaseTemplate<float> *>( transObj );
    if( fltptr.IsNotNull() )
      {
      TransformFileWriterHelper::AddToTransformList<float, float>( fltptr, m_TransformList );
      }
    else
      {
      itkExceptionMacro("The input of writer should be whether a double precision"
