...
//The WriteNiftiTestFiles function writes binary data to disk to ensure that
// both big and little endian files are available.
//This allows all the data necessary to create the images to be stored in source
// files rather than have separate reference images.
int
