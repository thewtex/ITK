...
int
itkLargeTIFFImageWriteReadTest(int ac, char* argv[])
{

  if (ac < 3)
    {
    std::cout <<
    "usage: itkIOTests itkLargeTIFFImageWriteReadTest outputFileName numberOfPixelsInOneDimension [numberOfZslices]" <<
    std::endl;
    return EXIT_FAILURE;
    }
