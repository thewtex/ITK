 ...
 *
 *=========================================================================*/
#ifndef __itkHDF5TransformIOTemplate_h
#define __itkHDF5TransformIOTemplate_h
...
class HDF5TransformIOTemplate:public TransformIOBaseTemplate< InternalComputationType >
{
public:
  typedef HDF5TransformIOTemplate                               Self;
  typedef TransformIOBaseTemplate< InternalComputationType >    Superclass;
  ...
  typedef typename TransformIOBaseTemplate
                      <InternalComputationType>::ConstTransformListType
...
#include "itkHDF5TransformIOTemplate.hxx"
#endif

#endif // __itkHDF5TransformIOTemplate_h
