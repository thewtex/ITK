 ...
 *
 *=========================================================================*/
#ifndef __itkHDF5TransformIOTemplate_hxx
#define __itkHDF5TransformIOTemplate_hxx
...
struct TypeName
{
  ...
  {
  return typeid(InternalComputationType).name();
  }
};
...
template< class InternalComputationType >
HDF5TransformIOTemplate< InternalComputationType >
                  ...
                  const ParametersType &parameters)
{
  ...
  const char* nameOfComputationType = TypeName<InternalComputationType>::Get();
  InternalComputationType *buf = new InternalComputationType[dim];
...
template< class InternalComputationType >
typename HDF5TransformIOTemplate< InternalComputationType >::ParametersType
HDF5TransformIOTemplate< InternalComputationType >
...
::Write()
{
  ...
  try
    ...
    typedef typename TransformIOBaseTemplate<InternalComputationType>::ConstTransformListType ConstTransformListType;
    ...
    CompositeTransformIOHelperTemplate<InternalComputationType> helper;
    //
