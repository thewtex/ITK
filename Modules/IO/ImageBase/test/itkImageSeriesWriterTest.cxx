...
itkImageSeriesWriterTest(int ac, char* av[])
{
  ...
  rescaler->UpdateLargestPossibleRegion();
    ...
    { // This API is being deprecated. Please use NumericSeriesFileNames in the
      // future
      // for generating the list of filenames.  This API will be removed after
      // ITK 1.8
    ...
    // Verify that attempting to use a MetaDataDictionary without setting the
    // ImageIO
    ...
    { // This is the new API, using the NumericSeriesFileNames (or any other
      // filename generator).
