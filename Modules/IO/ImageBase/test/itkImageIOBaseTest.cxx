...
#include "itkImageIOFactory.h" // required to instantiate an instance of
                               // ImageIOBase
...
itkImageIOBaseTest( int , char * [] )
{
  ...
  // Test the non-static version of the string <-> type conversions
    {
    // Create an instance of ImageIOBase. It does not matter that 'test' is not
    // a valid image to read,
