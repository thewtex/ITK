                  ...
                  vnl_vector<double> &dir3)
{
  ...
  else if(this->GetElementDS(0x0020,0x0037,6,dircos,false) != EXIT_SUCCESS)
    {
    return EXIT_FAILURE;
    }
...
::GetSpacing(double *spacing)
{
  ...
  if(this->GetElementDS<double>(0x0028,0x0030,2,_spacing,false) != EXIT_SUCCESS ||
    ...
    if((this->GetElementSQ(0x5200,0x9229,spacingSequence,false) == EXIT_SUCCESS ||
        this->GetElementSQ(0X5200,0X9239,spacingSequence,false) == EXIT_SUCCESS) &&
      ...
      if(subsubSequence.GetElementDS<double>(0x0018,0x0050,1,&_spacing[2],true) != EXIT_SUCCESS)
        {
        // Slice Thickness
        _spacing[2] = 1.0;
        }
