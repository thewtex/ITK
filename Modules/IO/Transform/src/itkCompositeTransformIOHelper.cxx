...
::GetTransformList(const TransformType *transform)
{
  ...
  if(this->BuildTransformList<double,2>(transform) == 0 &&
     this->BuildTransformList<double,3>(transform) == 0 &&
...
{
  if(this->InternalSetTransformList<double,2>(transform,transformList) == 0 &&
     this->InternalSetTransformList<double,3>(transform,transformList) == 0 &&
