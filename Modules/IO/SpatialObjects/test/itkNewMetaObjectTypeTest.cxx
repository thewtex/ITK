...
int itkNewMetaObjectTypeTest(int ac, char* av[])
{
  ...
  group->GetProperty()->SetName("Group");
  group->SetId(0);
  ...
  group->AddSpatialObject(dummy);

  DummyConverterType::Pointer dummyConverter(DummyConverterType::New());
  WriterType::Pointer         writer(WriterType::New());

  writer->RegisterMetaConverter("Dummy","DummySpatialObject",dummyConverter);
  ...
  reader->RegisterMetaConverter("Dummy","DummySpatialObject",dummyConverter);
