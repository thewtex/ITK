...
static void RandomPix(vnl_random &randgen, int &pix,int _max=itk::NumericTraits<int>::max() )
{
  pix = randgen.lrand32();
}

static void RandomPix(vnl_random &randgen, unsigned int &pix,unsigned int _max=itk::NumericTraits<unsigned int>::max() )
{
  pix = randgen.lrand32();
}
...
template <typename TPixel,int VDimension> int MINCReadWriteTest(const char *fileName,mitype_t minc_storage_type,
...
int itkMINCImageIOTest(int ac, char * av [] )
{
  ...
  result += MINCReadWriteTest<char,3>("3DCharImage.mnc",MI_TYPE_BYTE);
  result += MINCReadWriteTest<unsigned short,3>("3DUShortImage.mnc",MI_TYPE_SHORT);
  result += MINCReadWriteTest<short,3>("3DShortImage.mnc",MI_TYPE_USHORT);
  result += MINCReadWriteTest<unsigned int,3>("3DUIntImage.mnc",MI_TYPE_INT);
  result += MINCReadWriteTest<int,3>("3DIntImage.mnc",MI_TYPE_UINT);
  ...
  result += MINCReadWriteTest<itk::RGBPixel<char>,3 >("3DRGBImage2.mnc",MI_TYPE_BYTE);
  result += MINCReadWriteTest<itk::Vector<float,3>,3 >("3DVectorImage_float.mnc",MI_TYPE_FLOAT);
  result += MINCReadWriteTest<itk::Vector<double,3>,3 >("3DVectorImage_double.mnc",MI_TYPE_DOUBLE);

  result += MINCReadWriteTest<itk::Vector<short,3>,3 >("3DVectorImage_short.mnc",MI_TYPE_SHORT);
  result += MINCReadWriteTest<itk::Vector<unsigned short,3>,3 >("3DVectorImage_ushort.mnc",MI_TYPE_USHORT);

  result += MINCReadWriteTest<itk::Vector<int,3>,3 >("3DVectorImage_int.mnc",MI_TYPE_INT);
  result += MINCReadWriteTest<itk::Vector<unsigned int,3>,3 >("3DVectorImage_uint.mnc",MI_TYPE_UINT);
  ...
  result += MINCReadWriteTest<double,3>("3DDoubleImage_double_byte.mnc",MI_TYPE_BYTE,0.2);
  result += MINCReadWriteTest<double,3>("3DDoubleImage_double_short.mnc",MI_TYPE_SHORT,0.01);

  result += MINCReadWriteTest<itk::Vector<float,3>,3 >("3DVectorImage_float_byte.mnc",MI_TYPE_BYTE,0.5);
  result += MINCReadWriteTest<itk::Vector<float,3>,3 >("3DVectorImage_float_short.mnc",MI_TYPE_SHORT,0.05);
...
//   result += MINCReadWriteTest<unsigned char,4>("4DUCharImage.mnc",MI_TYPE_BYTE,0.5);
//   result += MINCReadWriteTest<float,4>("4DFloatImage.mnc",MI_TYPE_FLOAT,0.0001);
//
//   result += MINCReadWriteTest<itk::RGBPixel<unsigned char>,4 >("4DRGBImage.mnc",MI_TYPE_BYTE,0.5);
//   result += MINCReadWriteTest<itk::Vector<float,3>,3 >("4DVectorImage.mnc",MI_TYPE_FLOAT,0.0001);
