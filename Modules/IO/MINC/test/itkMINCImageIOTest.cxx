...
int itkMINCImageIOTest(int ac, char * av [] )
{
  ...
  result += MINCReadWriteTest<itk::Vector<float,3>,3 >("3DVectorImage_float_byte.mnc",typeid(unsigned char).name(),0.5*sqrt(3));
  result += MINCReadWriteTest<itk::Vector<float,3>,3 >("3DVectorImage_float_short.mnc",typeid(short).name(),0.05*sqrt(3));
