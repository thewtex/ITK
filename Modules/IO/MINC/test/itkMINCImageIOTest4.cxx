...
test_image_moments(const char *input_image,const char *output_image,double total, double mx,double my,double mz,
                   double epsilon)
{
  ...
  if(total>0.0) //assume that if no total was provided this test should not be
                // performed
    {
