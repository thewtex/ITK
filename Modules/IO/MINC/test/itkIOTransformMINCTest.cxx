...
static int oneTest(const char *goodname,const char *gridname)
{
  ...
  DisplacementFieldType::Pointer field2=disp2->GetModifiableDisplacementField();
#else //defined ( ITK_FUTURE_LEGACY_REMOVE )
  DisplacementFieldType::Pointer field2=disp2->GetDisplacementField();
#endif //defined ( ITK_FUTURE_LEGACY_REMOVE )

  itk::ImageRegionIterator<DisplacementFieldType> it2(field2,field2->GetLargestPossibleRegion() );
  if(tolerance == 0.0)
    {
