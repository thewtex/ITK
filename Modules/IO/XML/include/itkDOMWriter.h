 ...
 *
 *     itk::MyObjectType::Pointer input_object = ... <br>
 *     const char* output_xml_file_name = ... <br>
 *     itk::MyObjectDOMWriter::Pointer writer = itk::MyObjectDOMWriter::New(); <br>
 *     writer->SetInput( input_object ); <br>
 *     writer->SetFileName( output_xml_file_name ); <br>
 *     writer->Update();
 *
 * \sa XMLWriterBase
 * \sa DOMNodeXMLWriter
