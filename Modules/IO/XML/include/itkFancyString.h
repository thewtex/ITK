 ...
 */
template < class T >
inline FancyString& operator>>( FancyString& s, std::vector<T>& data )
{
 ...
 */
template < class T >
inline FancyString& operator<<( FancyString& s, const std::vector<T>& data )
{
 ...
 */
template < class T >
inline FancyString& operator>>( FancyString& s, Array<T>& data )
{
  return s.ToData( data, 0 );
}
 ...
 */
template < class T >
inline FancyString& operator<<( FancyString& s, const Array<T>& data )
{
  return s.FromData( data );
}
 ...
 */
template < class T >
inline FancyString& operator>>( FancyString& s, T& data )
{
 ...
 */
template < class T >
inline FancyString& operator<<( FancyString& s, const T& data )
{
  return s.FromData( data );
}
