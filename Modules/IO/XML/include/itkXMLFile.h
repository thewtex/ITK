 ...
 * \ingroup ITKIOXML
 */
class ITKXML_EXPORT XMLReaderBase:public LightProcessObject
{
public:
 ...
 */
template< class T >
class ITKXML_EXPORT XMLReader: public XMLReaderBase
{
public:
 ...
 */
template< class T >
class ITKXML_EXPORT XMLWriterBase:public LightProcessObject
{
public:
