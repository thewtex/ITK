 ...
 *          i.e., the output of this class cannot be connected to an input of another ProcessObject except for DOMNodeXMLWriter,
 *          because the output of this class (i.e. a DOMNode) is not a DataObject.
 *
 ...
 * \ingroup ITKIOXML
 */
class DOMNodeXMLReader : public ProcessObject
{
public:
  ...
  itkTypeMacro(DOMNodeXMLReader, ProcessObject);
