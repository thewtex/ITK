...
public:
  ...
  /** Functions to set/get bar value. */
  itkSetMacro( BarValue, int );
  itkGetConstMacro( BarValue, int );
  /** Functions to set/get bar file name. */
  itkSetMacro( BarFileName, std::string );
  itkGetConstMacro( BarFileName, std::string );

private:
  DOMTestObject() : m_BarValue(0) {}
