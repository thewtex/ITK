...
//
#ifdef DIM_1
__kernel void SmoothFilter(__global const PIXELTYPE* in,__global PIXELTYPE* out, int radiusx, int width)
{
...
#ifdef DIM_2
__kernel void SmoothFilter(__global const PIXELTYPE* in,
