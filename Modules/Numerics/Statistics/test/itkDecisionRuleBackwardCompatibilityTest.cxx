...
int itkDecisionRuleBackwardCompatibilityTest(int, char* [] )
{
  ...
  typedef itk::DecisionRuleBase DecisionRuleType;
  ...
  typedef itk::MinimumDecisionRule MinimumDecisionRuleType;
  typedef itk::MaximumDecisionRule MaximumDecisionRuleType;
  typedef itk::MaximumRatioDecisionRule MaximumRationDecisionRuleType;
