 ...
 * a given offset falls outside of the requested region at a particular point,
 * that co-occurrence pair will not be added to the matrix.
 *
 ...
 *
 * IJ article:  http://www.insight-journal.org/browse/publication/231
 *
