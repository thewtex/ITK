...
public:
   ...
   */
  itkSetDecoratedNamedInputMacro(HistogramSize, HistogramSizeType);
   ...
   * integer type. */
  itkSetDecoratedNamedInputMacro(MarginalScale, HistogramMeasurementType);

  /** Methods for setting and getting the Minimum and Maximum values of the
   * histogram bins. */
  itkSetDecoratedNamedInputMacro(HistogramBinMinimum, HistogramMeasurementVectorType);
  itkSetDecoratedNamedInputMacro(HistogramBinMaximum, HistogramMeasurementVectorType);
  ...
  itkSetDecoratedNamedInputMacro(AutoMinimumMaximum, bool);
