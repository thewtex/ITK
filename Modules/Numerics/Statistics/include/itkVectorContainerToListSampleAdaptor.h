 ...
 * dimension equals to the measurement vectors size.
 *
...
public:
  ...
  typedef typename TVectorContainer::Iterator             VectorContainerIteratorType;
  typedef typename TVectorContainer::ConstIterator        VectorContainerConstIteratorType;
  ...
  void SetVectorContainer(const VectorContainerType *);

  /** Method to get the point set */
  const VectorContainerType * GetVectorContainer();
...
protected:
    ...
    ConstIterator(
      VectorContainerConstIteratorType iter,
    ...
    ConstIterator();
private:
    VectorContainerConstIteratorType m_Iter;
...
protected:
    ...
    Iterator(VectorContainerConstIteratorType iter, InstanceIdentifier iid);
    Iterator(const ConstIterator & it);
    ConstIterator & operator=(const ConstIterator & it);

    Iterator(
      VectorContainerIteratorType iter,
...
private:
  ...
  Iterator Begin()
  {
    VectorContainerPointer nonConstVectorDataContainer =
      const_cast< VectorContainerType * >( m_VectorContainer.GetPointer() );
  ...
  Iterator End()
  {
    ...
    Iterator iter( nonConstVectorDataContainer->End(), m_VectorContainer->Size() );
  ...
  {
    ConstIterator iter(m_VectorContainer->Begin(), 0);
  ...
  {
    ConstIterator iter( m_VectorContainer->End(), m_VectorContainer->Size() );
