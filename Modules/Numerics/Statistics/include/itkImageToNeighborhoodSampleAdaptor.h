/*=========================================================================
  ...
  Module:    itkImageToNeighborhoodSampleAdaptor.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
public:
  ...
  typedef typename std::vector< ConstNeighborhoodIterator< TImage, TBoundaryCondition > >                    MeasurementVectorType;
    ...
    const MeasurementVectorType & GetMeasurementVector() const
      {
        ...
        //this->m_MeasurementVectorCache.push_back(m_Iter);
 ...
 /** \class ImageToNeighborhoodSampleAdaptor::Iterator */
...
private:
  ...
  OffsetValueType                    m_OffsetTable[ImageType::ImageDimension+1];
