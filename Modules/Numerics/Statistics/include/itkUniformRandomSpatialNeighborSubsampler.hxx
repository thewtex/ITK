...
template <class TSample, class TRegion>
typename UniformRandomSpatialNeighborSubsampler<TSample, TRegion>::Baseclass::Pointer
UniformRandomSpatialNeighborSubsampler<TSample, TRegion>
::Clone() const
{
...
template <class TSample, class TRegion>
typename UniformRandomSpatialNeighborSubsampler<TSample, TRegion>::Baseclass*
UniformRandomSpatialNeighborSubsampler<TSample, TRegion>
