...
Element3DC0LinearTriangular
::JacobianDeterminant(const VectorType & /*HACK pt*/, const MatrixType * /*HACK
                                                                           pJ*/) const
{
  // use heron's formula
  const int na = 0;
...
void
Element3DC0LinearTriangular::ComputeNormalDirection(const VectorType & v1, const VectorType & v2,
...
void
Element3DC0LinearTriangular::GeneralizedProjectPoint(const VectorType & x, const VectorType & origin,
...
Element3DC0LinearTriangular::Determinant2x2(
