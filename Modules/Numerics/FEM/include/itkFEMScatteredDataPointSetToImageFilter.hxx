...
::GenerateData()
{
  ...
  {
      //provide a rectilinear mesh if users do not specify one.
...
::Generate2DQuadrilateralMesh()
{
    ...
    this->m_NumberOfElements[0] = int(size[0] / m_PixelsPerElement[0]) + 1;
    this->m_NumberOfElements[1] = int(size[1] / m_PixelsPerElement[1]) + 1;
...
::Generate3DHexahedralMesh()
{
    ...
    this->m_NumberOfElements[0] = int(size[0] / m_PixelsPerElement[0]) + 1;
    this->m_NumberOfElements[1] = int(size[1] / m_PixelsPerElement[1]) + 1;
    this->m_NumberOfElements[2] = int(size[2] / m_PixelsPerElement[2]) + 1;
