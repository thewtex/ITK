...
public:
  ...
  /** Set/Get contained element */
  void SetContainedElement(Element::ConstPointer e)
  {
      m_ContainedElement = e;
  }

  Element::ConstPointer GetContainedElement()
  {
...
protected:
  ...
  */
   ...
   */
  Element::ConstPointer m_ContainedElement;
