...
public:
  ...
  typedef typename ConfidencePointSetType::Pointer                            ConfidencePointSetPointer;
  ...
  typedef typename ConfidencePointDataContainerType::Iterator                 ConfidencePointDataIterator;
  ...
  itkSetMacro(FEMSolver, FEMSolverPointer);
  itkGetMacro(FEMSolver, FEMSolverPointer);
...
protected:
  ...
  void InitializeMaterials(FEMObjectPointer femObject);

  /** Initialize Nodes */
  void InitializeNodes(FEMObjectPointer femObject);

  /** Initialize Elements */
  void InitializeElements(FEMObjectPointer femObject);

  /** Initialize Loads */
  void InitializeLoads(FEMObjectPointer femObject);
