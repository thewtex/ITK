...
public:
  ...
  /** Get/Set the number of voxels/pixels in each dimension used during the mesh
    generation */
...
protected:
  ...
  /** Run the solver and call ProduceDeformationField to produce deformation
    field */
  void GenerateData();
...
private:
  ...
  FEMScatteredDataPointSetToImageFilter( const Self & ); // purposely not
                                                         // implemented.
