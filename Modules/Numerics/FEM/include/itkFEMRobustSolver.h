...
public:
  ...
  itkSetMacro(FracErrorRejected, double);
  itkGetMacro(FracErrorRejected, double);
...
protected:
  ...
  */
  ...
  unsigned int m_LandmarkForceIndex;
  ...
  unsigned int m_MaximumNonZeroMatrixEntriesFactor;
