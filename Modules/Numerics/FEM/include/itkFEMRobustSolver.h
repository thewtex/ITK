...
#include "itkFEMNoisyLoadLandmark.h"
...
protected:
  ...
  */
  ...
  double m_CgPrecision, m_FracErrorRejected;
...
public:
    ...
    {
        NoisyLoadLandmark * l1 = dynamic_cast<NoisyLoadLandmark*>(L1.GetPointer());
        NoisyLoadLandmark * l2 = dynamic_cast<NoisyLoadLandmark*>(L2.GetPointer());
...
public:
    ...
    {
        NoisyLoadLandmark *nl = dynamic_cast<NoisyLoadLandmark*>(l.GetPointer());
        if(nl != NULL)
            return nl->IsOutlier();
        return false;
    }
