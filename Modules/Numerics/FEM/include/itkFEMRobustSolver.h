...
public:
  ...
  */
  ...
  itkGetConstReferenceMacro(Origin, InterpolationGridPointType);

  itkSetMacro(Spacing, InterpolationGridSpacingType);
  itkGetConstReferenceMacro(Spacing, InterpolationGridSpacingType);

  itkSetMacro(Region, InterpolationGridRegionType);
  itkGetConstReferenceMacro(Region, InterpolationGridRegionType);

  itkSetMacro(Direction, InterpolationGridDirectionType);
  itkGetConstReferenceMacro(Direction, InterpolationGridDirectionType);
...
protected:
   ...
   */
  virtual void AssembleElementMatrixWithID(Element::Pointer e,
  ...
  */
   ...
   */
  void IncrementalSolverWithOutlierRejection(unsigned int OutlierRejectionSteps,
   ...
   * from approximation to interpolation
   */
  void IncrementalSolverWithoutOutlierRejection(unsigned int ApproximationSteps);
...
private:
  ...
  IndexType m_ForceIndex;
  IndexType m_LandmarkForceIndex;
  IndexType m_ExternalForceIndex;
  IndexType m_SolutionIndex;
  IndexType m_MeshStiffnessMatrixIndex;
  IndexType m_LandmarkStiffnessMatrixIndex;
  IndexType m_StiffnessMatrixIndex;
  IndexType m_MaximumNonZeroMatrixEntriesFactor;

  float m_TradeOffImageMeshEnergy;

  float         m_ToleranceToLargestDisplacement;
