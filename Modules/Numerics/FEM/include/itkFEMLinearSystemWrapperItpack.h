...
public:
   ...
   */
  const int  GetMaximumNumberIterations()
  {
    return m_IPARM[0];
  }
   ...
   */
  const int  GetErrorReportingLevel()
  {
    return m_IPARM[1];
  }
   ...
   */
  const int  GetCommunicationSwitch()
  {
    return m_IPARM[2];
  }
   ...
   * Get flag indicating ??
   */
  const int  GetAdaptiveCaseSwitch()
  {
    return m_IPARM[6];
  }
   ...
   */
  const int  GetErrorAnalysisSwitch()
  {
    return m_IPARM[11];
  }
   ...
   * Get ??
   */
  const double GetLargestJacobiEigenvalueEstimate()
  {
    return m_RPARM[1];
  }
   ...
   * Get the ??
   */
  const double GetEstimatedSpectralRadiusSSOR()
  {
    return m_RPARM[5];
  }
   ...
   * Get the ??
   */
  const double GetEstimatedSpectralRadiusLU()
  {
    return m_RPARM[6];
  }
   ...
   */
  const double GetDigitsInResidual()
  {
    return m_RPARM[11];
  }
