...
::MetaObjectToSpatialObject(const MetaObjectType * mo)
{
  ...
  while(it_nodes != nodelist.end())
    ...
    fem::Node::Pointer o1 =
      dynamic_cast< itk::fem::Node * >
      ( ObjectFactoryBase::CreateInstance ( "Node" ).GetPointer() );
  ...
  while(it_material != materiallist.end())
    ...
    itk::fem::MaterialLinearElasticity::Pointer o1 =
      dynamic_cast< itk::fem::MaterialLinearElasticity * >
      ( ObjectFactoryBase::CreateInstance ( "MaterialLinearElasticity" ).GetPointer() );
  ...
  while(it_elements != elementlist.end())
    ...
    itk::fem::Element::Pointer o1 = dynamic_cast< itk::fem::Element * >
      ( ObjectFactoryBase::CreateInstance ( element->m_ElementName ).GetPointer() );
    o1->SetGlobalNumber(element->m_GN);
    int numNodes = element->m_NumNodes;
    for (int i=0; i<numNodes; i++)
      {
      o1->SetNode(i, myFEMObject->GetNodeWithGlobalNumber
                  (element->m_NodesId[i]).GetPointer());
      }
    o1->SetMaterial( myFEMObject->GetMaterialWithGlobalNumber
                     (element->m_MaterialGN).GetPointer() );
  ...
  while(it_load != loadlist.end())
    ...
    if(loadname == "LoadNode")
      ...
      itk::fem::LoadNode::Pointer o1 =
        dynamic_cast< itk::fem::LoadNode * >
        ( ObjectFactoryBase::CreateInstance ( load->m_LoadName ).GetPointer() );
      ...
      itk::fem::LoadBCMFC::Pointer o1 =
        dynamic_cast< itk::fem::LoadBCMFC * >
        ( ObjectFactoryBase::CreateInstance( load->m_LoadName ).GetPointer() );
      o1->SetGlobalNumber(load->m_GN);
      ...
      for ( int i = 0; i < NumLHS; i++ )
        ...
        o1->GetLeftHandSideArray().push_back
          (fem::LoadBCMFC::MFCTerm
           (myFEMObject->GetElementWithGlobalNumber(elementGN).GetPointer(), DOF, Value) );
        }
      ...
      itk::fem::LoadGravConst::Pointer o1 =
        dynamic_cast< itk::fem::LoadGravConst * >
        ( ObjectFactoryBase::CreateInstance( load->m_LoadName ).GetPointer() );
      o1->SetGlobalNumber(load->m_GN);
      ...
      for (int i=0; i<load->m_NumElements; i++)
        ...
        o1->GetElementArray().push_back
          (myFEMObject->GetElementWithGlobalNumber(load->m_Elements[i]).GetPointer());
        }
      ...
      itk::fem::LoadLandmark::Pointer o1 =
        dynamic_cast< itk::fem::LoadLandmark * >
        ( ObjectFactoryBase::CreateInstance( load->m_LoadName ).GetPointer() );
      o1->SetGlobalNumber(load->m_GN);
  ...
  for (int i=0; i<numMaterial; i++)
    ...
    if(mat_name == "MaterialLinearElasticity")
      ...
      itk::fem::MaterialLinearElasticity::ConstPointer SOMaterialCast =
        dynamic_cast<const itk::fem::MaterialLinearElasticity * >( SOMaterial.GetPointer() );
  ...
  for (int ll=0; ll<numLoads; ++ll)
    ...
    if(load_name == "LoadNode")
      ...
      itk::fem::LoadNode::ConstPointer SOLoadCast =
        dynamic_cast<const itk::fem::LoadNode * >( SOLoad.GetPointer() );
    ...
    if(load_name == "LoadBC")
      ...
      itk::fem::LoadBC::ConstPointer SOLoadCast =
        dynamic_cast<const itk::fem::LoadBC * >( SOLoad.GetPointer() );
    ...
    if(load_name == "LoadBCMFC")
      ...
      itk::fem::LoadBCMFC::ConstPointer SOLoadCast =
        dynamic_cast<const itk::fem::LoadBCMFC * >( SOLoad.GetPointer() );
    ...
    if(load_name == "LoadEdge")
      ...
      itk::fem::LoadEdge::ConstPointer SOLoadCast =
        dynamic_cast<const itk::fem::LoadEdge * >( SOLoad.GetPointer() );
    ...
    if(load_name == "LoadGravConst")
      ...
      itk::fem::LoadGravConst::ConstPointer SOLoadCast =
        dynamic_cast<const itk::fem::LoadGravConst * >( SOLoad.GetPointer() );
    ...
    if(load_name == "LoadLandmark")
      ...
      itk::fem::LoadLandmark::ConstPointer SOLoadCast =
        dynamic_cast<const itk::fem::LoadLandmark * >( SOLoad.GetPointer() );
