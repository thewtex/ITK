...
class GradientDescentObjectOptimizerBaseModifyGradientByLearningRateThreader
  : public DomainThreader< ThreadedIndexedContainerPartitioner, TGradientDescentObjectOptimizer >
{
public:
  /** Standard class typedefs. */
  typedef GradientDescentObjectOptimizerBaseModifyGradientByLearningRateThreader Self;
  typedef DomainThreader< ThreadedIndexedContainerPartitioner, TGradientDescentObjectOptimizer >
                                                                                 Superclass;
...
#include "itkGradientDescentObjectOptimizerBaseModifyGradientByLearningRateThreader.hxx"
#endif
