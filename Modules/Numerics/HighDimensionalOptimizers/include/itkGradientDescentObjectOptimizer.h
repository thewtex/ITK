 ...
 *
 * When m_ScalesEstimator is set, m_MaximumStepSizeInPhysicalSpaceUnits may also
 ...
 * impacts on voxels less than m_MaximumStepSizeInPhysicalSpaceUnits.
 * m_MaximumStepSizeInPhysicalSpaceUnits defaults to the voxel spacing returned
...
public:
  ...
  itkSetMacro(MaximumStepSizeInPhysicalSpaceUnits, InternalComputationValueType);
...
protected:
  ...
  InternalComputationValueType  m_MaximumStepSizeInPhysicalSpaceUnits;
