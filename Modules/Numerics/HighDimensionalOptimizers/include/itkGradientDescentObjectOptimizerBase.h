...
protected:
  ...
  friend class GradientDescentObjectOptimizerBaseModifyGradientByScalesThreader< Self >;
  friend class GradientDescentObjectOptimizerBaseModifyGradientByLearningRateThreader< Self >;

  typedef GradientDescentObjectOptimizerBaseModifyGradientByScalesThreader< Self >
    GradientDescentObjectOptimizerBaseModifyGradientByScalesThreaderType;
  typedef GradientDescentObjectOptimizerBaseModifyGradientByLearningRateThreader< Self >
    GradientDescentObjectOptimizerBaseModifyGradientByLearningRateThreaderType;

  typedef typename GradientDescentObjectOptimizerBaseModifyGradientByScalesThreaderType::IndexRangeType IndexRangeType;

  typename GradientDescentObjectOptimizerBaseModifyGradientByScalesThreaderType::Pointer       m_ModifyGradientByScalesThreader;
  typename GradientDescentObjectOptimizerBaseModifyGradientByLearningRateThreaderType::Pointer m_ModifyGradientByLearningRateThreader;
