...
#include "itkCommandScalesUpdate.h"
                                                          ...
                                                          bool usePhysicalSpaceForShift = true)
{
  ...
  typedef itk::CommandScalesUpdate< OptimizerType, itk::OptimizerParameterScalesEstimator >
    CommandScalesType;
  ...
  scalesCommand->QuietOff(); //by default Quiet is on
