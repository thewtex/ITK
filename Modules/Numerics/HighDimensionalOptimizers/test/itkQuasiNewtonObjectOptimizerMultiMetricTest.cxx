...
int itkQuasiNewtonObjectOptimizerMultiMetricTest(int argc, char *argv[])
{
  ...
  std::string metricString = argv[1];
  ...
  if( argc >= 7 )
    {
    numberOfDisplacementIterations = atoi( argv[6] );
    }
  ...
  if (metricString.compare("dm") == 0)
    ...
    typedef MIMetricType::FixedSampledPointSetType  PointSetType;
    ...
    ANCMetricType::Pointer nbcMetric = ANCMetricType::New();
