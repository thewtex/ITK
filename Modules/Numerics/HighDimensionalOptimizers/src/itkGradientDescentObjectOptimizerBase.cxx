...
::GradientDescentObjectOptimizerBase()
{
  ...
  this->m_ModifyGradientByScalesThreader = GradientDescentObjectOptimizerBaseModifyGradientByScalesThreaderType::New();

  /** Threader for apply the learning rate to gradient */
  this->m_ModifyGradientByLearningRateThreader = GradientDescentObjectOptimizerBaseModifyGradientByLearningRateThreaderType::New();
