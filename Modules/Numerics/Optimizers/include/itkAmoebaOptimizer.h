...
public:
   ...
   * diameter threshold is set via SetParametersConvergenceTolerance() with the
   * default value defined as DEFAULT_PARAMETERS_CONVERGENCE_TOLERANCE.  The
   * cost function convergence threshold is set via
   * SetFunctionConvergenceTolerance() with the default value defined as
   * DEFAULT_FUNCTION_CONVERGENCE_TOLERANCE. */
