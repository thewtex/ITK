...
public:
  ...
  itkSetMacro( InitializationCoefficient, double )
  itkGetMacro( InitializationCoefficient, double )
  ...
  const ParametersType::ValueType DEFAULT_INITIALIZATION_COEFFICIENT;
