 ...
 * and the maximum voxel shift in optimizer.
 *
 * The estimation requires information about metric and transform which is
 * not available in the optimizer. Therefore we create a separate class
 * for this purpose.
 *
