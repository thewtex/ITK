...
::ResumeOptimization()
{
  ...
  while( ! this->m_Stop )
    ...
    try
      ...
      // this keeps the logic of the original implementation:
      this->m_Metric->SetParameters( currentParam );
      // but maybe this is what's intended. it works too for the test.
