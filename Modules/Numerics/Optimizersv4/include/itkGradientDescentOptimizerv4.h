...
: public GradientDescentOptimizerBaseTemplatev4<InternalComputationType>
{
public:
  /** Standard class typedefs. */
  typedef GradientDescentOptimizerTemplatev4                                   Self;
  typedef GradientDescentOptimizerBaseTemplatev4<InternalComputationType> Superclass;
...
extern template class itk::GradientDescentOptimizerTemplatev4<float>;
extern template class itk::GradientDescentOptimizerTemplatev4<double>;
