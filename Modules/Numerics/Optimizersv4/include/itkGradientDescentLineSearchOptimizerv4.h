...
: public GradientDescentOptimizerTemplatev4<InternalComputationType>
{
public:
  /** Standard class typedefs. */
  typedef GradientDescentLineSearchOptimizerTemplatev4                 Self;
  typedef  GradientDescentOptimizerTemplatev4<InternalComputationType> Superclass;
  ...
  typedef itk::Function::WindowConvergenceMonitoringFunction<InternalComputationType> ConvergenceMonitoringType;
  ...
  itkGetMacro( Epsilon , InternalComputationType );
   ...
   */
  itkSetMacro( LowerLimit , InternalComputationType );
  itkGetMacro( LowerLimit , InternalComputationType );
  itkSetMacro( UpperLimit , InternalComputationType );
  itkGetMacro( UpperLimit , InternalComputationType );
...
protected:
  ...
  InternalComputationType GoldenSectionSearch( InternalComputationType a, InternalComputationType b, InternalComputationType c );

  InternalComputationType m_LowerLimit;
  InternalComputationType m_UpperLimit;
  InternalComputationType m_Phi;
  InternalComputationType m_Resphi;
