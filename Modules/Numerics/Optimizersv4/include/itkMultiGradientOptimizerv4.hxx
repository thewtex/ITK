...
MultiGradientOptimizerTemplatev4<InternalComputationType>
...
//-------------------------------------------------------------------
template<class InternalComputationType>
typename MultiGradientOptimizerTemplatev4<InternalComputationType>::OptimizersListType &
MultiGradientOptimizerTemplatev4<InternalComputationType>
::GetOptimizersList()
{
...
template<class InternalComputationType>
const typename MultiGradientOptimizerTemplatev4<InternalComputationType>::MetricValuesListType &
MultiGradientOptimizerTemplatev4<InternalComputationType>
...
//-------------------------------------------------------------------
template<class InternalComputationType>
const typename MultiGradientOptimizerTemplatev4<InternalComputationType>::StopConditionReturnStringType
MultiGradientOptimizerTemplatev4<InternalComputationType>
...
::ResumeOptimization()
{
  ...
  while( ! this->m_Stop )
    ...
    InternalComputationType combinefunction = NumericTraits<InternalComputationType>::OneValue() / static_cast<InternalComputationType>(maxOpt);
