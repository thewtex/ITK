...
public:
  ...
  typedef itk::GradientDescentOptimizerTemplatev4<InternalComputationType>                   LocalOptimizerType;
  typedef typename itk::GradientDescentOptimizerTemplatev4<InternalComputationType>::Pointer LocalOptimizerPointer;
  typedef typename Superclass::ParametersType                                                ParametersType;
  typedef ObjectToObjectOptimizerBaseTemplate<InternalComputationType>                       OptimizerType;
...
extern template class itk::MultiGradientOptimizerTemplatev4<float>;
extern template class itk::MultiGradientOptimizerTemplatev4<double>;
