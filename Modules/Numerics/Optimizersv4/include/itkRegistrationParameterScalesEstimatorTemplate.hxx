 ...
 *
 *=========================================================================*/
#ifndef __itkRegistrationParameterScalesEstimatorTemplate_hxx
#define __itkRegistrationParameterScalesEstimatorTemplate_hxx
...
RegistrationParameterScalesEstimatorTemplate< TMetric >
::RegistrationParameterScalesEstimatorTemplate()
{
...
template< class TMetric >
typename RegistrationParameterScalesEstimatorTemplate< TMetric >::FloatType
RegistrationParameterScalesEstimatorTemplate< TMetric >
...
if (m_Metric.IsNull())
    {
    itkExceptionMacro("RegistrationParameterScalesEstimatorTemplate: the metric is NULL");
    }

  if (this->m_Metric->GetMovingTransform() == NULL)
    {
    itkExceptionMacro("RegistrationParameterScalesEstimatorTemplate: this->m_MovingTransform in the metric is NULL.");
    }
  if (this->m_Metric->GetFixedTransform() == NULL)
    {
    itkExceptionMacro("RegistrationParameterScalesEstimatorTemplate: this->m_FixedTransform in the metric is NULL.");
    }
 ...
 */
template< class TMetric >
typename RegistrationParameterScalesEstimatorTemplate< TMetric >::VirtualIndexType
RegistrationParameterScalesEstimatorTemplate< TMetric >
 ...
 */
template< class TMetric >
typename RegistrationParameterScalesEstimatorTemplate< TMetric >::VirtualRegionType
RegistrationParameterScalesEstimatorTemplate< TMetric >
...
#endif /* __itkRegistrationParameterScalesEstimatorTemplate_txx */
