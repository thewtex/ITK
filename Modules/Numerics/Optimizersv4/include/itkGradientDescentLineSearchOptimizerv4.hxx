...
GradientDescentLineSearchOptimizerTemplatev4<InternalComputationType>
::GradientDescentLineSearchOptimizerTemplatev4()
{
  ...
  this->m_LowerLimit = itk::NumericTraits< InternalComputationType >::Zero;
...
// x corresponds to x4
template<class InternalComputationType>
InternalComputationType
GradientDescentLineSearchOptimizerTemplatev4<InternalComputationType>
::GoldenSectionSearch( InternalComputationType a, InternalComputationType b, InternalComputationType c )
{
  ...
  InternalComputationType metricx, metricb;
    ...
    InternalComputationType baseLearningRate = this->m_LearningRate;
