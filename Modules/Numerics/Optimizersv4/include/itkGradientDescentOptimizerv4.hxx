...
GradientDescentOptimizerTemplatev4<InternalComputationType>
::GradientDescentOptimizerTemplatev4()
{
  ...
  this->m_MaximumStepSizeInPhysicalUnits = NumericTraits<InternalComputationType>::Zero;

    // Initialize parameters for the convergence checker
  this->m_MinimumConvergenceValue = 1e-8;//NumericTraits<InternalComputationType>::epsilon();//1e-30;
