 ...
 *
 *=========================================================================*/
#ifndef __itkRegistrationParameterScalesEstimatorTemplate_h
#define __itkRegistrationParameterScalesEstimatorTemplate_h
...
#include "itkOptimizerParameterScalesEstimatorTemplate.h"
...
/** \class RegistrationParameterScalesEstimatorTemplate
...
class ITK_EXPORT RegistrationParameterScalesEstimatorTemplate : public OptimizerParameterScalesEstimatorTemplate<typename TMetric::ParametersValueType>
{
public:
  /** Standard class typedefs. */
  typedef RegistrationParameterScalesEstimatorTemplate            Self;
  typedef OptimizerParameterScalesEstimatorTemplate
                      <typename TMetric::ParametersValueType>     Superclass;
  typedef SmartPointer<Self>                                      Pointer;
  typedef SmartPointer<const Self>                                ConstPointer;

  /** Run-time type information (and related methods). */
  itkTypeMacro( RegistrationParameterScalesEstimatorTemplate, Superclass );
...
private:
  RegistrationParameterScalesEstimatorTemplate(const Self&); //purposely not implemented
...
#include "itkRegistrationParameterScalesEstimatorTemplate.hxx"
#endif

#endif /* __itkRegistrationParameterScalesEstimatorTemplate_h */
