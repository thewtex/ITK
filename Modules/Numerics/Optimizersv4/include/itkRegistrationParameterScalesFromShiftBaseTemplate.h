 ...
 *
 *=========================================================================*/
#ifndef __itkRegistrationParameterScalesFromShiftBaseTemplate_h
#define __itkRegistrationParameterScalesFromShiftBaseTemplate_h

#include "itkRegistrationParameterScalesEstimatorTemplate.h"

namespace itk
{

/** \class RegistrationParameterScalesFromShiftBaseTemplate
 ...
 * See RegistrationParameterScalesEstimatorTemplate documentation.
 *
 * \sa RegistrationParameterScalesEstimatorTemplate
 * \ingroup ITKOptimizersv4
 */
template < class TMetric >
class ITK_EXPORT RegistrationParameterScalesFromShiftBaseTemplate :
  public RegistrationParameterScalesEstimatorTemplate< TMetric >
{
public:
  /** Standard class typedefs. */
  typedef RegistrationParameterScalesFromShiftBaseTemplate        Self;
  typedef RegistrationParameterScalesEstimatorTemplate< TMetric > Superclass;
  typedef SmartPointer<Self>                                      Pointer;
  typedef SmartPointer<const Self>                                ConstPointer;

  /** Run-time type information (and related methods). */
  itkTypeMacro( RegistrationParameterScalesFromShiftBaseTemplate, RegistrationParameterScalesEstimatorTemplate );
...
protected:
  RegistrationParameterScalesFromShiftBaseTemplate();
  ~RegistrationParameterScalesFromShiftBaseTemplate(){};
...
private:
  RegistrationParameterScalesFromShiftBaseTemplate(const Self&); //purposely not implemented
...
#include "itkRegistrationParameterScalesFromShiftBaseTemplate.hxx"
#endif

#endif /* __itkRegistrationParameterScalesFromShiftBaseTemplate_h */
