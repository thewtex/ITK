...
public:
  ...
  /** Type of scales */
  typedef typename ObjectToObjectOptimizerBaseTemplate<InternalComputationValueType>::ScalesType        ScalesType;
  /** Type of parameters of the optimizer */
  typedef typename ObjectToObjectOptimizerBaseTemplate<InternalComputationValueType>::ParametersType    ParametersType;
  /** Type of float */
  typedef InternalComputationValueType                                                                  FloatType;
