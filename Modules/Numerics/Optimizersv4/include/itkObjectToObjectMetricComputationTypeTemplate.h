 ...
 *
 *=========================================================================*/
#ifndef __itkObjectToObjectMetricComputationTypeTemplate_h
#define __itkObjectToObjectMetricComputationTypeTemplate_h
...
/** \class ObjectToObjectMetricComputationTypeTemplate
 ...
 */
template<class ParametersValueType, unsigned int TFixedDimension, unsigned int TMovingDimension, class TVirtualImage = Image<ParametersValueType, TFixedDimension> >
class ITK_EXPORT ObjectToObjectMetricComputationTypeTemplate:
  public ObjectToObjectMetricBaseTemplate< ParametersValueType >
{
public:
  /** Standard class typedefs. */
  typedef ObjectToObjectMetricComputationTypeTemplate                 Self;
  typedef ObjectToObjectMetricBaseTemplate< ParametersValueType >     Superclass;
  typedef SmartPointer< Self >                                        Pointer;
  typedef SmartPointer< const Self >                                  ConstPointer;

  /** Run-time type information (and related methods). */
  itkTypeMacro(ObjectToObjectMetricComputationTypeTemplate, ObjectToObjectMetricBaseTemplate);

  /** Type used for representing object components  */
  typedef ParametersValueType            CoordinateRepresentationType;

  /** Type for internal computations */
  typedef ParametersValueType            InternalComputationValueType;
...
protected:
  ...
  virtual ~ObjectToObjectMetricComputationTypeTemplate();
...
private:
  ObjectToObjectMetricComputationTypeTemplate(const Self &); //purposely not implemented
...
#include "itkObjectToObjectMetricComputationTypeTemplate.hxx"
#endif
