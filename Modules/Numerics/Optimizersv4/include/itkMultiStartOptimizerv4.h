...
: public ObjectToObjectOptimizerBaseTemplate<InternalComputationType>
{
public:
  /** Standard class typedefs. */
  typedef MultiStartOptimizerTemplatev4                                Self;
  typedef ObjectToObjectOptimizerBaseTemplate<InternalComputationType> Superclass;
  ...
  typedef typename itk::GradientDescentOptimizerTemplatev4<InternalComputationType> LocalOptimizerType;
...
extern template class itk::MultiStartOptimizerTemplatev4<float>;
extern template class itk::MultiStartOptimizerTemplatev4<double>;
