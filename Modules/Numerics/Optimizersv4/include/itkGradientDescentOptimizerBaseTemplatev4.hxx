...
::GradientDescentOptimizerBaseTemplatev4()
{
  ...
  this->m_ModifyGradientByScalesThreader = GradientDescentOptimizerBasev4ModifyGradientByScalesThreaderTemplate<ValueType>::New();

  /** Threader for apply the learning rate to gradient */
  this->m_ModifyGradientByLearningRateThreader = GradientDescentOptimizerBasev4ModifyGradientByLearningRateThreaderTemplate<ValueType>::New();
