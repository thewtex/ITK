 ...
 *
 *=========================================================================*/
#ifndef __itkGradientDescentOptimizerBaseTemplatev4_hxx
#define __itkGradientDescentOptimizerBaseTemplatev4_hxx

#include "itkGradientDescentOptimizerBaseTemplatev4.h"
#include "itkGradientDescentOptimizerBasev4ModifyGradientByScalesThreaderTemplate.h"
#include "itkGradientDescentOptimizerBasev4ModifyGradientByLearningRateThreaderTemplate.h"
...
GradientDescentOptimizerBaseTemplatev4<ValueType>
::GradientDescentOptimizerBaseTemplatev4()
{
  /** Threader for apply scales to gradient */
  typename GradientDescentOptimizerBasev4ModifyGradientByScalesThreaderTemplate<ValueType>::Pointer modifyGradientByScalesThreader =
    GradientDescentOptimizerBasev4ModifyGradientByScalesThreaderTemplate<ValueType>::New();
  this->m_ModifyGradientByScalesThreader = modifyGradientByScalesThreader;

  /** Threader for apply the learning rate to gradient */
  typename GradientDescentOptimizerBasev4ModifyGradientByLearningRateThreaderTemplate<ValueType>::Pointer modifyGradientByLearningRateThreader =
    GradientDescentOptimizerBasev4ModifyGradientByLearningRateThreaderTemplate<ValueType>::New();
...
//-------------------------------------------------------------------
template<class ValueType>
const typename GradientDescentOptimizerBaseTemplatev4<ValueType>::StopConditionReturnStringType
GradientDescentOptimizerBaseTemplatev4<ValueType>
