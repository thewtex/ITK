 ...
 *
 *=========================================================================*/
#ifndef __itkSingleValuedVnlCostFunctionAdaptorv4_hxx
#define __itkSingleValuedVnlCostFunctionAdaptorv4_hxx
#include "itkSingleValuedVnlCostFunctionAdaptorv4.h"

namespace itk
{
/**  Constructor.  */
SingleValueVnlCostFunctionAdaptorv4
...
::f(const InternalParametersType & inparameters)
{
  ...
  if ( m_ScalesInitialized )
    ...
    for ( unsigned int i = 0; i < parameters.size(); i++ )
      {
//x      parameters[i] = inparameters[i] / m_Scales[i];
      parameters[i] = inparameters[i];
      }
    }
  else
    {
...
#endif // __itkSingleValuedVnlCostFunctionAdaptorv4_hxx
