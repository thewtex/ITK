...
//FIXME: Remove this if the MetricIsPointSetToPointSetType method is removed
...
{
  //FIXME: decide if should keep this
...
/*
FIXME: removed temporarily to decide if should be kept
template< class TMetric >
bool
RegistrationParameterScalesEstimator< TMetric >
::MetricIsPointSetToPointSetType()
{
  ...
  typedef PointSetToPointSetMetricv4<FixedPointSetType, MovingPointSetType> PointSetMetricType;
