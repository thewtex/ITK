...
class ITK_EXPORT SingleValuedCostFunctionTemplatev4:
  public CostFunctionTemplate<InternalComputationType>
{
public:
  /** Standard class typedefs. */
  typedef SingleValuedCostFunctionTemplatev4              Self;
  typedef CostFunctionTemplate<InternalComputationType>   Superclass;
  ...
  typedef InternalComputationType                  MeasureType;
  ...
  typedef Array< InternalComputationType > DerivativeType;
