...
#include "itkQuasiNewtonOptimizerv4EstimateNewtonStepThreaderEstimateNewtonStepThreader.h"
 ...
 */
class ITK_EXPORT QuasiNewtonOptimizerv4EstimateNewtonStepThreader:
...
public:
  ...
  itkTypeMacro(QuasiNewtonOptimizerv4EstimateNewtonStepThreader, GradientDescentOptimizerv4);
...
protected:
  ...
  friend class QuasiNewtonOptimizerv4EstimateNewtonStepThreaderEstimateNewtonStepThreader;
...
private:
  ...
  QuasiNewtonOptimizerv4EstimateNewtonStepThreaderEstimateNewtonStepThreader::Pointer m_EstimateNewtonStepThreader;
};
} // end namespace itk
