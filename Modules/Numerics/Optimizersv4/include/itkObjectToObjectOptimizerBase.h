...
public:
  ...
  /**  Scale type. */
  typedef OptimizerParameters< InternalComputationValueType >          ScalesType;

  /**  Parameters type. */
  typedef OptimizerParameters< InternalComputationValueType >          ParametersType;

  /** Metric function type */
  typedef ObjectToObjectMetricBaseTemplate< InternalComputationValueType >  MetricType;
...
extern template class itk::ObjectToObjectOptimizerBaseTemplate<float>;
extern template class itk::ObjectToObjectOptimizerBaseTemplate<double>;
