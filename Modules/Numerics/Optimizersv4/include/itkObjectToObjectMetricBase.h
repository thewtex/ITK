...
namespace itk
{
   ...
   */
template<class InternalComputationValueType=double>
class ITK_EXPORT ObjectToObjectMetricBaseTemplate:
  public SingleValuedCostFunctionTemplatev4<InternalComputationValueType>
{
public:
  /** Standard class typedefs. */
  typedef ObjectToObjectMetricBaseTemplate                                  Self;
  typedef SingleValuedCostFunctionTemplatev4<InternalComputationValueType>  Superclass;
  ...
  typedef InternalComputationValueType            CoordinateRepresentationType;
...
extern template class itk::ObjectToObjectMetricBaseTemplate<float>;
extern template class itk::ObjectToObjectMetricBaseTemplate<double>;
