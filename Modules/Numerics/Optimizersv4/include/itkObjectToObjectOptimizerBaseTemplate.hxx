 ...
 *
 *=========================================================================*/
#ifndef __itkObjectToObjectOptimizerBaseTemplate_hxx
#define __itkObjectToObjectOptimizerBaseTemplate_hxx
...
ObjectToObjectOptimizerBaseTemplate<ValueType>
...
//-------------------------------------------------------------------
template<class ValueType>
const typename ObjectToObjectOptimizerBaseTemplate<ValueType>::ParametersType &
ObjectToObjectOptimizerBaseTemplate<ValueType>
::GetCurrentPosition()
{
  if( this->m_Metric.IsNull() )
...
//-------------------------------------------------------------------
template<class ValueType>
const typename ObjectToObjectOptimizerBaseTemplate<ValueType>::MeasureType &
ObjectToObjectOptimizerBaseTemplate<ValueType>
::GetValue()
{
