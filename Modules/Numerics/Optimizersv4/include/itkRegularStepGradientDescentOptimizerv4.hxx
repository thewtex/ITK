...
::AdvanceOneStep()
{
  ...
  const double stepLength = (this->m_CurrentLearningRateRelaxation*this->m_LearningRate)/gradientMagnitude;
  ...
  std::cout << "\tLearningRate: " << this->m_LearningRate << std::endl;
  std::cout << "\tgradientMagnitude: " << gradientMagnitude << std::endl;
  std::cout << "\tCurrentLearningRateRelaxation: " << this->m_CurrentLearningRateRelaxation << std::endl;
