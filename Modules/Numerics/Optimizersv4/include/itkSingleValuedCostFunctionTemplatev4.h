 ...
 *
 *=========================================================================*/
#ifndef __itkSingleValuedCostFunctionTemplatev4_h
#define __itkSingleValuedCostFunctionTemplatev4_h
...
class ITK_EXPORT SingleValuedCostFunctionTemplatev4:
  public CostFunctionTemplate<ParametersValueType>
{
public:
  /** Standard class typedefs. */
  typedef SingleValuedCostFunctionTemplatev4              Self;
  typedef CostFunctionTemplate<ParametersValueType>       Superclass;
  ...
  typedef ParametersValueType         MeasureType;
