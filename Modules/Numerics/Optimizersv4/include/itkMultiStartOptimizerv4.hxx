...
MultiStartOptimizerTemplatev4<InternalComputationType>
...
//-------------------------------------------------------------------
template<class InternalComputationType>
typename MultiStartOptimizerTemplatev4<InternalComputationType>::ParametersListType &
MultiStartOptimizerTemplatev4<InternalComputationType>
::GetParametersList()
{
...
template<class InternalComputationType>
const typename MultiStartOptimizerTemplatev4<InternalComputationType>::MetricValuesListType &
MultiStartOptimizerTemplatev4<InternalComputationType>
...
//-------------------------------------------------------------------
template<class InternalComputationType>
typename MultiStartOptimizerTemplatev4<InternalComputationType>::ParametersType
MultiStartOptimizerTemplatev4<InternalComputationType>
::GetBestParameters( )
{
...
::InstantiateLocalOptimizer()
{
  ...
  optimizer->SetLearningRate( static_cast<InternalComputationType>(1.e-1) );
...
//-------------------------------------------------------------------
template<class InternalComputationType>
const typename MultiStartOptimizerTemplatev4<InternalComputationType>::StopConditionReturnStringType
MultiStartOptimizerTemplatev4<InternalComputationType>
