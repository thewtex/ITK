 ...
 *
 *=========================================================================*/
#ifndef __itkOptimizerParameterScalesEstimatorTemplate_h
#define __itkOptimizerParameterScalesEstimatorTemplate_h
...
public:
  ...
  /** Type of scales */
  typedef typename ObjectToObjectOptimizerBaseTemplate<ParametersValueType>::ScalesType        ScalesType;
  /** Type of parameters of the optimizer */
  typedef typename ObjectToObjectOptimizerBaseTemplate<ParametersValueType>::ParametersType    ParametersType;
  /** Type of float */
  typedef ParametersValueType                                                                  FloatType;
...
#endif /* __itkOptimizerParameterScalesEstimatorTemplate_h */
