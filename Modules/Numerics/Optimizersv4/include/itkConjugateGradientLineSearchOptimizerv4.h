...
: public GradientDescentLineSearchOptimizerTemplatev4<InternalComputationType>
{
public:
  /** Standard class typedefs. */
  typedef ConjugateGradientLineSearchOptimizerTemplatev4                        Self;
  typedef GradientDescentLineSearchOptimizerTemplatev4<InternalComputationType> Superclass;
...
extern template class itk::ConjugateGradientLineSearchOptimizerTemplatev4<float>;
extern template class itk::ConjugateGradientLineSearchOptimizerTemplatev4<double>;
