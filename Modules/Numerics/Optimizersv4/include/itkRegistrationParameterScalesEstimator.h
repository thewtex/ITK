 ...
 * The point set can be retrieved from a metric using GetVirtualTransformedPointSet()
 * method within the metric.
 *
...
protected:
  ...
  /** Test if the assigned metric is a PointSetToPointSetMetric */
//removed temporarily to decide if should be kept
//  bool MetricIsPointSetToPointSetType();
