 ...
 *
 *=========================================================================*/
#ifndef __itkMultiGradientOptimizerTemplatev4_hxx
#define __itkMultiGradientOptimizerTemplatev4_hxx
...
MultiGradientOptimizerTemplatev4<ValueType>
...
//-------------------------------------------------------------------
template<class ValueType>
typename MultiGradientOptimizerTemplatev4<ValueType>::OptimizersListType &
MultiGradientOptimizerTemplatev4<ValueType>
::GetOptimizersList()
{
...
template<class ValueType>
const typename MultiGradientOptimizerTemplatev4<ValueType>::MetricValuesListType &
MultiGradientOptimizerTemplatev4<ValueType>
...
//-------------------------------------------------------------------
template<class ValueType>
const typename MultiGradientOptimizerTemplatev4<ValueType>::StopConditionReturnStringType
MultiGradientOptimizerTemplatev4<ValueType>
