...
ObjectToObjectOptimizerBaseTemplate<InternalComputationValueType>
...
//-------------------------------------------------------------------
template<class InternalComputationValueType>
const typename ObjectToObjectOptimizerBaseTemplate<InternalComputationValueType>::ParametersType &
ObjectToObjectOptimizerBaseTemplate<InternalComputationValueType>
::GetCurrentPosition()
{
  if( this->m_Metric.IsNull() )
...
//-------------------------------------------------------------------
template<class InternalComputationValueType>
const typename ObjectToObjectOptimizerBaseTemplate<InternalComputationValueType>::MeasureType &
ObjectToObjectOptimizerBaseTemplate<InternalComputationValueType>
::GetValue()
{
