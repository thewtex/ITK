 ...
 *
 *=========================================================================*/
#ifndef __itkGradientDescentOptimizerTemplatev4_h
#define __itkGradientDescentOptimizerTemplatev4_h
...
: public GradientDescentOptimizerBaseTemplatev4<ValueType>
{
public:
  /** Standard class typedefs. */
  typedef GradientDescentOptimizerTemplatev4                Self;
  typedef GradientDescentOptimizerBaseTemplatev4<ValueType> Superclass;
  ...
  typedef itk::Function::WindowConvergenceMonitoringFunction<ValueType>
   ...
   */
  itkSetObjectMacro(ScalesEstimator, OptimizerParameterScalesEstimatorTemplate<ValueType>);
   ...
   *  checking.
   */
  itkSetMacro(MinimumConvergenceValue, /*InternalComputationValueType*/ double);
  ...
  itkGetConstReferenceMacro( ConvergenceValue, /*InternalComputationValueType*/ double);
...
protected:
  ...
  typename OptimizerParameterScalesEstimatorTemplate<ValueType>::Pointer m_ScalesEstimator;
...
#include "itkGradientDescentOptimizerTemplatev4.hxx"
#endif
