...
: public GradientDescentOptimizerBaseTemplatev4<InternalComputationValueType>
{
public:
  /** Standard class typedefs. */
  typedef GradientDescentOptimizerTemplatev4                                      Self;
  typedef GradientDescentOptimizerBaseTemplatev4<InternalComputationValueType>    Superclass;
  ...
  typedef itk::Function::WindowConvergenceMonitoringFunction<InternalComputationValueType>
   ...
   */
  itkSetObjectMacro(ScalesEstimator, OptimizerParameterScalesEstimatorTemplate<InternalComputationValueType>);
...
protected:
  ...
  typename OptimizerParameterScalesEstimatorTemplate<InternalComputationValueType>::Pointer m_ScalesEstimator;
