 ...
 *
 *=========================================================================*/
#ifndef __itkObjectToObjectMetricBaseTemplate_h
#define __itkObjectToObjectMetricBaseTemplate_h

#include "itkTransformBaseTemplate.h"
...
namespace itk
{
   ...
   */
template<class ParametersPrecisionType>
class ITK_EXPORT ObjectToObjectMetricBaseTemplate:
  public SingleValuedCostFunctionTemplatev4<ParametersPrecisionType>
{
public:
  /** Standard class typedefs. */
  typedef ObjectToObjectMetricBaseTemplate                              Self;
  typedef SingleValuedCostFunctionTemplatev4<ParametersPrecisionType>   Superclass;
  ...
  typedef ParametersPrecisionType                 CoordinateRepresentationType;

  /** Type for internal computations */
  typedef ParametersPrecisionType                 InternalComputationValueType;
  ...
  typedef ParametersPrecisionType                 ParametersValueType;
...
#include "itkObjectToObjectMetricBaseTemplate.hxx"
#endif
