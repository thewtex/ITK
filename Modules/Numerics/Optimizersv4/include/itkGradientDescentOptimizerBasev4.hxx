...
GradientDescentOptimizerBaseTemplatev4<InternalComputationType>
::GradientDescentOptimizerBaseTemplatev4()
{
  /** Threader for apply scales to gradient */
  typename GradientDescentOptimizerBasev4ModifyGradientByScalesThreaderTemplate<InternalComputationType>::Pointer modifyGradientByScalesThreader =
    GradientDescentOptimizerBasev4ModifyGradientByScalesThreaderTemplate<InternalComputationType>::New();
  this->m_ModifyGradientByScalesThreader = modifyGradientByScalesThreader;

  /** Threader for apply the learning rate to gradient */
  typename GradientDescentOptimizerBasev4ModifyGradientByLearningRateThreaderTemplate<InternalComputationType>::Pointer modifyGradientByLearningRateThreader =
    GradientDescentOptimizerBasev4ModifyGradientByLearningRateThreaderTemplate<InternalComputationType>::New();
...
//-------------------------------------------------------------------
template<class InternalComputationType>
const typename GradientDescentOptimizerBaseTemplatev4<InternalComputationType>::StopConditionReturnStringType
GradientDescentOptimizerBaseTemplatev4<InternalComputationType>
