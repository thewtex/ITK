 ...
 *
 *=========================================================================*/
#ifndef __itkObjectToObjectOptimizerBaseTemplate_h
#define __itkObjectToObjectOptimizerBaseTemplate_h
...
public:
  ...
  /**  Scale type. */
  typedef OptimizerParameters< ValueType >          ScalesType;

  /**  Parameters type. */
  typedef OptimizerParameters< ValueType >          ParametersType;

  /** Metric function type */
  typedef ObjectToObjectMetricBaseTemplate< ValueType >      MetricType;
...
#include "itkObjectToObjectOptimizerBaseTemplate.hxx"
#endif
