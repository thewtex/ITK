 ...
 *
 *=========================================================================*/
#ifndef __itkQuasiNewtonOptimizerv4EstimateNewtonStepThreaderTemplate_h
#define __itkQuasiNewtonOptimizerv4EstimateNewtonStepThreaderTemplate_h

#include "itkDomainThreader.h"
#include "itkThreadedIndexedContainerPartitioner.h"
#include "itkQuasiNewtonOptimizerTemplatev4.h"
 ...
 * */
template<class ParameterValueType>
class QuasiNewtonOptimizerv4EstimateNewtonStepThreaderTemplate
  : public DomainThreader< ThreadedIndexedContainerPartitioner, QuasiNewtonOptimizerTemplatev4<ParameterValueType> >
{
public:
  /** Standard class typedefs. */
  typedef QuasiNewtonOptimizerv4EstimateNewtonStepThreaderTemplate                                  Self;
  typedef DomainThreader< ThreadedIndexedContainerPartitioner, QuasiNewtonOptimizerTemplatev4<ParameterValueType> >
                                                                                                    Superclass;
...
#include "itkQuasiNewtonOptimizerv4EstimateNewtonStepThreaderTemplate.hxx"
#endif
