...
class LBFGSOptimizerBasev4Template:
    public SingleValuedNonLinearVnlOptimizerv4
{
public:
  /** Standard "Self" typedef. */
  typedef LBFGSOptimizerBasev4Template        Self;
  typedef SingleValuedNonLinearVnlOptimizerv4 Superclass;
  typedef SmartPointer< Self >                Pointer;
  typedef SmartPointer< const Self >          ConstPointer;

  /** Run-time type information (and related methods). */
  itkTypeMacro(LBFGSOptimizerBasev4Template, SingleValuedNonLinearVnlOptimizerv4);
...
protected:
  LBFGSOptimizerBasev4Template();
  virtual ~LBFGSOptimizerBasev4Template();
...
private:
  LBFGSOptimizerBasev4Template(const Self &); //purposely not implemented
