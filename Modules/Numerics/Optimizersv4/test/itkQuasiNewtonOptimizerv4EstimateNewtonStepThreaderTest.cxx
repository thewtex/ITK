...
int itkQuasiNewtonOptimizerv4EstimateNewtonStepThreaderTestTemplated(int numberOfIterations,
                                                          double shiftOfStep,
                                                          ...
                                                          bool usePhysicalSpaceForShift = true)
{
  ...
  // Optimizer
  typedef itk::QuasiNewtonOptimizerv4EstimateNewtonStepThreader  OptimizerType;
...
int itkQuasiNewtonOptimizerv4EstimateNewtonStepThreaderTest(int argc, char ** const argv)
{
  if( argc > 3 )
    {
  ...
  ret1 = itkQuasiNewtonOptimizerv4EstimateNewtonStepThreaderTestTemplated<TranslationTransformType>(numberOfIterations, shiftOfStep, "shift");

  std::cout << std::endl << "Optimizing translation transform with Jacobian scales" << std::endl;
  typedef itk::TranslationTransform<double, Dimension> TranslationTransformType;
  ret2 = itkQuasiNewtonOptimizerv4EstimateNewtonStepThreaderTestTemplated<TranslationTransformType>(numberOfIterations, shiftOfStep, "jacobian");
