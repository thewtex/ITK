...
int itkAutoScaledGradientDescentRegistrationOnVectorTestTemplated(int numberOfIterations,
                                                          double shiftOfStep,
                                                          ...
                                                          bool usePhysicalSpaceForShift = true)
{
  ...
  // Metric
  typedef itk::VectorImageToImageMetricTraitsv4< FixedImageType, MovingImageType, FixedImageType, 2 > MetricTraitsType;
  typedef itk::DemonsImageToImageMetricv4
    < FixedImageType, MovingImageType, FixedImageType, MetricTraitsType > MetricType;
...
int itkAutoScaledGradientDescentRegistrationOnVectorTest(int argc, char ** const argv)
{
  ...
  ret1 = itkAutoScaledGradientDescentRegistrationOnVectorTestTemplated<TranslationTransformType>(numberOfIterations, shiftOfStep, "shift", usePhysicalSpaceForShift);
