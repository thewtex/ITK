  ...
  OutputPointIdentifierType& oId ) const
{
  ...
  while( nNum<50 && qe->GetLeft() != OutputMeshType::m_NoFace )
    ...
    */
    ...
    OutputVectorRealType lambda11 = -( x1 * v1 ) / ( ( x - x1 ) * v1 );   //
                                                                          //
                                                                          // left
                                                                          //
                                                                          // most
    OutputVectorRealType lambda12 = -( x1 * v2 ) / ( ( x - x1 ) * v2 );   //
                                                                          //
                                                                          // right
                                                                          //
                                                                          // most
    OutputVectorRealType lambda21 = -( x2 * v1 ) / ( ( x - x2 ) * v1 );   //
                                                                          //
                                                                          // left
                                                                          //
                                                                          // most
    OutputVectorRealType lambda22 = -( x2 * v2 ) / ( ( x - x2 ) * v2 );   //
                                                                          //
                                                                          // right
                                                                          //
                                                                          // most
