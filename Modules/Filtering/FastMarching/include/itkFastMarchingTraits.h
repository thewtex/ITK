...
template< unsigned int VDimension,
          typename TInputPixel,
          typename TInputMeshTraits, //= QuadEdgeMeshTraits< TInputPixel,
                                     // VDimension, bool, bool >,
          typename TOutputPixel,     //= TInputPixel,
          class TOutputMeshTraits    //= QuadEdgeMeshTraits< TOutputPixel,
                                     // VDimension, bool, bool >
          >
class FastMarchingTraits<QuadEdgeMesh< TInputPixel, VDimension,
                                       TInputMeshTraits >,
