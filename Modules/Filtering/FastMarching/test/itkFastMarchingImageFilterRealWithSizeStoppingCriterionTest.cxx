...
#include "itkFastMarchingSizeStoppingCriterion.h"
...
int itkFastMarchingImageFilterRealWithSizeStoppingCriterionTest(int argc, char* argv[] )
{
  if( argc != 2 )
    {
  ...
  typedef itk::FastMarchingSizeStoppingCriterion< FloatImageType, FloatImageType >
      CriterionType;
...
//  typedef FastMarchingType::NodeContainerType NodeContainerType;
  ...
  typedef itk::ImageFileWriter< FloatImageType > OutputWriterType;
