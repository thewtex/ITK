...
//  speedImage->Print( std::cout );
  ...
  // It is also necessary that the TargetOffset be set to 0.0 for the
  // TargetReached
  // tests to pass.
...
// marcher->DebugOn();
  ...
  // Find the smallest reaching time of the TargetPoints.  This is the time of
  // the closest
  // TargetPoint.
  ...
  // Find the largest reaching time of the TargetPoints.  This is the largest
  // time of
