...
#include "itkImage.h"
#include "itkImageFastMarchingTraits2.h"
...
int FastMarchingImageFilter( unsigned int argc, char *argv[] )
{
  ...
  typedef itk::ImageFastMarchingTraits2< InternalImageType, InternalImageType >
      FMMTraits;

  typedef unsigned char OutputPixelType;
  typedef itk::Image<OutputPixelType, VDimension> OutputImageType;

  typedef itk::FastMarchingThresholdStoppingCriterion< FMMTraits >
      CriterionType;
  ...
  typedef itk::FastMarchingImageFilterBase< FMMTraits > FastMarchingType;
