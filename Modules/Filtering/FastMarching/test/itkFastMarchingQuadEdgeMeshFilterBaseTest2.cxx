...
#include "itkMeshFastMarchingTraits2.h"
...
int itkFastMarchingQuadEdgeMeshFilterBaseTest2( int , char** )
{
  ...
  typedef itk::MeshFastMarchingTraits2< MeshType, MeshType > FMMTraits;

  typedef itk::FastMarchingQuadEdgeMeshFilterBase< FMMTraits > FastMarchingType;
