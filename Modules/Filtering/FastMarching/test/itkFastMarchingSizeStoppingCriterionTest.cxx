...
int itkFastMarchingSizeStoppingCriterionTest( int , char * [] )
{
  typedef itk::Image< float, 2> ImageType;

  typedef itk::FastMarchingSizeStoppingCriterion<
  ...
  typedef itk::FastMarchingSizeStoppingCriterion< MeshType, MeshType >
