...
#include "itkImageFastMarchingTraits.h"
...
int FastMarchingImageFilterBase( )
  ...
  typedef itk::ImageFastMarchingTraits< VDimension, PixelType, PixelType >
      FMMTraits;

  typedef itk::FastMarchingThresholdStoppingCriterion< FMMTraits >
      CriterionType;

  typedef itk::FastMarchingImageFilterBase< FMMTraits >
      FMMType;
