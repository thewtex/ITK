...
int itkMaskedFFTNormalizedCorrelationImageFilterTest(int argc, char * argv[] )
{
  ...
  // This parameter generally does not need to be set by the user.
  ...
  filter->SetRequiredPercentageOfOverlappingPixels(5);

  typedef itk::RescaleIntensityImageFilter<RealImageType,OutputImageType> RescaleType;
