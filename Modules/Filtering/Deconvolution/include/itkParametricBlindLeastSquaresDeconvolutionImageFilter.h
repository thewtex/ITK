...
private:
   ...
   * image estimate. */
  typedef Functor::ParametricBlindLeastSquaresDeconvolutionDifference< InternalComplexType >
  ...
  typedef Functor::ParametricBlindLeastSquaresDeconvolutionImageUpdate< InternalComplexType >
