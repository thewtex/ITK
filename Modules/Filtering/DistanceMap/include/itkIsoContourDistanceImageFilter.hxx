  ...
  for ( unsigned int n = 0; n < ImageDimension; n++ )
    ...
    if ( sign != neighSign )
      ...
      if ( norm > NumericTraits< PixelRealType >::min() )
        ...
        if ( vcl_fabs( static_cast< PixelRealType >( valNew0 ) ) < vcl_fabs( static_cast< PixelRealType >( outNeigIt.GetNext(n, 0) ) ) )
          {
          outNeigIt.SetNext( n, 0, static_cast< PixelType >( valNew0 ) );
          }
        if ( vcl_fabs( static_cast< PixelRealType >( valNew1 ) ) < vcl_fabs( static_cast< PixelRealType >( outNeigIt.GetNext(n, 1) ) ) )
          {
