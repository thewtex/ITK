...
int itkGradientRecursiveGaussianFilterTest4(int, char* [] )
{
  ...
  typedef itk::VariableLengthVector<float> myVectorType;
  ...
  //typedef itk::VectorImage<float> myGradImageType;
