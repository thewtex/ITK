...
::BeforeThreadedGenerateData()
{
  ...
  ThreadIdType max_number_threads = itk::MultiThreader::GetGlobalMaximumNumberOfThreads();
  if ( max_number_threads != 0 )
    {
    nbOfThreads = vnl_math_min( this->GetNumberOfThreads(), max_number_threads );
    }
