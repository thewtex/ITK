...
public:
   ...
   *  path by one pixel */
  OffsetType IncrementInput(InputType & input) const;
   ...
   *  previous and next integral timepoints index and subtracting them */
  VectorType EvaluateDerivative(const InputType & input) const;
