...
# Testing GPU Binary Threshold Image Filter
...
from itk import ITKGPUCommon
print(dir(ITKGPUCommon))
print(ITKGPUCommon.lazy_attributes)
print(ITKGPUCommon.loaded_lazy_modules)
from itk import ITKGPUThresholding
print(dir(ITKGPUThresholding))
print(ITKGPUThresholding.lazy_attributes)
print(ITKGPUThresholding.loaded_lazy_modules)
print(itk.BinaryThresholdImageFilter.GetTypes())
print(itk.GPUBinaryThresholdImageFilter.GetTypes())
sys.exit(0)

BinaryThresholdFilterType = itk.BinaryThresholdImageFilter[InputImageType, OutputImageType]
GPUBinaryThresholdFilterType = itk.GPUBinaryThresholdImageFilter[InputGPUImageType, OutputGPUImageType]

# test 1~8 work units for CPU
for number_of_work_units in range(1,9):
    cpu_filter = BinaryThresholdFilterType.New()
    ...
    print("CPU BinaryThresholdFilter took {0} seconds with {1} work units.\n".format(cpu_timer.GetMean(),
                cpu_filter.GetNumberOfWorkUnits()))


gpu_filter = GPUBinaryThresholdFilterType.New()
...
print("GPU BinaryThresholdFilter took {0} seconds.\n".format(gpu_timer.GetMean()))
