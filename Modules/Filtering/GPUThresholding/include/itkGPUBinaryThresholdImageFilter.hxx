...
#ifdef __APPLE__
    // This is to work around a bug in the OpenCL compiler on Mac OS 10.6 and
    // 10.7 with NVidia drivers
    // where the compiler was not handling unsigned char arguments correctly.
    // be sure to define the kernel arguments as InArgType and OutArgType in the
    // kernel source
