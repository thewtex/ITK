 ...
 *
 *=========================================================================*/
#ifndef __itkBSplineExponentialTransform_h
#define __itkBSplineExponentialTransform_h
...
/** \class BSplineExponentialTransform
...
class ITK_EXPORT BSplineExponentialTransform :
  public  BSplineSmoothingOnUpdateDisplacementFieldTransform<TScalar, NDimensions>
{
public:
  /** Standard class typedefs. */
  typedef BSplineExponentialTransform                                                Self;
  ...
  itkTypeMacro( BSplineExponentialTransform, BSplineSmoothingOnUpdateDisplacementFieldTransform );
...
protected:
  BSplineExponentialTransform();
  virtual ~BSplineExponentialTransform();

private:
  BSplineExponentialTransform( const Self& ); //purposely not implemented
...
# include "Templates/itkBSplineExponentialTransform+-.h"
#endif

#if ITK_TEMPLATE_TXX
# include "itkBSplineExponentialTransform.hxx"
#endif

#endif // __itkBSplineExponentialTransform_h
