...
::UpdateTransformParameters( const DerivativeType & update, ScalarType factor )
{
  ...
  if( smoothVelocityField )
    ...
    ConstantVelocityFieldPointer velocitySmoothField =
      this->GaussianSmoothConstantVelocityField( updatedVelocityField, this->m_GaussianSmoothingVarianceForTheVelocityField );

    updatedVelocityField = velocitySmoothField;
    }
