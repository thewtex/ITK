 ...
 * the histogram and therefore the threshold is computed from the non
 * zero parts of the mask. The output image is, by default, masked by
 * the same image. This output masking can be disabled using
 * SetMaskOutput(false)
 *
