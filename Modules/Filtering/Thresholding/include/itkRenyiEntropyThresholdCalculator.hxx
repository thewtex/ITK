                          ...
                          const std::vector< double >& P2 )
{
  ...
  */
  InstanceIdentifier threshold = 0;                            // was MIN_INT in
                                                               // original code,
                                                               // but if an
                                                               // empty image is
                                                               // processed it
                           ...
                           const std::vector< double >& P2 )
{
  ...
  InstanceIdentifier threshold = 0; //was MIN_INT in original code, but if an
                                    // empty image is processed it gives an
                                    // error later on.
