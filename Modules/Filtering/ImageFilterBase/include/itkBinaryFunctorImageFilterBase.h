 ...
 *
 *=========================================================================*/
#ifndef __itkBinaryFunctorImageFilterBase_h
#define __itkBinaryFunctorImageFilterBase_h
...
namespace itk
{
/** \class BinaryFunctorImageFilterBase
 * \brief Abstract base class for implementing pixel-wise generic
 * operations on two images, or of an image and a constant.
 *
...
class ITK_EXPORT BinaryFunctorImageFilterBase:
  public InPlaceImageFilter< TInputImage1, TOutputImage >
{
public:
  /** Standard class typedefs. */
  typedef BinaryFunctorImageFilterBase                     Self;
  typedef InPlaceImageFilter< TInputImage1, TOutputImage > Superclass;
  typedef SmartPointer< Self >                             Pointer;
  typedef SmartPointer< const Self >                       ConstPointer;

  /** Run-time type information (and related methods). */
  itkTypeMacro(BinaryFunctorImageFilterBase, InPlaceImageFilter);
...
protected:
  ...
  virtual ~BinaryFunctorImageFilterBase() {}
  ...
  virtual OutputImagePixelType InvokeFunctor(const OutputImageIndexType & index,
                                             ...
                                             const Input2ImagePixelType & value2) = 0;

private:
  BinaryFunctorImageFilterBase(const Self &); //purposely not implemented
...
#include "itkBinaryFunctorImageFilterBase.hxx"
#endif
