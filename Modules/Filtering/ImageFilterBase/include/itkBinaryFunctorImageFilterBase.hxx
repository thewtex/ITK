 ...
 *
 *=========================================================================*/
#ifndef __itkBinaryFunctorImageFilterBase_hxx
#define __itkBinaryFunctorImageFilterBase_hxx
...
BinaryFunctorImageFilterBase< TInputImage1, TInputImage2, TOutputImage, TFunction >
...
template< class TInputImage1, class TInputImage2,
          class TOutputImage, class TFunction  >
const typename BinaryFunctorImageFilterBase< TInputImage1, TInputImage2, TOutputImage, TFunction >::Input1ImagePixelType &
BinaryFunctorImageFilterBase< TInputImage1, TInputImage2, TOutputImage, TFunction >
::GetConstant1() const
{
...
template< class TInputImage1, class TInputImage2,
          class TOutputImage, class TFunction  >
const typename BinaryFunctorImageFilterBase< TInputImage1, TInputImage2, TOutputImage, TFunction >::Input2ImagePixelType &
BinaryFunctorImageFilterBase< TInputImage1, TInputImage2, TOutputImage, TFunction >
::GetConstant2() const
{
                       ...
                       ThreadIdType threadId)
{
  ...
  if( inputPtr1 && inputPtr2 )
    ...
    while ( !inputIt1.IsAtEnd() )
      {
      outputIt.Set( this->InvokeFunctor( outputIt.GetIndex(), inputIt1.Get(), inputIt2.Get() ) );
      ++inputIt2;
      ++inputIt1;
      ++outputIt;
    ...
    while ( !inputIt1.IsAtEnd() )
      {
      outputIt.Set( this->InvokeFunctor( outputIt.GetIndex(), inputIt1.Get(), input2Value ) );
      ++inputIt1;
      ++outputIt;
      progress.CompletedPixel(); // potential exception thrown here
      }
    ...
    while ( !inputIt2.IsAtEnd() )
      {
      outputIt.Set( this->InvokeFunctor( outputIt.GetIndex(), input1Value, inputIt2.Get() ) );
      ++inputIt2;
      ++outputIt;
      progress.CompletedPixel(); // potential exception thrown here
      }
