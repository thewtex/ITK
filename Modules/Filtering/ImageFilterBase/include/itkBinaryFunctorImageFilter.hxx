                       ...
                       ThreadIdType threadId)
{
  ...
  if( inputPtr1 && inputPtr2 )
    {
    ImageFastLinearConstIterator< TInputImage1 > inputIt1(inputPtr1, outputRegionForThread);
    ImageFastLinearConstIterator< TInputImage2 > inputIt2(inputPtr2, outputRegionForThread);
    ImageFastLinearIterator< TOutputImage > outputIt(outputPtr, outputRegionForThread);
