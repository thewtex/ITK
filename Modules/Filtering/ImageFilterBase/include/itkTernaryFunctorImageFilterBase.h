 ...
 *
 *=========================================================================*/
#ifndef __itkTernaryFunctorImageFilterBase_h
#define __itkTernaryFunctorImageFilterBase_h
...
namespace itk
{
/** \class TernaryFunctorImageFilterBase
 * \brief Base class for implementing pixel-wise generic operations on
 * three images.
 *
 * \tparam TInputImage1 First input image type
 * \tparam TInputImage2 Second input image type
 * \tparam TInputImage3 Third input image type
 * \tparam TOutputImage Output image type
 * \tparam TFunction    Functor type that defines the operation to be applied
 *
 * \sa UnaryFunctorImageFilterBase
 * \sa BinaryFunctorImageFilterBase
 *
...
class ITK_EXPORT TernaryFunctorImageFilterBase :
    public InPlaceImageFilter< TInputImage1, TOutputImage >
{
public:
  /** Standard class typedefs. */
  typedef TernaryFunctorImageFilterBase                    Self;
  typedef InPlaceImageFilter< TInputImage1, TOutputImage > Superclass;
  typedef SmartPointer< Self >                             Pointer;
  typedef SmartPointer< const Self >                       ConstPointer;

  /** Run-time type information (and related methods). */
  itkTypeMacro(TernaryFunctorImageFilterBase, InPlaceImageFilter);
  ...
  typedef typename Input1ImageType::IndexType    Input1ImageIndexType;
  ...
  typedef typename Input2ImageType::IndexType    Input2ImageIndexType;
  ...
  typedef typename Input3ImageType::IndexType    Input3ImageIndexType;
...
protected:
  ...
  virtual ~TernaryFunctorImageFilterBase() {}
  ...
  virtual OutputImagePixelType InvokeFunctor(const OutputImageIndexType & index,
                                             ...
                                             const Input3ImagePixelType & value3) = 0;

private:
  TernaryFunctorImageFilterBase(const Self &); //purposely not implemented
...
#include "itkTernaryFunctorImageFilterBase.hxx"
#endif
