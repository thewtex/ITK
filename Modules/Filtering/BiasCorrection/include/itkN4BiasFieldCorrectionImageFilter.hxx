...
::GenerateData()
{
  ...
  logBiasField->AllocateWithDefaultPixelInitializer(); // initialize buffer to zero
...
::SharpenImage( const RealImageType *unsharpenedImage ) const
{
  ...
  sharpenedImage->AllocateWithDefaultPixelInitializer(); // initialize buffer to zero
