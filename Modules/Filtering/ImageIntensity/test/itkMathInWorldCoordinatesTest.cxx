...
int itkMathOpTest(float valA, float valB, typename TImage::PixelType expectedResult)
{
...
int itkMathInWorldCoordinatesTest(int, char* [] )
{
  ...
  if(itkMathOpTest<myImageType,AddImageFilterType,myDimension>(2.0,3.0,5.0) != EXIT_SUCCESS)
    {
    err = EXIT_FAILURE;
    }
  if(itkMathOpTest<myImageType,SubtractImageFilterType,myDimension>(2.0,3.0,-1.0) != EXIT_SUCCESS)
    {
    err = EXIT_FAILURE;
    }
  if(itkMathOpTest<myImageType,MultiplyImageFilterType,myDimension>(2.0,3.0,6.0) != EXIT_SUCCESS)
    {
    err = EXIT_FAILURE;
    }
  if(itkMathOpTest<myImageType,DivideImageFilterType,myDimension>(2.0,3.0,(2.0/3.0)) != EXIT_SUCCESS)
    {
    err = EXIT_FAILURE;
    }
  ...
  if(itkMathOpTest<myVectorImageType,VectorAddImageFilterType,myDimension>(2.0,3.0,expectedResult)
     != EXIT_SUCCESS)
    {
    err = EXIT_FAILURE;
    }
