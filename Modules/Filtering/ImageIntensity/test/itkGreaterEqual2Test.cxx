...
int itkGreaterEqual2Test(int, char* [] )
{
  ...
  typedef itk::BinaryFunctorImageFilter<
    ...
    myImageType2,
    myImageType3,
    itk::Functor::GreaterEqual2<myImageType1::PixelType,
  ...
  std::cout << " Result : Im1 >= Im2" << std::endl;
  while( !it3.IsAtEnd() )
  {
  ...
  std::cout << " Result Im1 >= 2.0 " << std::endl;
  it3.GoToBegin();
  while( !it3.IsAtEnd() )
  {
    std::cout << it3.Get() << std::endl;
  ...
  std::cout << " Result 3.0 >= Im2 " << std::endl;
  it3.GoToBegin();
  while( !it3.IsAtEnd() )
  {
    std::cout << it3.Get() << std::endl;
