...
int
itkConstrainedValueAdditionImageFilterTest(int, char* [] )
{
  ...
  float valueA = 125; // when added to B will saturate a char in some of the
                      // pixels.
  ...
  float valueB = 125; // when added to A will saturate a char in some of the
                      // pixels.
