...
itkHessianRecursiveGaussianFilterScaleSpaceTest(int, char* [] )
{
  ...
  for (unsigned int i=0; i<numberOfScales; i++)
    ...
    // Fill the image with a 1D Gaussian along X with sigma equal to the current
    // scale
    // The Gaussian is not normalized, since it should have the same peak value
    // across
    ...
    // Get the value at the center of the image, the location of the peak of the
    // Gaussian
    PointType center;
    center.Fill(0.0);
