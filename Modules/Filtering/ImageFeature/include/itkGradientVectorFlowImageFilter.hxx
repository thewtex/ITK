...
::InitInterImage()
{
  ...
  itk::ImageAlgorithm::Copy(this->GetInput(), m_IntermediateImage.GetPointer(), this->GetInput()->GetLargestPossibleRegion(), m_IntermediateImage->GetLargestPossibleRegion());
