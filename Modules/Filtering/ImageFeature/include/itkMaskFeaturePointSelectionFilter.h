...
public:
  ...
  /** set/get half window(optional) for avoiding points too close to boundaries */
  itkSetMacro(BlockHalfWindow, InputImageSizeType);
  itkGetConstMacro(BlockHalfWindow, InputImageSizeType);
...
private:
  ...
  InputImageSizeType  m_BlockHalfWindow;
