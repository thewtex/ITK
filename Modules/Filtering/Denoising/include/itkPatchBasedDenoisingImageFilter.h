...
public PatchBasedDenoisingBaseImageFilter<TInputImage, TOutputImage>
{
 ...
 protected:
  ...
  void ComputeMinMax(const Image<RGBPixel<PixelValueType>,
                             ImageDimension>* imgPtr);
  void ComputeMinMax(const Image<RGBAPixel<PixelValueType>,
                             ImageDimension>* imgPtr);
  void ComputeMinMax(const Image<Vector<PixelValueType,PixelType::Dimension>,
                             ImageDimension>* imgPtr);
  void ComputeMinMax(const Image<FixedArray<PixelValueType,PixelType::Dimension>,
                             ImageDimension>* imgPtr);
  void ComputeMinMax(const Image<Array<PixelValueType>,
                             ImageDimension>* imgPtr);
  template <class TImage> void ComputeMinMax(const TImage* imgPtr);
  void ArrayComputeMinMax(const InputImageType* imgPtr);

  virtual void EnforceConstraints() throw(DataObjectError);
  ...
  RealArrayType    m_ImageMin;
  RealArrayType    m_ImageMax;
