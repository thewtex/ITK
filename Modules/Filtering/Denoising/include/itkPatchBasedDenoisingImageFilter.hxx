...
::PatchBasedDenoisingImageFilter()
{
  ...
  m_SigmaUpdateDecimationFactor     = static_cast<unsigned int>
    (itk::Math::Round<double>(1.0 / m_FractionPixelsForSigmaUpdate) );
...
::Initialize()
{
  ...
  m_SigmaUpdateDecimationFactor
    = vnl_math_min(m_SigmaUpdateDecimationFactor,
                   static_cast<unsigned int>
                   (itk::Math::Round<double>(m_TotalNumberPixels / 100.0) ) );
      ...
      if (d == 0)
        ...
        distanceVector[d]
          = static_cast<DistanceType> (pos            /
                                       itk::Math::Round<double> (pow(static_cast<double>(physicalDiameter),static_cast<int>(d) ) ) )
            - static_cast<DistanceType> (centerPosition /
                                         itk::Math::Round<double> (pow(static_cast<double>(physicalDiameter),
                                                           static_cast<int>(d) ) ) );
        }
      }
