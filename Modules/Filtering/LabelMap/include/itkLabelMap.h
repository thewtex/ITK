...
public:
  ...
  private:
    ...
    ConstIterator(const Self *lm, const InternalIteratorType & pos )
    {
      m_Begin = lm->m_LabelObjectContainer.begin();
      m_End = lm->m_LabelObjectContainer.end();
      m_Iterator = pos;
  ...
  private:
    ...
    Iterator( Self *lm, const InternalIteratorType & pos )
    {
      m_Begin = lm->m_LabelObjectContainer.begin();
      m_End = lm->m_LabelObjectContainer.end();
      m_Iterator = pos;
  ...
  /** Return an iterator at the begining of the LabelObjects */
  ...
  /** Return an iterator at the end of the LabelObjects */
  ConstIterator End() const
  {
    return ConstIterator( this, m_LabelObjectContainer.end() );
  }
  Iterator End()
  {
    return Iterator( this, m_LabelObjectContainer.end() );
  }
