...
int itkVnlFFTWF_RealFFTTest(int argc, char *argv[])
{
  ...
  if((test_fft_rtc<float,1,
      ...
      itk::FFTWRealToComplexForwardFFTImageFilter<ImageF1> >(SizeOfDimensions1)) != 0)
    rval++;
  std::cerr << "VnlFFTWF:float,2 (4,4,4)" << std::endl;
  if((test_fft_rtc<float,2,
      itk::VnlRealToComplexForwardFFTImageFilter<ImageF2> ,
      itk::FFTWRealToComplexForwardFFTImageFilter<ImageF2> >(SizeOfDimensions1)) != 0)
    rval++;
  std::cerr << "VnlFFTWF:float,3 (4,4,4)" << std::endl;
  if((test_fft_rtc<float,3,
      itk::VnlRealToComplexForwardFFTImageFilter<ImageF3> ,
      itk::FFTWRealToComplexForwardFFTImageFilter<ImageF3> >(SizeOfDimensions1)) != 0)
    rval++;
  std::cerr << "VnlFFTWF:float,1 (3,5,4)" << std::endl;
  if((test_fft_rtc<float,1,
      itk::VnlRealToComplexForwardFFTImageFilter<ImageF1> ,
      itk::FFTWRealToComplexForwardFFTImageFilter<ImageF1> >(SizeOfDimensions2)) != 0)
    rval++;
  std::cerr << "VnlFFTWF:float,2 (3,5,4)" << std::endl;
  if((test_fft_rtc<float,2,
      itk::VnlRealToComplexForwardFFTImageFilter<ImageF2> ,
      itk::FFTWRealToComplexForwardFFTImageFilter<ImageF2> >(SizeOfDimensions2)) != 0)
    rval++;
  std::cerr << "VnlFFTWF:float,3 (3,5,4)" << std::endl;
  if((test_fft_rtc<float,3,
      itk::VnlRealToComplexForwardFFTImageFilter<ImageF3> ,
      itk::FFTWRealToComplexForwardFFTImageFilter<ImageF3> >(SizeOfDimensions2)) != 0)
    rval++;
