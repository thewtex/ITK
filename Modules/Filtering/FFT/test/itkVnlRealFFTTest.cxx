...
int itkVnlRealFFTTest(int, char *[])
{
  ...
  if((test_fft<float,1,
      itk::VnlRealToComplexForwardFFTImageFilter<ImageF1> ,
      itk::VnlComplexToRealInverseFFTImageFilter<ImageCF1> >(SizeOfDimensions1)) != 0)
    {
    rval++;
  ...
  if((test_fft<float,2,
      itk::VnlRealToComplexForwardFFTImageFilter<ImageF2> ,
      itk::VnlComplexToRealInverseFFTImageFilter<ImageCF2> >(SizeOfDimensions1)) != 0)
    {
    std::cerr << "--------------------- Failed!" << std::endl;
    rval++;
    }
  ...
  if((test_fft<float,3,
      itk::VnlRealToComplexForwardFFTImageFilter<ImageF3> ,
      itk::VnlComplexToRealInverseFFTImageFilter<ImageCF3> >(SizeOfDimensions1)) != 0)
    {
    std::cerr << "--------------------- Failed!" << std::endl;
    rval++;
    }
  ...
  if((test_fft<float,4,
      itk::VnlRealToComplexForwardFFTImageFilter<ImageF4> ,
      itk::VnlComplexToRealInverseFFTImageFilter<ImageCF4> >(SizeOfDimensions1)) != 0)
    {
    std::cerr << "--------------------- Failed!" << std::endl;
    rval++;
    }
  ...
  if((test_fft<double,1,
      itk::VnlRealToComplexForwardFFTImageFilter<ImageD1> ,
      itk::VnlComplexToRealInverseFFTImageFilter<ImageCD1> >(SizeOfDimensions1)) != 0)
    {
    std::cerr << "--------------------- Failed!" << std::endl;
    rval++;
    }
  ...
  if((test_fft<double,2,
      itk::VnlRealToComplexForwardFFTImageFilter<ImageD2> ,
      itk::VnlComplexToRealInverseFFTImageFilter<ImageCD2> >(SizeOfDimensions1)) != 0)
    {
    std::cerr << "--------------------- Failed!" << std::endl;
    rval++;
    }
  ...
  if((test_fft<double,3,
      itk::VnlRealToComplexForwardFFTImageFilter<ImageD3> ,
      itk::VnlComplexToRealInverseFFTImageFilter<ImageCD3> >(SizeOfDimensions1)) != 0)
    {
    std::cerr << "--------------------- Failed!" << std::endl;
    rval++;
    }
  ...
  if((test_fft<float,1,
      itk::VnlRealToComplexForwardFFTImageFilter<ImageF1> ,
      itk::VnlComplexToRealInverseFFTImageFilter<ImageCF1> >(SizeOfDimensions2)) != 0)
    {
    std::cerr << "--------------------- Failed!" << std::endl;
    rval++;
    }
  ...
  if((test_fft<float,2,
      itk::VnlRealToComplexForwardFFTImageFilter<ImageF2> ,
      itk::VnlComplexToRealInverseFFTImageFilter<ImageCF2> >(SizeOfDimensions2)) != 0)
    {
    std::cerr << "--------------------- Failed!" << std::endl;
    rval++;
    }
  ...
  if((test_fft<float,3,
      itk::VnlRealToComplexForwardFFTImageFilter<ImageF3> ,
      itk::VnlComplexToRealInverseFFTImageFilter<ImageCF3> >(SizeOfDimensions2)) != 0)
    {
    std::cerr << "--------------------- Failed!" << std::endl;
    rval++;
    }
  ...
  if((test_fft<double,1,
      itk::VnlRealToComplexForwardFFTImageFilter<ImageD1> ,
      itk::VnlComplexToRealInverseFFTImageFilter<ImageCD1> >(SizeOfDimensions2)) != 0)
    {
    std::cerr << "--------------------- Failed!" << std::endl;
    rval++;
    }
  ...
  if((test_fft<double,2,
      itk::VnlRealToComplexForwardFFTImageFilter<ImageD2> ,
      itk::VnlComplexToRealInverseFFTImageFilter<ImageCD2> >(SizeOfDimensions2)) != 0)
    {
    std::cerr << "--------------------- Failed!" << std::endl;
    rval++;
    }
  ...
  if((test_fft<double,3,
      itk::VnlRealToComplexForwardFFTImageFilter<ImageD3> ,
      itk::VnlComplexToRealInverseFFTImageFilter<ImageCD3> >(SizeOfDimensions2)) != 0)
    {
    std::cerr << "--------------------- Failed!" << std::endl;
    rval++;
    }
  ...
  if((test_fft<float,1,
      itk::VnlRealToComplexForwardFFTImageFilter<ImageF1> ,
      itk::VnlComplexToRealInverseFFTImageFilter<ImageCF1> >(SizeOfDimensions3)) == 0)
    {
    std::cerr << "--------------------- Failed!" << std::endl;
    rval++;
    }
  ...
  if((test_fft<float,2,
      itk::VnlRealToComplexForwardFFTImageFilter<ImageF2> ,
      itk::VnlComplexToRealInverseFFTImageFilter<ImageCF2> >(SizeOfDimensions3)) == 0)
    {
    std::cerr << "--------------------- Failed!" << std::endl;
    rval++;
    }
  ...
  if((test_fft<float,3,
      itk::VnlRealToComplexForwardFFTImageFilter<ImageF3> ,
      itk::VnlComplexToRealInverseFFTImageFilter<ImageCF3> >(SizeOfDimensions3)) == 0)
    {
    std::cerr << "--------------------- Failed!" << std::endl;
    rval++;
    }
  ...
  if((test_fft<double,1,
      itk::VnlRealToComplexForwardFFTImageFilter<ImageD1> ,
      itk::VnlComplexToRealInverseFFTImageFilter<ImageCD1> >(SizeOfDimensions3)) == 0)
    {
    std::cerr << "--------------------- Failed!" << std::endl;
    rval++;
    }
  ...
  if((test_fft<double,2,
      itk::VnlRealToComplexForwardFFTImageFilter<ImageD2> ,
      itk::VnlComplexToRealInverseFFTImageFilter<ImageCD2> >(SizeOfDimensions3)) == 0)
    {
    std::cerr << "--------------------- Failed!" << std::endl;
    rval++;
    }
  ...
  if((test_fft<double,3,
      itk::VnlRealToComplexForwardFFTImageFilter<ImageD3> ,
      itk::VnlComplexToRealInverseFFTImageFilter<ImageCD3> >(SizeOfDimensions3)) == 0)
    {
    std::cerr << "--------------------- Failed!" << std::endl;
    rval++;
    }
