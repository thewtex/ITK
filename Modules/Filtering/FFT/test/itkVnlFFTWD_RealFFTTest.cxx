...
int itkVnlFFTWD_RealFFTTest(int, char *[])
{
  ...
  if((test_fft_rtc<double,1,
      ...
      itk::FFTWRealToComplexForwardFFTImageFilter<ImageD1> >(SizeOfDimensions1)) != 0)
    rval++;
  std::cerr << "VnlFFTWD:double,2 (4,4,4)" << std::endl;
  if((test_fft_rtc<double,2,
      itk::VnlRealToComplexForwardFFTImageFilter<ImageD2> ,
      itk::FFTWRealToComplexForwardFFTImageFilter<ImageD2> >(SizeOfDimensions1)) != 0)
    rval++;
  std::cerr << "VnlFFTWD:double,3 (4,4,4)" << std::endl;
  if((test_fft_rtc<double,3,
      itk::VnlRealToComplexForwardFFTImageFilter<ImageD3> ,
      itk::FFTWRealToComplexForwardFFTImageFilter<ImageD3> >(SizeOfDimensions1)) != 0)
    rval++;
  std::cerr << "VnlFFTWD:double,1 (3,5,4)" << std::endl;
  if((test_fft_rtc<double,1,
      itk::VnlRealToComplexForwardFFTImageFilter<ImageD1> ,
      itk::FFTWRealToComplexForwardFFTImageFilter<ImageD1> >(SizeOfDimensions2)) != 0)
    rval++;
  std::cerr << "VnlFFTWD:double,2 (3,5,4)" << std::endl;
  if((test_fft_rtc<double,2,
      itk::VnlRealToComplexForwardFFTImageFilter<ImageD2> ,
      itk::FFTWRealToComplexForwardFFTImageFilter<ImageD2> >(SizeOfDimensions2)) != 0)
    rval++;
  std::cerr << "VnlFFTWD:double,3 (3,5,4)" << std::endl;
  if((test_fft_rtc<double,3,
      itk::VnlRealToComplexForwardFFTImageFilter<ImageD3> ,
      itk::FFTWRealToComplexForwardFFTImageFilter<ImageD3> >(SizeOfDimensions2)) != 0)
    rval++;
