...
int transformImage( const char * inputImageFileName, const char * outputImageFileName )
{
  ...
  typedef itk::FFTComplexToComplexImageFilter< ComplexImageType > ComplexFilterType;
  typename ComplexFilterType::Pointer inverseComplexFilter1 = ComplexFilterType::New();
  inverseComplexFilter1->SetInput( forwardFilter->GetOutput() );
  inverseComplexFilter1->SetTransformDirection( ComplexFilterType::INVERSE );

  typedef itk::FFTComplexToComplexImageFilter< ComplexImageType > ComplexFilterType;
  typename ComplexFilterType::Pointer forwardComplexFilter = ComplexFilterType::New();
  forwardComplexFilter->SetInput( inverseComplexFilter1->GetOutput() );
  forwardComplexFilter->SetTransformDirection( ComplexFilterType::DIRECT );

  typedef itk::FFTComplexToComplexImageFilter< ComplexImageType > ComplexFilterType;
  typename ComplexFilterType::Pointer inverseComplexFilter2 = ComplexFilterType::New();
  inverseComplexFilter2->SetInput( forwardComplexFilter->GetOutput() );
  inverseComplexFilter2->SetTransformDirection( ComplexFilterType::INVERSE );
  ...
  inverseFilter->SetInput( inverseComplexFilter2->GetOutput() );
