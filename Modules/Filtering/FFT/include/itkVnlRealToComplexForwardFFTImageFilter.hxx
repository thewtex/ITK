...
#define __itkVnlRealToComplexForwardFFTImageFilter_hxx
...
void
VnlRealToComplexForwardFFTImageFilter< TInputImage, TOutputImage >
::GenerateData()
{
  ...
  for ( unsigned int i = 0; i < ImageDimension; i++ )
    ...
    if ( !VnlFFTCommon::IsDimensionSizeLegal( inputSize[i] ) )
      ...
      itkExceptionMacro(<< "Cannot compute FFT of image with size "
                        << inputSize << ". VnlRealToComplexForwardFFTImageFilter operates "
