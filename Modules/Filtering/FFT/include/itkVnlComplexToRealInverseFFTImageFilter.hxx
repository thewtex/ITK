...
#define __itkVnlComplexToRealInverseFFTImageFilter_hxx
...
void
VnlComplexToRealInverseFFTImageFilter< TInputImage, TOutputImage >
::GenerateData()
{
  ...
  for ( unsigned int i = 0; i < ImageDimension; i++ )
    ...
    if ( !VnlFFTCommon::IsDimensionSizeLegal( outputSize[i] ) )
      ...
      itkExceptionMacro(<< "Cannot compute FFT of image with size "
                        << outputSize << ". VnlComplexToRealInverseFFTImageFilter operates "
