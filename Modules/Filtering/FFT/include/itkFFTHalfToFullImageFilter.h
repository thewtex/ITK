 ...
 *
 *=========================================================================*/
#ifndef __itkFFTHalfToFullImageFilter_h
#define __itkFFTHalfToFullImageFilter_h

#include "itkImageToImageFilter.h"

namespace itk
{
/** \class FFTHalfToFullImageFilter
 *
 * \brief Expands a half image produced from a real-to-complex
 * discrete Fourier transform (DFT) to the full complex image.
 *
 * The subclasses of ForwardFFTImageFilter produce only the
 * non-redundant half of the image resulting from a real-to-complex
 * DFT. This filter takes the non-redundant half image and generates
 * the full complex image that includes the redundant half. It
 * requires additional information about the output image size,
 * namely, whether the size in the first dimension of the output image
 * is odd.
 *
...
public:
  ...
  typedef FFTHalfToFullImageFilter                       Self;
  ...
  itkTypeMacro(FFTHalfToFullImageFilter,
               ImageToImageFilter);
...
protected:
  FFTHalfToFullImageFilter() : m_ActualXDimensionIsOdd(false) {}
  ~FFTHalfToFullImageFilter() {}

  void ThreadedGenerateData(const OutputImageRegionType & outputRegionForThread,
                            ThreadIdType threadId);

private:
  FFTHalfToFullImageFilter(const Self &); // purposely not implemented
...
#include "itkFFTHalfToFullImageFilter.hxx"
#endif

#endif // __itkFFTHalfToFullImageFilter_h
