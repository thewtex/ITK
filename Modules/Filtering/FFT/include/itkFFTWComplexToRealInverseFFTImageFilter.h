 ...
 *
 *=========================================================================*/
#ifndef __itkFFTWComplexToRealInverseFFTImageFilter_h
#define __itkFFTWComplexToRealInverseFFTImageFilter_h

#include "itkComplexToRealInverseFFTImageFilter.h"

#include "itkFFTWCommon.h"

namespace itk
{
/** \class FFTWComplexToRealInverseFFTImageFilter
 *
...
class ITK_EXPORT FFTWComplexToRealInverseFFTImageFilter:
  public ComplexToRealInverseFFTImageFilter< TInputImage, TOutputImage >
{
public:
  ...
  typedef FFTWComplexToRealInverseFFTImageFilter                                Self;
  typedef ComplexToRealInverseFFTImageFilter< InputImageType, OutputImageType > Superclass;
  ...
  itkTypeMacro(FFTWComplexToRealInverseFFTImageFilter,
               ComplexToRealInverseFFTImageFilter);
...
protected:
  FFTWComplexToRealInverseFFTImageFilter();
  virtual ~FFTWComplexToRealInverseFFTImageFilter() {}
...
private:
  FFTWComplexToRealInverseFFTImageFilter(const Self&); //purposely not implemented
...
#include "itkFFTWComplexToRealInverseFFTImageFilter.hxx"
#endif

#endif //__itkFFTWComplexToRealInverseFFTImageFilter_h
