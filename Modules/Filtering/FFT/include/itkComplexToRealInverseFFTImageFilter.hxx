 ...
 *
 *=========================================================================*/
#ifndef __itkComplexToRealInverseFFTImageFilter_hxx
#define __itkComplexToRealInverseFFTImageFilter_hxx
...
struct Dispatch_C2R_New
{
  static TSelfPointer Apply()
    {
      return VnlComplexToRealInverseFFTImageFilter< TInputImage, TOutputImage >
        ::New().GetPointer();
    }
};
...
struct Dispatch_C2R_New< TSelfPointer, TInputImage, TOutputImage, double >
{
  static TSelfPointer Apply()
    {
      return FFTWComplexToRealInverseFFTImageFilter< TInputImage, TOutputImage >
        ::New().GetPointer();
    }
};
#endif
...
typename ComplexToRealInverseFFTImageFilter< TInputImage, TOutputImage >::Pointer
ComplexToRealInverseFFTImageFilter< TInputImage, TOutputImage >
::New(void)
{
