 ...
 *
 *=========================================================================*/
#ifndef __itkRealToComplexForwardFFTImageFilter_hxx
#define __itkRealToComplexForwardFFTImageFilter_hxx
...
struct DispatchFFTW_R2C_New
{
  static TSelfPointer Apply()
    {
      return VnlRealToComplexForwardFFTImageFilter< TInputImage, TOutputImage >
        ::New().GetPointer();
    }
};
...
struct DispatchFFTW_R2C_New< TSelfPointer, TInputImage, TOutputImage, double >
{
  static TSelfPointer Apply()
    {
      return FFTWRealToComplexForwardFFTImageFilter< TInputImage, TOutputImage >
        ::New().GetPointer();
    }
};
#endif
...
typename RealToComplexForwardFFTImageFilter< TInputImage, TOutputImage >::Pointer
RealToComplexForwardFFTImageFilter< TInputImage, TOutputImage >
::New(void)
{
