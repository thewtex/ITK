...
::CreateStructuringElement()
{
  ...
  Iterator kernel_it;
  typename SEType::Iterator flatKernelIt;
  for ( flatKernelIt = flatKernel.Begin(), kernel_it = this->Begin(); flatKernelIt != flatKernel.End(); ++flatKernelIt, ++kernel_it )
  {
    *kernel_it = *flatKernelIt;
  }
}
} // namespace itk
