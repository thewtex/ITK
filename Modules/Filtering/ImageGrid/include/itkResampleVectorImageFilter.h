 ...
 *
 *=========================================================================*/
#ifndef __itkResampleVectorImageFilter_h
#define __itkResampleVectorImageFilter_h
...
namespace itk
{
/** \class ResampleVectorImageFilter
 * \brief Resample an image via a coordinate transform
 *
 * ResampleVectorImageFilter resamples an existing image through some coordinate
...
class ITK_EXPORT ResampleVectorImageFilter:
  public ImageToImageFilter< TInputImage, TOutputImage >
{
public:
  /** Standard class typedefs. */
  typedef ResampleVectorImageFilter                       Self;
  ...
  itkTypeMacro(ResampleVectorImageFilter, ImageToImageFilter);
  ...
  typedef InterpolateVectorImageFunction< InputImageType, TInterpolatorPrecisionType > InterpolatorType;
  ...
  /** ResampleVectorImageFilter produces an image which is a different size
  ...
  /** ResampleVectorImageFilter needs a different input requested region than
   * the output requested region.  As such, ResampleVectorImageFilter needs
...
#endif
protected:
  ResampleVectorImageFilter();
  ~ResampleVectorImageFilter() {}
  void PrintSelf(std::ostream & os, Indent indent) const;

  /** ResampleVectorImageFilter can be implemented as a multithreaded filter.  Therefore,
...
private:
  ResampleVectorImageFilter(const Self &); //purposely not implemented
...
#include "itkResampleVectorImageFilter.txx"
#endif
