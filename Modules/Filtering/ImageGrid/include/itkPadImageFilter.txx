                       ...
                       ThreadIdType threadId)
{
  ...
  typedef typename OutputIteratorType::IndexType       OutputIteratorIndexType;

  // TODO - future speed improvement: iterate over the pixel region
  // inside the input image and copy directly to the output. Then
  // treat the remaining regions with the boundary condition.

  ProgressReporter progress( this, threadId, outputRegionForThread.GetNumberOfPixels() );

  OutputIteratorType outIter( this->GetOutput(), outputRegionForThread );
  outIter.GoToBegin();
