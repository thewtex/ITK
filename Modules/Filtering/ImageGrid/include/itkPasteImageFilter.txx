                       ...
                       int threadId)
{
  ...
  if ( !useSource && !( this->GetInPlace() && this->CanRunInPlace() ) )
    ...
    // input to the output
    ImageCopy( destPtr, outputPtr, outputRegionForThread, outputRegionForThread );
    ...
    // to the output
    ImageCopy(  sourcePtr, outputPtr, sourceRegionInSourceImageCropped, outputRegionForThread);
    ...
    // appropriate output pixels with the source.
     ...
     ImageCopy( sourcePtr, outputPtr, sourceRegionInSourceImageCropped, sourceRegionInDestinationImageCropped );
