...
::GenerateOutputInformation()
{
  ...
  ContinuousIndex< typename TOutputImage::SpacePrecisionType, TOutputImage::ImageDimension > inputCenterIndex;
  ContinuousIndex< typename TOutputImage::SpacePrecisionType, TOutputImage::ImageDimension > outputCenterIndex;
  for ( i = 0; i < TOutputImage::ImageDimension; i++ )
    {
