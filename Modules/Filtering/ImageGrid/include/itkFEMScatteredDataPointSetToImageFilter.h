...
#include "itkMesh.h"
//TODO: add include paths in CMakeLists.txt
#include "D:\MyVC\ITKGit\ITK\Modules\Numerics\FEM\include\itkFEMObject.h"
#include "D:\MyVC\ITKGit\ITK\Modules\Numerics\FEM\include\itkFEMElement3DC0LinearTetrahedronStrain.h"
#include "D:\MyVC\ITKGit\ITK\Modules\Numerics\FEM\include\itkFEMElement2DC0LinearTriangularStrain.h"
#include "D:\MyVC\ITKGit\ITK\Modules\Numerics\FEM\include\itkFEMRobustSolver.h"
#include "D:\MyVC\ITKGit\ITK\Modules\Numerics\FEM\include\itkFEMNoisyLoadLandmark.h"
...
public:
  ...
  typedef fem::FEMObject<ImageDimension>            FEMObjectType;
  typedef typename FEMObjectType::Pointer           FEMObjectPointer;

  /** FEM solver typedef support */
  typedef fem::RobustSolver<ImageDimension>       FEMSolverType;

  typedef typename FEMSolverType::Pointer           FEMSolverPointer;

  /** FEM element typedef support */
  typedef fem::Element3DC0LinearTetrahedronStrain FEMTetrahedronType;
  typedef fem::Element2DC0LinearTriangularStrain  FEMTriangleType;

  /** FEM node typedef support */
  typedef fem::Element::Node            NodeType;
  
  /** FEM Load typedef support */  
  typedef fem::NoisyLoadLandmark          LoadType;

  typedef fem::Element::VectorType                  FEMVectorType;
  typedef fem::Element::MatrixType                  FEMMatrixType;
