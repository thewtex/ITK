 ...
 *
 *=========================================================================*/
#ifndef __itkResampleVectorImageFilter_txx
#define __itkResampleVectorImageFilter_txx
...
ResampleVectorImageFilter< TInputImage, TOutputImage, TInterpolatorPrecisionType >
::ResampleVectorImageFilter()
{
  ...
  m_Interpolator = LinearInterpolateVectorImageFunction< InputImageType, TInterpolatorPrecisionType >::New();

  m_DefaultPixelValue.Fill(0); // This needs to be redone after setting the Size of the vector
}
  ...
  ThreadIdType threadId)
{
  ...
  m_DefaultPixelValue.SetSize(inputPtr->GetNumberOfComponentsPerPixel());
  ...
  while ( !outIt.IsAtEnd() )
    ...
    if ( m_Interpolator->IsInsideBuffer(inputIndex) )
      {
      PixelType        pixval;
      pixval.SetSize(inputPtr->GetNumberOfComponentsPerPixel());
...
//std::cout << "inputPtr : " << inputPtr << std::endl;
  // Request the entire input image
  InputImageRegionType inputRegion;
  inputRegion = inputPtr->GetLargestPossibleRegion();
  inputPtr->SetRequestedRegion(inputRegion);
//std::cout << "inputPtr after: " << inputPtr << std::endl;
  return;
}
