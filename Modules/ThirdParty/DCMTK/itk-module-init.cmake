...
if(NOT ITK_USE_SYSTEM_DCMTK)
  ...
  set(ITKDCMTK_LIBDIR ${CMAKE_CURRENT_BINARY_DIR}/Modules/ThirdParty/DCMTK/${DCMTK_EPNAME}-build/lib)
  ...
  foreach(lib ${ITKDCMTK_LibNames})
    ...
    set_property(TARGET ${lib} PROPERTY IMPORTED_LOCATION ${libfilename})
    message("${lib} imported location ${libfilename}")
