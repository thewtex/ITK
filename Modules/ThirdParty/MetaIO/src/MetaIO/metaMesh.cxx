  ...
  if(m_BinaryData)
  {
    ...
    for(int j=0; j<m_NPoints; j++)
      ...
      for(int d=0; d<m_NDims; d++)
        {
        bufferAlignedUnition aligned_buffer;
        char * const num = (char *)(&aligned_buffer);
