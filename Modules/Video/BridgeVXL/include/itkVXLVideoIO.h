...
public:
   ...
   * type of meta data. */
  virtual TemporalOffsetType GetSpacing(unsigned int ) const
    { return 1.0; }
  virtual TemporalOffsetType  GetOrigin(unsigned int ) const
    { return 0.0; }
  virtual std::vector< TemporalOffsetType > GetDirection(unsigned int i) const
