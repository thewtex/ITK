...
struct HandleRGBPixel< char, VDimension >
{
  static void Padding( const Image< char, VDimension >* in, IplImage* out )
  {
    (void) in;
    (void) out;
  }
...
template< unsigned int VDimension >
struct HandleRGBPixel< unsigned char, VDimension >
{
  static void Padding( const Image< unsigned char, VDimension >* in, IplImage* out )
  {
    (void) in;
    (void) out;
  }
...
template< unsigned int VDimension >
struct HandleRGBPixel< short, VDimension >
{
  static void Padding( const Image< short, VDimension >* in, IplImage* out )
  {
    (void) in;
    (void) out;
  }
...
template< unsigned int VDimension >
struct HandleRGBPixel< unsigned short, VDimension >
{
  static void Padding( const Image< unsigned short, VDimension >* in, IplImage* out )
  {
    (void) in;
    (void) out;
  }
...
template< unsigned int VDimension >
struct HandleRGBPixel< float, VDimension >
{
  static void Padding( const Image< float, VDimension >* in, IplImage* out )
  {
    (void) in;
    (void) out;
  }
...
template< unsigned int VDimension >
struct HandleRGBPixel< double, VDimension >
{
  static void Padding( const Image< double, VDimension >* in, IplImage* out )
  {
    (void) in;
    (void) out;
  }
    ...
    for( int r=0;r < out->height; r++ )
      ...
      for( int c=0;c < out->width; c++ )
        ...
        for( unsigned int i=0; i< 3; i++ )
          {
          out->imageData[pos + c* 3 + i ] = pixel[i];
          }
        }
      }
  }
