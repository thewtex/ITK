...
{
  if (itkOpenCVImageBridgeTestTemplatedRGB< TValue, 2 >(argv) == EXIT_FAILURE)
    {
    return EXIT_FAILURE;
    }
  if (itkOpenCVImageBridgeTestTemplatedRGB< TValue, 3 >(argv) == EXIT_FAILURE)
    {
    return EXIT_FAILURE;
    }
...
int itkOpenCVImageBridgeTest ( int argc, char *argv[] )
{
  ...
  //
  argv++;//scalar_image_1
  if( itkRunScalarTest< unsigned char >( argv ) == EXIT_FAILURE )
    {
    return EXIT_FAILURE;
    }
  if( itkRunScalarTest< short >( argv ) == EXIT_FAILURE )
    {
    return EXIT_FAILURE;
    }
  if( itkRunScalarTest< unsigned short >( argv ) == EXIT_FAILURE )
    {
    return EXIT_FAILURE;
    }
  if( itkRunScalarTest< float >( argv ) == EXIT_FAILURE )
    {
    return EXIT_FAILURE;
    }
  if( itkRunScalarTest< double >( argv ) == EXIT_FAILURE )
    {
    return EXIT_FAILURE;
    }
  ...
  if( itkRunRGBTest< unsigned char >( argv ) == EXIT_FAILURE )
    {
    return EXIT_FAILURE;
    }
  if( itkRunRGBTest< unsigned short >( argv ) == EXIT_FAILURE )
    {
    return EXIT_FAILURE;
    }
  if( itkRunRGBTest< float >( argv ) == EXIT_FAILURE )
    {
    return EXIT_FAILURE;
    }
