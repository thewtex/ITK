...
*/
#ifndef __itkJaccardFilter_txx
#define __itkJaccardFilter_txx

#include "itkJaccardFilter.h"
...
JaccardFilter<TImage>::JaccardFilter()
{
...
//set the first image
template< class TImage>
void JaccardFilter<TImage>:: SetInputImage1(const TImage* image)
{
...
//set second image
template< class TImage>
void JaccardFilter<TImage>:: SetInputImage2(const TImage* image)
{
 ...
 //Before threaded
template<class TImage>
void JaccardFilter<TImage>::BeforeThreadedGenerateData()
{
...
template<class TImage>
double  JaccardFilter<TImage>:: getJaccardDistance()
{return  this->JaccardDistance;};



}// end namespace
#endif //__itkJaccardFilter_txx
