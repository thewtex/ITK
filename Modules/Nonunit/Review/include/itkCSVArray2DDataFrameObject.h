...
namespace itk
{
/** \class CSVArray2DDataFrameObject
 * \brief Stores parsed data from csv files.
 *
 * CSVArray2DDataFrameObject contains methods for accessing data from the
 * Array2D object. It is used in the CSVFileToArray2DReader class for storing
 * parsed data. The CSVArray2DDataFrameObject comprises of an Array2D object
