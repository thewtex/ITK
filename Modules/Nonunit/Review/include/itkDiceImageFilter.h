...
namespace itk
{
  ...
  class DiceImageFilter:public ImageToImageFilter< TImage, TImage >
  {
  public:
    /** Standard class typedefs. */
    typedef DiceImageFilter             Self;
    ...
    itkTypeMacro(DiceImageFilter, ImageToImageFilter);
  ...
  private:
    DiceImageFilter(const Self &); //purposely not implemented
