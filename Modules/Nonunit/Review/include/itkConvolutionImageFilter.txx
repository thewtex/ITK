                      ...
                      ProgressAccumulator * progress )
{
  ...
  const TKernelImage *kernelInput = kernelOperator.GetImageKernel();
  SmartPointerForwardReference< ProcessObject > kernelSource = kernelInput->GetSource();
  if ( kernelSource.GetPointer() )
    {
    kernelSource->UpdateLargestPossibleRegion();
    }
