...
public:
  ...
  /** PerimeterOnBorder is the physical size of the objects which are on
    ...
    * the Size, this attribute is not directly linked to the SizeOnBorder
    * attribute. This attribute is particulary useful to remove the objects
    * which are touching too much the border. Its type is double.*/
