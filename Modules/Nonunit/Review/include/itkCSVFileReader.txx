...
void
CSVFileReader <TData>
::SetDataFrameObject(DataFrameObjectType* dfo)
{
  dfo->SetMatrix            ( m_Matrix );
  dfo->SetColumnHeaders     ( m_ColumnHeaders);
  dfo->SetRowHeaders        ( m_RowHeaders );
  dfo->SetHaveColumnHeaders ( m_HaveColumnHeaders );
  dfo->SetHaveRowHeaders    ( m_HaveRowHeaders );
}
