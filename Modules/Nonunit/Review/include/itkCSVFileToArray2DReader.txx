...
::Parse()
{
  /* Try not opening the file as GetDataDimension opens the file anyway.
  ...
  */
  ...
  // DEBUGGING: check to see if the file can be opened now
  this->m_InputStream.open(this->m_FileName.c_str());
  ...
  std::cout << "Within Parse(): The file was opened successfully after GetDataDimension() was called."
