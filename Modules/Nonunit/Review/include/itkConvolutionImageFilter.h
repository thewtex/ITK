...
public:
  ...
  /** ConvolutionImageFilter needs a smaller second input (the image
   * kernel) requested region than output requested region.  As such,
   * this filter needs to provide an implementation for
