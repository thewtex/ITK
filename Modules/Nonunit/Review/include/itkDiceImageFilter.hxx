...
namespace itk
{
  ...
  DiceImageFilter<TImage>::DiceImageFilter()
  {
    ...
    //set image 1
  template< class TImage>
  void DiceImageFilter<TImage>:: SetInputImage1(const TImage* image)
  {
    ...
    //set image 2
  template< class TImage>
  void DiceImageFilter<TImage>:: SetInputImage2(const TImage* image)
  {
    ...
    //Before threaded
  template<class TImage>
  void DiceImageFilter<TImage>::BeforeThreadedGenerateData()
  {
  ...
  template<class TImage>
  const double  DiceImageFilter<TImage>:: getDiceDistance()
  {
