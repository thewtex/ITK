...
/** \class CSVFileToArray2DReader
 * \brief Parses csv files and stores the data in a CSVArray2DDataFrameObject.
 *
 * CSVFileToArray2DReader is used for reading csv files. This reader should
 * only be used for parsing numeric data fields. The Parse() method in this
 * class parses the data from the file into a CSVArray2DDataFrameObject. As the
 ...
 * can then get the results by instantiating a CSVArray2DDataFrameObject and
 * assigning it using the GetDataFrameObject() method.
 *
...
public:
 ...
 typedef typename itk::CSVArray2DDataFrameObject<TData>
                                                    Array2DDataFrameObjectType;
 typedef typename Array2DDataFrameObjectType::Pointer
                                                    DataFrameObjectPointer;
...
private:
 ...
 DataFrameObjectPointer   m_DataFrameObject;
