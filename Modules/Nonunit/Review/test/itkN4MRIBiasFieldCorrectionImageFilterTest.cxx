...
int N4( int argc, char *argv[] )
{
  ...
  std::cout << "Pre-Shrink input Spacing: " << inputImage->Spacing() << std::endl;
  std::cout << "Pre-Shrink input Direction: " << inputImage->Direction() << std::endl;
  std::cout << "Pre-Shrink mask Origin: " <<  maskImage->GetOrigin() << std::endl;
  std::cout << "Pre-Shrink mask Spacing: " << maskImage->Spacing() << std::endl;
  std::cout << "Pre-Shrink mask Direction: " << maskImage->Direction() << std::endl;
  ...
  std::cout << "Post-Shrink input Spacing: " << inputImage->Spacing() << std::endl;
  std::cout << "Post-Shrink input Direction: " << inputImage->Direction() << std::endl;
  std::cout << "Post-Shrink mask Origin: " <<  maskImage->GetOrigin() << std::endl;
  std::cout << "Post-Shrink mask Spacing: " << maskImage->Spacing() << std::endl;
  std::cout << "Post-Shrink mask Direction: " << maskImage->Direction() << std::endl;
