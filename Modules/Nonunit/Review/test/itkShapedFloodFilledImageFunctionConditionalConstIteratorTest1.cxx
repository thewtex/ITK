...
int itkShapedFloodFilledImageFunctionConditionalConstIteratorTest1(int argc, char *argv [] )
{
  ...
  try
    ...
    const ShapedFloodFilledIteratorType::IndexContainerType &seeds(shapedFloodIt.GetStartIndices());
    std::cout << "Iterator seeds";
    for(ShapedFloodFilledIteratorType::IndexContainerType::const_iterator it =
