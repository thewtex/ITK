...
int itkNumericObjectToCSVFileWriterTest (int argc, char *argv[])
{
 ...
 if (!caught)
   {
   std::cerr << "An exception should have been caught here as there is no input file provided. Test fails." << std::endl;
   return EXIT_FAILURE;
   }
 ...
 if (!caught)
   {
   std::cerr << "An exception should have been caught here as there is no input object to write out. Test fails." << std::endl;
   return EXIT_FAILURE;
   }
