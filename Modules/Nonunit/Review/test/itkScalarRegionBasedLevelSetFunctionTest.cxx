...
public:
  ...
  virtual void
  UpdateSharedDataInsideParameters( const unsigned int& ,
                                    const FeaturePixelType&, const ScalarValueType& ) {
  }

  virtual void
  UpdateSharedDataOutsideParameters( const unsigned int& ,
                                     const FeaturePixelType&, const ScalarValueType& ) {
  }
...
private:
  ScalarRegionBasedLevelSetFunctionTestHelper(const Self&); //purposely not
                                                            // implemented
