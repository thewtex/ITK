...
int itkDiceImageFilterTest(int argc, char *argv[])
{
  ...
  typedef itk::DiceImageFilter<ImageType>     FilterType;
  ...
  filter->Update();
  std::cerr << " The Dice coefficient is defined as, twice the shared information (intersection) over the sum of cardinalities between the two inputs"
            << std::endl;
