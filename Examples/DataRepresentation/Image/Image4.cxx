...
int main(int, char *[])
{
  ...
  // The image direction matrix represents the orientaitonal relationships between
  ...
  // to increasing values the 1st, 2nd and 3rd physcial space axis axis respectively, and that the voxel
  // samples are perfectly aligned with the pysical space asis.
  //
  // The following code illustrates the creation and assignment of a variable
