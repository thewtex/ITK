...
//  In the \code{VersorRigid3DTransform} the updating fuction is reimplemented using
...
int main( int argc, char *argv[] )
{
  ...
  const OptimizerType::ParametersType finalParameters = transform->GetParameters();
