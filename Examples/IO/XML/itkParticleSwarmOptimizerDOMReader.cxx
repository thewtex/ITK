 ...
 * It should create a PSO object and return a pointer that points to a base ITK object.
 */
ParticleSwarmOptimizerDOMReader::ObjectPointer
ParticleSwarmOptimizerDOMReader::MakeOutput() const
{
 ...
 */
void
ParticleSwarmOptimizerDOMReader::GenerateData( const DOMNodeType* domnode, const void* )
{
