...
main( int , char *[] )
{
  ...
  // used to parse the
  // hierarchy. For example, via an \doxygen{LevelOrderTreeIterator} templated
  // over the type of tree,
  // we can parse the hierarchy of SpatialObjects. We set the maximum level to
  // 10
  ...
  // Here we show
  // how to use the \doxygen{PreOrderTreeIterator} to add a fourth object to the
  // tree.
  // Software Guide : EndLatex
  // Software Guide : BeginCodeSnippet
