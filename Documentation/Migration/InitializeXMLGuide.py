...
if __name__ == '__main__':
  ...
  try:
    ...
    print "I/O error: Could not open .git/HEAD" +HEADfilename
    sys.exit()
  ...
  # <Change> element
  changeComment = "\n" + XMLFileName + "\n\n>>>>>>>>>>>>>>>>>>>>>>>>>>>>\nTHIS FILE HAS BEEN AUTOMATICALLY GENERATED. EDIT IT BEFORE COMMITING\n<<<<<<<<<<<<<<<<<<<<<<<<<<<\n\nPlease, make sur this file validates the following w3c test before committing it: http://validator.w3.org"
