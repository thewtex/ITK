 ...
 *
 *=========================================================================*/
#ifndef __itkComparisonImageFilter_h
#define __itkComparisonImageFilter_h
...
#define ITK_TEMPLATE_ComparisonImageFilter(_, EXPORT, TypeX, TypeY)     \
  namespace itk                                                         \
  {                                                                     \
  _( 2 ( class EXPORT ComparisonImageFilter< ITK_TEMPLATE_2 TypeX > ) ) \
  namespace Templates                                                   \
  {                                                                     \
  typedef ComparisonImageFilter< ITK_TEMPLATE_2 TypeX >                 \
  ComparisonImageFilter##TypeY;                                       \
  }                                                                     \
  }

#if ITK_TEMPLATE_EXPLICIT
#include "Templates/itkComparisonImageFilter+-.h"
#endif

#if ITK_TEMPLATE_TXX
#include "itkComparisonImageFilter.txx"
#endif
