                        ...
                        unsigned int radiusTolerance)
{
  ...
  typedef itk::ComparisonImageFilter< ImageType, ImageType > DiffType;
  ...
  if ( ( status > numberOfPixelsTolerance ) && reportErrors )
    {
    typedef itk::StretchIntensityImageFilter< ImageType, OutputType >     RescaleType;
    typedef itk::ExtractSliceImageFilter< OutputType, DiffOutputType >    ExtractType;
