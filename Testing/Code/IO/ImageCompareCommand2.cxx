...
int main(int argc, char **argv)
{
  ...
  command.SetOptionLongTag("toleranceIntensity", "ToleranceIntensity");
  ...
  command.SetOptionLongTag("toleranceRadius", "ToleranceRadius");
  ...
  command.SetOptionLongTag("ToleranceNumberOfPixels", "ToleranceNumberOfPixels");
  ...
  command.SetOptionLongTag("testImage", "TestImage");
  ...
  command.SetOptionLongTag("baselineImages", "BaselineImages");
  ...
  command.SetOptionLongTag("baselineImage", "BaselineImage");
