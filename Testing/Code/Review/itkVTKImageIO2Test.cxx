...
int itkVTKImageIO2Test(int argc, char* argv[])
{
  ...
  // SymmetricSecondRankTensor< short, 2 > - ascii
  if (!(VTKImageIO2Tester< itk::SymmetricSecondRankTensor<short, 2>, 3 >::Write( filePrefix, outputPath, true )))
    {
    std::cout << "[FAILED] writing (SymmetricSecondRankTensor<short, 2> - ascii)" << std::endl;
    return EXIT_FAILURE;
    }
  std::cout << "[PASSED] writing (SymmetricSecondRankTensor<short, 2> - ascii)" << std::endl;
  ...
  // SymmetricSecondRankTensor< short, 3 > - ascii
  if (!(VTKImageIO2Tester< itk::SymmetricSecondRankTensor<short, 3>, 3 >::Write( filePrefix, outputPath, true )))
    {
    std::cout << "[FAILED] writing (SymmetricSecondRankTensor<short, 3> - ascii)" << std::endl;
    return EXIT_FAILURE;
    }
  std::cout << "[PASSED] writing (SymmetricSecondRankTensor<short, 3> - ascii)" << std::endl;
  if (!(VTKImageIO2Tester< itk::SymmetricSecondRankTensor<short, 3>, 3 >::Read( filePrefix, outputPath, true )))
    {
    std::cout << "[FAILED] reading (SymmetricSecondRankTensor<short, 3> - ascii)" << std::endl;
    return EXIT_FAILURE;
    }
  std::cout << "[PASSED] reading (SymmetricSecondRankTensor<short, 3> - ascii)" << std::endl;
  ...
  // SymmetricSecondRankTensor< short, 2 > - binary
  if (!(VTKImageIO2Tester< itk::SymmetricSecondRankTensor<short, 2>, 3 >::Write( filePrefix, outputPath, false )))
    {
    std::cout << "[FAILED] writing (SymmetricSecondRankTensor<short, 2> - binary)" << std::endl;
    return EXIT_FAILURE;
    }
  std::cout << "[PASSED] writing (SymmetricSecondRankTensor<short, 2> - binary)" << std::endl;
  // Writing a 2 dimension tensor is possible, but reading is not.
  ...
  // SymmetricSecondRankTensor< short, 3 > - binary
  if (!(VTKImageIO2Tester< itk::SymmetricSecondRankTensor<short, 3>, 3 >::Write( filePrefix, outputPath, false )))
    {
    std::cout << "[FAILED] writing (SymmetricSecondRankTensor<short, 3> - binary)" << std::endl;
    return EXIT_FAILURE;
    }
  std::cout << "[PASSED] writing (SymmetricSecondRankTensor<short, 3> - binary)" << std::endl;
  if (!(VTKImageIO2Tester< itk::SymmetricSecondRankTensor<short, 3>, 3 >::Read( filePrefix, outputPath, false )))
    {
    std::cout << "[FAILED] reading (SymmetricSecondRankTensor<short, 3> - binary)" << std::endl;
    return EXIT_FAILURE;
    }
  std::cout << "[PASSED] reading (SymmetricSecondRankTensor<short, 3> - binary)" << std::endl;
