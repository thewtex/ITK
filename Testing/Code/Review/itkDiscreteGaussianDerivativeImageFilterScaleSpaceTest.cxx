...
int NormalizeSineWave( double frequencyPerImage, unsigned int order, double pixelSpacing = 1.0 )
{
  ...
  const double       tol = vcl_pow( .001, 1.0 / order );
...
int itkDiscreteGaussianDerivativeImageFilterScaleSpaceTest(int, char* [] )
{
  ...
  exitValue  &= NormalizeSineWave( 16, 1 );
  exitValue  &= NormalizeSineWave( 32, 1 );
  exitValue  &= NormalizeSineWave( 64, 1 );

  std::cout << " Testing Second Order Gaussian" << std::endl;
  exitValue  &= NormalizeSineWave( 16, 2 );
  exitValue  &= NormalizeSineWave( 32, 2 );
  exitValue  &= NormalizeSineWave( 64, 2 );

  std::cout << " Testing Spacing Invariance" << std::endl;
  exitValue  &= NormalizeSineWave( 16, 2, 0.01 );
  exitValue  &= NormalizeSineWave( 16, 2, 100 );
