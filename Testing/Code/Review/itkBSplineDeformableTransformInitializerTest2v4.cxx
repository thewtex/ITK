...
int itkBSplineDeformableTransformInitializerTest2v4( int argc, char * argv[] )
{
...
#ifdef BSplinev4
  typedef itk::BSplineDeformableTransformv4<
                            CoordinateRepType,
                            SpaceDimension,
...
#ifdef BSplinev4
  typedef itk::BSplineDeformableTransformInitializerv4<
                  TransformType,
...
#else
  coefficientImages = bsplineTransform->GetCoefficientImage();
#endif
...
#ifndef BSplinev4
  transformInitializer2->SetGridSizeInsideTheImage( size );
#endif
...
#else
  coefficientImages = bsplineTransform2->GetCoefficientImage();
#endif
