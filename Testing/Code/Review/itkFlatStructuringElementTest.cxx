...
int itkFlatStructuringElementTest(int, char *[])
{
  ...
  k2 = SE2Type::Poly( r2, 2 );
  k2.Print(std::cout);
  k2 = SE2Type::Poly( r2, 3 );
  k2.Print(std::cout);
  k2 = SE2Type::Poly( r2, 4 );
  k2.Print(std::cout);
  k2 = SE2Type::Poly( r2, 5 );
  ...
  k3 = SE3Type::Poly( r3, 6 );
  k3.Print(std::cout);
  k3 = SE3Type::Poly( r3, 7 );
  k3.Print(std::cout);
  k3 = SE3Type::Poly( r3, 10 );
  k3.Print(std::cout);
  k3 = SE3Type::Poly( r3, 16 );
  k3.Print(std::cout);

  bool catched = false;
  try
    {
    k3 = SE3Type::Poly( r3, 200 );
    }
  catch(...)
    {
    catched = true;
